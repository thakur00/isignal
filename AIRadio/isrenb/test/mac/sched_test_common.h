...
#ifndef ISRRAN_SCHED_TEST_COMMON_H
#define ISRRAN_SCHED_TEST_COMMON_H
...
public:
  int      add_user(uint16_t rnti, const sched_interface::ue_cfg_t& init_ue_cfg) { return ISRRAN_SUCCESS; }
...
{
public:
  explicit sched_result_stats(std::vector<isrenb::sched::cell_cfg_t> cell_params_) :
...
private:
  ...
  const std::vector<isrenb::sched::cell_cfg_t> cell_params;
};
...
#endif // ISRRAN_SCHED_TEST_COMMON_H
