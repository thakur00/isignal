...
#include "isrenb/hdr/stack/mac/sched_ue_ctrl/tpc.h"
...
int main()
{
  TESTASSERT(isrenb::test_finite_target_snr() == 0);
  TESTASSERT(isrenb::test_undefined_target_snr() == 0);
  isrenb::test_finite_target_snr_tpc_period_above_1();
  printf("Success\n");
}
