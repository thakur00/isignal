...
#ifndef ISRRAN_SCHED_TEST_UTILS_H
#define ISRRAN_SCHED_TEST_UTILS_H
...
inline isrenb::sched_interface::cell_cfg_t generate_default_cell_cfg(uint32_t nof_prb)
{
  isrenb::sched_interface::cell_cfg_t cell_cfg     = {};
  isrran_cell_t&                      cell_cfg_phy = cell_cfg.cell;

  /* Set PHY cell configuration */
  cell_cfg_phy.id              = 1;
  cell_cfg_phy.cp              = ISRRAN_CP_NORM;
  cell_cfg_phy.nof_ports       = 1;
  cell_cfg_phy.nof_prb         = nof_prb;
  cell_cfg_phy.phich_length    = ISRRAN_PHICH_NORM;
  cell_cfg_phy.phich_resources = ISRRAN_PHICH_R_1;
...
inline isrenb::sched_interface::ue_cfg_t generate_default_ue_cfg()
{
  isrenb::sched_interface::ue_cfg_t ue_cfg = {};
  ...
  ue_cfg.ue_bearers[srb_to_lcid(lte_srb::srb0)].direction = isrenb::mac_lc_ch_cfg_t::BOTH;
  ue_cfg.ue_bearers[srb_to_lcid(lte_srb::srb1)].direction = isrenb::mac_lc_ch_cfg_t::BOTH;
  ue_cfg.ue_bearers[srb_to_lcid(lte_srb::srb2)].direction = isrenb::mac_lc_ch_cfg_t::BOTH;
  ue_cfg.ue_bearers[drb_to_lcid(lte_drb::drb1)].direction = isrenb::mac_lc_ch_cfg_t::BOTH;
...
inline isrenb::sched_interface::ue_cfg_t generate_default_ue_cfg2()
{
  isrenb::sched_interface::ue_cfg_t ue_cfg = generate_default_ue_cfg();
...
inline isrenb::sched_interface::ue_cfg_t generate_rach_ue_cfg(const isrenb::sched_interface::ue_cfg_t& final_cfg)
{
  isrenb::sched_interface::ue_cfg_t cfg                = {};
  cfg.ue_bearers[srb_to_lcid(lte_srb::srb0)].direction = isrenb::mac_lc_ch_cfg_t::BOTH;
...
inline isrenb::sched_interface::ue_cfg_t generate_setup_ue_cfg(const isrenb::sched_interface::ue_cfg_t& final_cfg)
{
  isrenb::sched_interface::ue_cfg_t cfg = generate_rach_ue_cfg(final_cfg);

  cfg.maxharq_tx                                       = final_cfg.maxharq_tx;
  cfg.ue_bearers[srb_to_lcid(lte_srb::srb1)].direction = isrenb::mac_lc_ch_cfg_t::BOTH;
  cfg.supported_cc_list[0].dl_cfg.tm                   = ISRRAN_TM1;
...
inline isrenb::sched_interface::ue_cfg_t generate_reconf_ue_cfg(const isrenb::sched_interface::ue_cfg_t& final_cfg)
{
  isrenb::sched_interface::ue_cfg_t cfg      = generate_setup_ue_cfg(final_cfg);
...
struct tti_ev {
  ...
  struct user_cfg_ev {
    ...
    std::unique_ptr<isrenb::mac_lc_ch_cfg_t> bearer_cfg;       ///< optional bearer_cfg call
...
struct sim_sched_args {
  ...
  std::vector<isrenb::sched_interface::cell_cfg_t> cell_cfg;
  ue_ctxt_test_cfg                                 default_ue_sim_cfg{};
  isrenb::sched_interface::sched_args_t            sched_args = {};
};
...
struct sched_sim_event_generator {
  ...
  tti_ev::user_cfg_ev* user_reconf(uint16_t rnti)
  {
    ...
    user->ue_sim_cfg->ue_cfg.ue_bearers[srb_to_lcid(lte_srb::srb2)].direction = isrenb::mac_lc_ch_cfg_t::BOTH;
    user->ue_sim_cfg->ue_cfg.ue_bearers[drb_to_lcid(lte_drb::drb1)].direction = isrenb::mac_lc_ch_cfg_t::BOTH;
...
#endif // ISRRAN_SCHED_TEST_UTILS_H
