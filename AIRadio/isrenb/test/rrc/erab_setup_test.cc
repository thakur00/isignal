...
int test_erab_setup(isrran::log_sink_spy& spy, bool qci_exists)
{
  ...
  rrc_cfg_t          cfg;
  TESTASSERT(test_helpers::parse_default_cfg(&cfg, args) == ISRRAN_SUCCESS);
  ...
  isrenb::rrc                       rrc{&task_sched, bearers};
  mac_dummy                         mac;
  rlc_dummy                         rlc;
...
int main(int argc, char** argv)
{
  ...
  TESTASSERT(test_erab_setup(*spy, true) == ISRRAN_SUCCESS);
  TESTASSERT(test_erab_setup(*spy, false) == ISRRAN_SUCCESS);
