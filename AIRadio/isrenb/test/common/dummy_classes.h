...
#ifndef ISRENB_DUMMY_CLASSES_H
#define ISRENB_DUMMY_CLASSES_H
...
public:
  ...
  void write_mcch(const isrran::sib2_mbms_t* sib2_,
...
public:
  ...
  bool send_ue_cap_info_indication(uint16_t rnti, const isrran::unique_byte_buffer_t ue_radio_cap) override
  {
    return true;
  }
};
...
class gtpu_dummy : public isrenb::gtpu_interface_rrc
{
public:
...
{
public:
  void write_dl_info(uint16_t rnti, isrran::unique_byte_buffer_t sdu) override {}
  ...
  int  release_erab(uint16_t rnti, uint16_t erab_id) override { return ISRRAN_SUCCESS; }
  ...
  void ho_preparation_complete(uint16_t                     rnti,
                               ...
                               isrran::unique_byte_buffer_t container) override
  {}
  ...
  int notify_ue_erab_updates(uint16_t rnti, isrran::const_byte_span nas_pdu) override { return ISRRAN_SUCCESS; }
};

} // namespace isrenb

#endif // ISRENB_DUMMY_CLASSES_H
