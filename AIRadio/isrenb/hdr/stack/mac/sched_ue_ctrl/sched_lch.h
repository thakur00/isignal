...
#ifndef ISRRAN_SCHED_LCH_H
#define ISRRAN_SCHED_LCH_H
...
public:
  explicit lch_ue_manager(uint16_t rnti) : base_ue_buffer_manager(rnti, isrlog::fetch_basic_logger("MAC")) {}
  ...
  using ce_cmd = isrran::dl_sch_lcid;
  isrran::deque<ce_cmd> pending_ces;
