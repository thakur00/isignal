...
#ifndef ISRRAN_PDCCH_SCHED_H
#define ISRRAN_PDCCH_SCHED_H
...
public:
  ...
  using alloc_result_t = isrran::bounded_vector<const tree_node*, 16>;

  sf_cch_allocator() : logger(isrlog::fetch_basic_logger("MAC")) {}
