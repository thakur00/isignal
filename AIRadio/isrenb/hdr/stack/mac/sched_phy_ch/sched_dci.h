...
#ifndef ISRRAN_SCHED_DCI_H
#define ISRRAN_SCHED_DCI_H
...
struct pending_rar_t {
  uint16_t                                                                                    ra_rnti = 0;
  tti_point                                                                                   prach_tti{};
  isrran::bounded_vector<sched_interface::dl_sched_rar_info_t, sched_interface::MAX_RAR_LIST> msg3_grant = {};
};
