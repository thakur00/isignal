...
#ifndef ISRRAN_SCHED_CARRIER_H
#define ISRRAN_SCHED_CARRIER_H
...
public:
  ...
  const cc_sched_result& generate_tti_result(isrran::tti_point tti_rx);
...
private:
  ...
  sf_sched* get_sf_sched(isrran::tti_point tti_rx);
  ...
  isrran::circular_array<sf_sched, TTIMOD_SZ> sf_scheds;
...
private:
  ...
  isrran::deque<pending_rar_t> pending_rars;
