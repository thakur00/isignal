...
#include "isrenb/hdr/stack/mac/schedulers/sched_time_rr.h"
...
#include "isrran/interfaces/enb_rrc_interface_types.h"
...
{
public:
  mac(isrran::ext_task_sched_handle task_sched_, isrlog::basic_logger& logger);
  ~mac();
...
private:
  ...
  // derived from args
  isrran::task_multiqueue::queue_handle stack_task_queue;
  ...
  std::array<isrran::rar_pdu, sched_interface::MAX_RAR_LIST> rar_pdu_msg;
  isrran::byte_buffer_t rar_payload[ISRRAN_MAX_CARRIERS][sched_interface::MAX_RAR_LIST];
  ...
  struct common_buffers_t {
    ...
    isrran_softbuffer_tx_t bcch_softbuffer_tx[NOF_BCCH_DLSCH_MSG]       = {};
    isrran_softbuffer_tx_t pcch_softbuffer_tx                           = {};
    isrran_softbuffer_tx_t rar_softbuffer_tx                            = {};
  };
  ...
  isrran::mcch_msg_t  mcch;
  isrran::sib2_mbms_t sib2;
  isrran::sib13_t     sib13;
  ...
  // Softbuffer pool
  std::unique_ptr<isrran::obj_pool_itf<ue_cc_softbuffers> > softbuffer_pool;
};
