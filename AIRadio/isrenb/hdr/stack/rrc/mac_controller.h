...
#ifndef ISRRAN_MAC_CONTROLLER_H
#define ISRRAN_MAC_CONTROLLER_H
...
public:
  ...
  void set_scell_activation(const std::bitset<ISRRAN_MAX_CARRIERS>& scell_mask);
