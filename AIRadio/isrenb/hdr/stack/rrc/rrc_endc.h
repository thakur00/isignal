...
#ifndef ISRENB_RRC_ENDC_H
#define ISRENB_RRC_ENDC_H
...
class rrc::ue::rrc_endc : public isrran::fsm_t<rrc::ue::rrc_endc>
{
public:
  ...
  rrc_endc(isrenb::rrc::ue* outer_ue, const rrc_endc_cfg_t& endc_cfg_);
  ~rrc_endc();
...
private:
  ...
  uint16_t                             nr_rnti  = ISRRAN_INVALID_RNTI; // C-RNTI assigned to UE on NR side
