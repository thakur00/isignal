...
struct rrc_cfg_t {
  ...
  std::array<isrran::CIPHERING_ALGORITHM_ID_ENUM, isrran::CIPHERING_ALGORITHM_ID_N_ITEMS> eea_preference_list;
  std::array<isrran::INTEGRITY_ALGORITHM_ID_ENUM, isrran::INTEGRITY_ALGORITHM_ID_N_ITEMS> eia_preference_list;
