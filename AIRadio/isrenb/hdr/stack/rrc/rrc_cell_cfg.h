...
#ifndef ISRRAN_RRC_CELL_CFG_H
#define ISRRAN_RRC_CELL_CFG_H
...
struct enb_cell_common {
  ...
  std::vector<isrran::unique_byte_buffer_t> sib_buffer; ///< Packed SIBs for given CC
...
public:
  ...
  const static uint32_t N_PUCCH_MAX_RES = 3 * ISRRAN_NRE * N_PUCCH_MAX_PRB;
