...
#ifndef ISRENB_NR_WORKER_POOL_H
#define ISRENB_NR_WORKER_POOL_H

#include "slot_worker.h"
#include "isrenb/hdr/phy/phy_interfaces.h"
...
{
private:
  isrran::tti_semaphore<slot_worker*> slot_sync; ///< Slot synchronization semaphore
...
public:
  ...
  worker_pool(isrran::phy_common_interface& common,
              stack_interface_phy_nr&       stack,
              isrlog::sink&                 log_sink,
