...
#ifndef ISRENB_LTE_WORKER_POOL_H
#define ISRENB_LTE_WORKER_POOL_H
...
public:
  ...
  bool       init(const phy_args_t& args, phy_common* common, isrlog::sink& log_sink, int prio);
...
#endif // ISRENB_LTE_WORKER_POOL_H
