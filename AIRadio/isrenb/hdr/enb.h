...
#include "isrran/interfaces/enb_command_interface.h"
...
#include "isrran/system/sys_metrics_processor.h"
...
private:
  ...
  std::unique_ptr<isrran::radio_base> radio       = nullptr;
  std::unique_ptr<enb_phy_base>       phy         = nullptr;

  // System metrics processor.
  isrran::sys_metrics_processor sys_proc;
