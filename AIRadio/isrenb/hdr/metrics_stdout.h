...
#ifndef ISRENB_METRICS_STDOUT_H
#define ISRENB_METRICS_STDOUT_H
...
class metrics_stdout : public isrran::metrics_listener<enb_metrics_t>
{
public:
  metrics_stdout();
