...
#include "isrenb/hdr/stack/mac/sched_ue_ctrl/sched_dl_cqi.h"
...
rbgmask_t sched_dl_cqi::get_optim_rbgmask(const rbgmask_t& dl_mask, uint32_t req_rbgs, bool max_flag) const
{
  ...
  isrran::bounded_vector<uint32_t, MAX_NOF_RBGS> sorted_cqi_pos;
  isrran::bounded_vector<uint32_t, MAX_NOF_RBGS> sorted_cqis;
