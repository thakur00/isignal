...
#include "isrgnb/hdr/stack/rrc/rrc_nr_security_context.h"
...
bool nr_security_context::set_security_capabilities(const asn1::ngap::ue_security_cap_s& caps)
{
  ...
  for (const auto& cipher_item : cfg.nea_preference_list) {
    ...
    switch (cipher_item) {
      case isrran::CIPHERING_ALGORITHM_ID_NR_NEA0:
        ...
        sec_cfg.cipher_algo = isrran::CIPHERING_ALGORITHM_ID_NR_NEA0;
        enc_algo_found      = true;
        logger.info("Selected NEA0 as RRC encryption algorithm");
        break;
      case isrran::CIPHERING_ALGORITHM_ID_NR_128_NEA1:
        // “first bit” – 128-EEA1,
        if (v.get(v.length() - isrran::CIPHERING_ALGORITHM_ID_NR_128_NEA1)) {
          sec_cfg.cipher_algo = isrran::CIPHERING_ALGORITHM_ID_NR_128_NEA1;
          enc_algo_found      = true;
        ...
        break;
      case isrran::CIPHERING_ALGORITHM_ID_NR_128_NEA2:
        // “second bit” – 128-EEA2,
        if (v.get(v.length() - isrran::CIPHERING_ALGORITHM_ID_NR_128_NEA2)) {
          sec_cfg.cipher_algo = isrran::CIPHERING_ALGORITHM_ID_NR_128_NEA2;
          enc_algo_found      = true;
        ...
        break;
      case isrran::CIPHERING_ALGORITHM_ID_NR_128_NEA3:
        // “third bit” – 128-EEA3,
        if (v.get(v.length() - isrran::CIPHERING_ALGORITHM_ID_NR_128_NEA3)) {
          sec_cfg.cipher_algo = isrran::CIPHERING_ALGORITHM_ID_NR_128_NEA3;
          enc_algo_found      = true;
  ...
  for (const auto& eia_enum : cfg.nia_preference_list) {
    ...
    switch (eia_enum) {
      case isrran::INTEGRITY_ALGORITHM_ID_NR_NIA0:
        // Null integrity is not supported
        logger.info("Skipping NIA0 as RRC integrity algorithm. Null integrity is not supported.");
        sec_cfg.integ_algo = isrran::INTEGRITY_ALGORITHM_ID_NR_NIA0;
        integ_algo_found   = true;
        break;
      case isrran::INTEGRITY_ALGORITHM_ID_NR_128_NIA1:
        // “first bit” – 128-EIA1,
        if (v.get(v.length() - isrran::INTEGRITY_ALGORITHM_ID_NR_128_NIA1)) {
          sec_cfg.integ_algo = isrran::INTEGRITY_ALGORITHM_ID_NR_128_NIA1;
          integ_algo_found   = true;
        ...
        break;
      case isrran::INTEGRITY_ALGORITHM_ID_NR_128_NIA2:
        // “second bit” – 128-EIA2,
        if (v.get(v.length() - isrran::INTEGRITY_ALGORITHM_ID_NR_128_NIA2)) {
          sec_cfg.integ_algo = isrran::INTEGRITY_ALGORITHM_ID_NR_128_NIA2;
          integ_algo_found   = true;
        ...
        break;
      case isrran::INTEGRITY_ALGORITHM_ID_NR_128_NIA3:
        // “third bit” – 128-EIA3,
        if (v.get(v.length() - isrran::INTEGRITY_ALGORITHM_ID_NR_128_NIA3)) {
          sec_cfg.integ_algo = isrran::INTEGRITY_ALGORITHM_ID_NR_128_NIA3;
          integ_algo_found   = true;
...
void nr_security_context::generate_as_keys()
{
  ...
  isrran::security_generate_k_nr_rrc(k_gnb,
                                     (isrran::CIPHERING_ALGORITHM_ID_ENUM)sec_cfg.cipher_algo,
                                     (isrran::INTEGRITY_ALGORITHM_ID_ENUM)sec_cfg.integ_algo,
...
void nr_security_context::regenerate_keys_handover(uint32_t new_pci, uint32_t new_dl_arfcn)
{
  ...
  isrran::security_generate_k_gnb_star(k_gnb, new_pci, new_dl_arfcn, k_gnb_star);
