...
#ifndef ISRRAN_CELL_ASN1_CONFIG_H
#define ISRRAN_CELL_ASN1_CONFIG_H
...
// PHY helpers
void set_search_space_from_phy_cfg(const isrran_search_space_t& ss, asn1::rrc_nr::search_space_s& out);
...
#endif // ISRRAN_CELL_ASN1_CONFIG_H
