...
#ifndef ISRENB_NGAP_UE_PROC_H
#define ISRENB_NGAP_UE_PROC_H

#include "ngap_interfaces.h"
#include "ngap_ue_utils.h"

#include "isrgnb/hdr/stack/ngap/ngap_ue_bearer_manager.h"
...
public:
  ...
  isrran::proc_outcome_t init(const asn1::ngap::pdu_session_res_setup_request_s& msg);
...
public:
  explicit ngap_ue_initial_context_setup_proc(ngap_interface_ngap_proc* parent_,
                                              ...
                                              ngap_ue_ctxt_t*           ue_ctxt,
                                              isrlog::basic_logger&     logger_);
  isrran::proc_outcome_t init(const asn1::ngap::init_context_setup_request_s& msg);
  isrran::proc_outcome_t react(const bool rrc_reconf_outcome);
  isrran::proc_outcome_t step();
...
public:
  explicit ngap_ue_ue_context_release_proc(ngap_interface_ngap_proc* parent_,
                                           ...
                                           ngap_ue_bearer_manager*   bearer_manager,
                                           isrlog::basic_logger&     logger_);
  isrran::proc_outcome_t init(const asn1::ngap::ue_context_release_cmd_s& msg);
  isrran::proc_outcome_t step();
