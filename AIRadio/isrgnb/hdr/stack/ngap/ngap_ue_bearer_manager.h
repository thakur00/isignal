...
#ifndef ISRENB_NGAP_UE_BEARER_MANAGER_H
#define ISRENB_NGAP_UE_BEARER_MANAGER_H
...
public:
  ...
  ngap_ue_bearer_manager(gtpu_interface_rrc* gtpu_, isrlog::basic_logger& logger_);
...
#endif // ISRENB_NGAP_UE_BEARER_MANAGER_H
