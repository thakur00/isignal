 ...
 *
 */
#ifndef ISRENB_NGAP_UE_H
#define ISRENB_NGAP_UE_H
...
public:
  ...
  bool send_ul_nas_transport(isrran::const_byte_span pdu);
...
private:
  ...
  // procedures
  isrran::proc_t<ngap_ue_initial_context_setup_proc> initial_context_setup_proc;
  isrran::proc_t<ngap_ue_ue_context_release_proc>    ue_context_release_proc;
  isrran::proc_t<ngap_ue_pdu_session_res_setup_proc> ue_pdu_session_res_setup_proc;
};
