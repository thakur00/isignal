...
#ifndef ISRRAN_SCHED_NR_SIGNALLING_H
#define ISRRAN_SCHED_NR_SIGNALLING_H
...
void sched_nzp_csi_rs(isrran::const_span<isrran_csi_rs_nzp_set_t> nzp_csi_rs_sets,
...
bool fill_dci_sib(prb_interval interv, uint32_t sib_idx, const bwp_params_t& bwp_cfg, isrran_dci_dl_nr_t& dci);
...
private:
  ...
  struct si_msg_ctxt_t {
    ...
    isrran::unique_pool_ptr<tx_harq_softbuffer> si_softbuffer;
  };
  isrran::bounded_vector<si_msg_ctxt_t, 10> pending_sis; /// configured SIB1 and SI messages
};

} // namespace sched_nr_impl
} // namespace isrenb

#endif // ISRRAN_SCHED_NR_SIGNALLING_H
