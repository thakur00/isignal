...
#ifndef ISRRAN_SCHED_NR_H
#define ISRRAN_SCHED_NR_H
...
public:
  ...
  void stop();
  int  config(const sched_args_t& sched_cfg, isrran::const_span<sched_nr_cell_cfg_t> cell_list) override;
...
private:
  ...
  // UE Database
  std::unique_ptr<isrran::circular_stack_pool<ISRENB_MAX_UES> > ue_pool;
