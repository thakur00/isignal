...
int test_mib_msg()
{
  ...
  TESTASSERT(test_pack_unpack_consistency(bcch_bch_msg) == ISRASN_SUCCESS);
...
int test_bcch_dl_sch_msg()
{
  ...
  TESTASSERT(res_sib->isr_ul_cfg_common.type() == isr_ul_cfg_common_c::types::release);
  ...
  TESTASSERT(test_pack_unpack_consistency(bcch_msg) == ISRASN_SUCCESS);
...
int test_dl_dcch_msg()
{
  ...
  TESTASSERT(test_pack_unpack_consistency(dl_dcch_msg) == ISRASN_SUCCESS);
...
int failed_dl_ccch_unpack()
{
  ...
  TESTASSERT(msg.unpack(bref) == ISRASN_SUCCESS);

  TESTASSERT(test_pack_unpack_consistency(msg) == ISRASN_SUCCESS);
...
int unrecognized_ext_group_test()
{
  ...
  TESTASSERT(test_pack_unpack_consistency(dl_sch_msg) == ISRASN_SUCCESS);
...
int v2x_test()
{
  ...
  TESTASSERT(sl_preconf.unpack(bref) == ISRASN_SUCCESS);

  //  asn1::json_writer json_writer;
  //  sl_preconf.to_json(json_writer);
  //  printf("Content: %s\n", json_writer.to_string().c_str());

  TESTASSERT(test_pack_unpack_consistency(sl_preconf) == ISRASN_SUCCESS);
...
int test_rrc_conn_reconf_r15_2()
{
  ...
  TESTASSERT(recfg_msg.unpack(bref) == ISRASN_SUCCESS);

  TESTASSERT(test_pack_unpack_consistency(recfg_msg) == ISRASN_SUCCESS);
