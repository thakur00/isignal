...
using namespace isrran::nas_5g;

#define HAVE_PCAP 0

inline void print_msg(const isrran::unique_byte_buffer_t& msg)
{
  printf("\t");
...
int registration_request_unpacking_packing_test(isrran::nas_pcap* pcap)
{
  ...
  isrran::unique_byte_buffer_t buf;
  ...
  TESTASSERT(nas_msg.unpack_outer_hdr(buf) == ISRRAN_SUCCESS);
  ...
  TESTASSERT(nas_msg.unpack(buf) == ISRRAN_SUCCESS);
  TESTASSERT(nas_msg.hdr.message_type == msg_types::options::registration_request);
  ...
  isrran::unique_byte_buffer_t buf_cmp = isrran::make_byte_buffer();
...
int registration_request_unpacking_packing_test_2(isrran::nas_pcap* pcap)
{
  // Non-Access-Stratum 5GS (NAS)PDU
  //   Plain NAS 5GS Message
  //       Extended protocol discriminator: 5G mobility management messages (126)
...
int deregistration_request_unpacking_packing_test(isrran::nas_pcap* pcap)
{
  // Non-Access-Stratum 5GS (NAS)PDU
...
int authentication_request_unpacking_packing_test(isrran::nas_pcap* pcap)
{
  // Non-Access-Stratum 5GS (NAS)PDU
  // Plain NAS 5GS Message
  //     Extended protocol discriminator: 5G mobility management messages (126)
...
int authentication_resp_request_unpacking_packing_test(isrran::nas_pcap* pcap)
{
  // Non-Access-Stratum 5GS (NAS)PDU
  //     Plain NAS 5GS Message
  //         Extended protocol discriminator: 5G mobility management messages (126)
...
int security_command_unpacking_packing_test(isrran::nas_pcap* pcap)
{
  // Non-Access-Stratum 5GS (NAS)PDU
  //   Security protected NAS 5GS message
  //   Plain NAS 5GS Message
...
int security_complete_unpacking_packing_test(isrran::nas_pcap* pcap)
{
  // Non-Access-Stratum 5GS (NAS)PDU
  //   Security protected NAS 5GS message
  //       Extended protocol discriminator: 5G mobility management messages (126)
  ...
  TESTASSERT(inner_message.unpack(sec_complete_msg.nas_message_container.nas_message_container) == ISRRAN_SUCCESS);
...
int registration_accept_unpacking_packing_test(isrran::nas_pcap* pcap)
{
  // Non-Access-Stratum 5GS (NAS)PDU
  //   Security protected NAS 5GS message
  //       Extended protocol discriminator: 5G mobility management messages (126)
...
int registration_complete_unpacking_packing_test(isrran::nas_pcap* pcap)
{
  // Non-Access-Stratum 5GS (NAS)PDU
  //   Security protected NAS 5GS message
  //       Extended protocol discriminator: 5G mobility management messages (126)
...
int deregistration_request_unpacking_packing_test_2(isrran::nas_pcap* pcap)
{
...
int pdu_session_establishment_request_unpacking_packing_test(isrran::nas_pcap* pcap)
{
  ...
  TESTASSERT(inner_nas.unpack_outer_hdr(ul_nas.payload_container.payload_container_contents) == ISRRAN_SUCCESS);
  ...
  TESTASSERT(inner_nas.unpack(ul_nas.payload_container.payload_container_contents) == ISRRAN_SUCCESS);
  ...
  isrran::unique_byte_buffer_t buf_cmp_inner = isrran::make_byte_buffer();
...
int pdu_session_est_req_accecpt(isrran::nas_pcap* pcap)
{
  ...
  // Unpack inner nas
  nas_5gs_msg inner_nas;
  TESTASSERT(inner_nas.unpack_outer_hdr(dl_nas.payload_container.payload_container_contents) == ISRRAN_SUCCESS);
  TESTASSERT(inner_nas.hdr.extended_protocol_discriminator == nas_5gs_hdr::extended_protocol_discriminator_5gsm);
  TESTASSERT(inner_nas.hdr.pdu_session_identity == 10);
  TESTASSERT(inner_nas.hdr.procedure_transaction_identity == 0);
  TESTASSERT(inner_nas.hdr.message_type == msg_types::options::pdu_session_establishment_accept);

  TESTASSERT(inner_nas.unpack(dl_nas.payload_container.payload_container_contents) == ISRRAN_SUCCESS);
...
{
  isrlog::init();
  isrran::console("Testing 5G NAS packing and unpacking\n");
#if HAVE_PCAP
  isrran::nas_pcap pcap;
  pcap.open("nas_5g_msg_test.pcap", 0, isrran::isrran_rat_t::nr);
  TESTASSERT(registration_request_unpacking_packing_test(&pcap) == ISRRAN_SUCCESS);
  TESTASSERT(registration_request_unpacking_packing_test_2(&pcap) == ISRRAN_SUCCESS);
  TESTASSERT(deregistration_request_unpacking_packing_test(&pcap) == ISRRAN_SUCCESS);
  TESTASSERT(authentication_request_unpacking_packing_test(&pcap) == ISRRAN_SUCCESS);
  TESTASSERT(authentication_resp_request_unpacking_packing_test(&pcap) == ISRRAN_SUCCESS);
  TESTASSERT(security_command_unpacking_packing_test(&pcap) == ISRRAN_SUCCESS);
  TESTASSERT(security_complete_unpacking_packing_test(&pcap) == ISRRAN_SUCCESS);
  TESTASSERT(registration_accept_unpacking_packing_test(&pcap) == ISRRAN_SUCCESS);
  TESTASSERT(registration_complete_unpacking_packing_test(&pcap) == ISRRAN_SUCCESS);
  TESTASSERT(deregistration_request_unpacking_packing_test_2(&pcap) == ISRRAN_SUCCESS);
  TESTASSERT(pdu_session_establishment_request_unpacking_packing_test(&pcap) == ISRRAN_SUCCESS);
  TESTASSERT(pdu_session_est_req_accecpt(&pcap) == ISRRAN_SUCCESS);
  pcap.close();
#else
  TESTASSERT(registration_request_unpacking_packing_test(nullptr) == ISRRAN_SUCCESS);
  TESTASSERT(registration_request_unpacking_packing_test_2(nullptr) == ISRRAN_SUCCESS);
  TESTASSERT(deregistration_request_unpacking_packing_test(nullptr) == ISRRAN_SUCCESS);
  TESTASSERT(authentication_request_unpacking_packing_test(nullptr) == ISRRAN_SUCCESS);
  TESTASSERT(authentication_resp_request_unpacking_packing_test(nullptr) == ISRRAN_SUCCESS);
  TESTASSERT(security_command_unpacking_packing_test(nullptr) == ISRRAN_SUCCESS);
  TESTASSERT(security_complete_unpacking_packing_test(nullptr) == ISRRAN_SUCCESS);
  TESTASSERT(registration_accept_unpacking_packing_test(nullptr) == ISRRAN_SUCCESS);
  TESTASSERT(registration_complete_unpacking_packing_test(nullptr) == ISRRAN_SUCCESS);
  TESTASSERT(deregistration_request_unpacking_packing_test_2(nullptr) == ISRRAN_SUCCESS);
  TESTASSERT(pdu_session_establishment_request_unpacking_packing_test(nullptr) == ISRRAN_SUCCESS);
  TESTASSERT(pdu_session_est_req_accecpt(nullptr) == ISRRAN_SUCCESS);
#endif
  return ISRRAN_SUCCESS;
}
