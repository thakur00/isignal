...
int simple_status_pdu_test1()
{
  ...
  isrran::rlc_status_pdu_t s1;
  isrran::byte_buffer_t    b1, b2;
...
int malformed_status_pdu_test2()
{
  ...
  isrran::rlc_status_pdu_t status_pdu = {};
...
int main(int argc, char** argv)
{
  ...
  TESTASSERT(simple_status_pdu_test1() == ISRRAN_SUCCESS);
  TESTASSERT(status_pdu_with_nacks_test1() == ISRRAN_SUCCESS);
  TESTASSERT(malformed_status_pdu_test() == ISRRAN_SUCCESS);
  TESTASSERT(malformed_status_pdu_test2() == ISRRAN_SUCCESS);
