...
int main(int argc, char** argv)
{
  ...
  TESTASSERT(test1() == ISRRAN_SUCCESS);
  TESTASSERT(test2() == ISRRAN_SUCCESS);
  TESTASSERT(test3() == ISRRAN_SUCCESS);
  TESTASSERT(test4() == ISRRAN_SUCCESS);
  TESTASSERT(test5() == ISRRAN_SUCCESS);
