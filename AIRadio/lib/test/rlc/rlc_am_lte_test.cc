...
#include "isrran/rlc/rlc_am_lte.h"
...
int basic_test()
{
  ...
  rlc_am rlc1(isrran_rat_t::lte, isrlog::fetch_basic_logger("RLC_AM_1"), 1, &tester, &tester, &timers);
  rlc_am rlc2(isrran_rat_t::lte, isrlog::fetch_basic_logger("RLC_AM_2"), 1, &tester, &tester, &timers);
...
int resegment_test_1()
{
  ...
  // Check notifications
  isrlog::fetch_basic_logger("RLC_AM_1").debug("%ld", tester.notified_counts.size());
  TESTASSERT(tester.notified_counts.size() == 4);
  for (int i = 0; i < 5; i++) {
...
int header_reconstruction_test(isrran::log_sink_message_spy& spy)
{
...
int header_reconstruction_test2(isrran::log_sink_message_spy& spy)
{
...
int header_reconstruction_test3(isrran::log_sink_message_spy& spy)
{
  // Original PDU
...
int header_reconstruction_test4(isrran::log_sink_message_spy& spy)
{
  // Original PDU
...
int header_reconstruction_test5(isrran::log_sink_message_spy& spy)
{
  // Original PDU:
...
int header_reconstruction_test6(isrran::log_sink_message_spy& spy)
{
  // Original PDU:
...
int header_reconstruction_test7(isrran::log_sink_message_spy& spy)
{
  // Original PDU:
...
int header_reconstruction_test8(isrran::log_sink_message_spy& spy)
{
  // Original PDU:
...
bool poll_retx_expiry_test()
{
  ...
  TESTASSERT_EQ(true, rlc1.has_data());
  isrlog::fetch_basic_logger("TEST").info("t-Poll Retransmssion successfully restarted.");
...
int main(int argc, char** argv)
{
  ...
  auto& logger_rrc1 = isrlog::fetch_basic_logger("RLC_AM_1", *spy, false);
  auto& logger_rrc2 = isrlog::fetch_basic_logger("RLC_AM_2", *spy, false);
  logger_rrc1.set_hex_dump_max_size(100);
  logger_rrc2.set_hex_dump_max_size(100);
  logger_rrc1.set_level(isrlog::basic_levels::debug);
  logger_rrc2.set_level(isrlog::basic_levels::debug);
