...
#ifndef ISRRAN_RLC_TEST_COMMON_H
#define ISRRAN_RLC_TEST_COMMON_H
...
class rlc_um_tester : public isrue::pdcp_interface_rlc, public isrue::rrc_interface_rlc
{
public:
  ...
  void write_pdu_mch(uint32_t lcid, isrran::unique_byte_buffer_t sdu) final { sdus.push_back(std::move(sdu)); }
  void notify_delivery(uint32_t lcid, const isrran::pdcp_sn_vector_t& pdcp_sns) final {}
  void notify_failure(uint32_t lcid, const isrran::pdcp_sn_vector_t& pdcp_sns) final {}
...
class rlc_am_tester : public isrue::pdcp_interface_rlc, public isrue::rrc_interface_rlc
{
public:
  ...
  void notify_delivery(uint32_t lcid, const isrran::pdcp_sn_vector_t& pdcp_sn_vec)
  {
    assert(lcid == 1);
  ...
  void notify_failure(uint32_t lcid, const isrran::pdcp_sn_vector_t& pdcp_sn_vec)
  {
    assert(lcid == 1);
    // TODO
  }
...
#endif // ISRRAN_RLC_TEST_COMMON_H
