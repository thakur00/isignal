...
int rlc_um_nr_pdu_test1()
{
  ...
  TESTASSERT(rlc_um_nr_read_data_pdu_header(&pdu, isrran::rlc_um_nr_sn_size_t::size6bits, &header) != 0);
...
int rlc_um_nr_pdu_test2()
{
  ...
  TESTASSERT(header.sn_size == isrran::rlc_um_nr_sn_size_t::size6bits);
...
int rlc_um_nr_pdu_unpack_test6()
{
  ...
  // unpack PDU
  rlc_um_nr_pdu_header_t header = {};
  TESTASSERT(rlc_um_nr_read_data_pdu_header(&pdu, isrran::rlc_um_nr_sn_size_t::size12bits, &header) != 0);
