...
class rlc_tester : public isrue::pdcp_interface_rlc, public isrue::rrc_interface_rlc
{
public:
  rlc_tester()
  {
  ...
  void write_pdu_mch(uint32_t lcid, isrran::unique_byte_buffer_t sdu) { sdus[n_sdus++] = std::move(sdu); }
