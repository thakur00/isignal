...
{
  TESTASSERT(0 == isrran::mask_lsb_ones<uint8_t>(0));
  TESTASSERT(0 == isrran::mask_msb_ones<uint8_t>(0));
  TESTASSERT(0 == isrran::mask_lsb_ones<uint32_t>(0));
  TESTASSERT(0 == isrran::mask_msb_ones<uint32_t>(0));
  TESTASSERT(0b11111111 == isrran::mask_lsb_zeros<uint8_t>(0));
  TESTASSERT(0b11111111 == isrran::mask_msb_zeros<uint8_t>(0));
  TESTASSERT((uint32_t)-1 == isrran::mask_lsb_zeros<uint32_t>(0));
  TESTASSERT((uint32_t)-1 == isrran::mask_msb_zeros<uint32_t>(0));

  TESTASSERT(0b11 == isrran::mask_lsb_ones<uint8_t>(2));
  TESTASSERT(0b11000000 == isrran::mask_msb_ones<uint8_t>(2));
  TESTASSERT(0b11111100 == isrran::mask_lsb_zeros<uint8_t>(2));
  TESTASSERT(0b00111111 == isrran::mask_msb_zeros<uint8_t>(2));

  TESTASSERT(0b11111111 == isrran::mask_lsb_ones<uint8_t>(8));
  TESTASSERT(0b1111 == isrran::mask_lsb_ones<uint8_t>(4));

  TESTASSERT(isrran::find_first_lsb_one<uint8_t>(0) == std::numeric_limits<uint8_t>::digits);
  TESTASSERT(isrran::find_first_msb_one<uint8_t>(0) == std::numeric_limits<uint8_t>::digits);
  TESTASSERT(isrran::find_first_lsb_one<uint8_t>(1) == 0);
  TESTASSERT(isrran::find_first_msb_one<uint8_t>(1) == 0);
  TESTASSERT(isrran::find_first_lsb_one<uint8_t>(0b11) == 0);
  TESTASSERT(isrran::find_first_lsb_one<uint8_t>(0b10) == 1);
  TESTASSERT(isrran::find_first_msb_one<uint8_t>(0b11) == 1);
  TESTASSERT(isrran::find_first_msb_one<uint8_t>(0b10) == 1);
  TESTASSERT(isrran::find_first_lsb_one<uint32_t>(0b11) == 0);
  TESTASSERT(isrran::find_first_lsb_one<uint32_t>(0b10) == 1);
  TESTASSERT(isrran::find_first_msb_one<uint32_t>(0b11) == 1);
  TESTASSERT(isrran::find_first_msb_one<uint32_t>(0b10) == 1);
}

int test_zero_bitset()
{
  isrran::bounded_bitset<25> mask;
  isrran::bounded_bitset<25> mask2{23};
...
int test_bitset_set()
{
  isrran::bounded_bitset<25> mask{23};
  mask.set(10);
...
int test_bitset_bitwise_oper()
{
  ...
  try {
    mask2 |= mask;
  } catch (isrran::bad_type_access& c) {
...
{
  {
    isrran::bounded_bitset<100> bitset(100);
    bitset.set(0);
    bitset.set(5);
  ...
  {
    isrran::bounded_bitset<100> bitset(25);
    bitset.set(0);
    bitset.set(4);
...
{
  {
    isrran::bounded_bitset<100> bitset;
  ...
  {
    // TEST: Reverse case
    isrran::bounded_bitset<100, true> bitset;
    TESTASSERT(bitset.none() and bitset.size() == 0);
...
{
  {
    isrran::bounded_bitset<25, reversed> bitset(6);
  ...
  {
    isrran::bounded_bitset<100, reversed> bitset(95);
...
{
  test_bit_operations();
  TESTASSERT(test_zero_bitset() == ISRRAN_SUCCESS);
  TESTASSERT(test_ones_bitset() == ISRRAN_SUCCESS);
  TESTASSERT(test_bitset_set() == ISRRAN_SUCCESS);
  TESTASSERT(test_bitset_bitwise_oper() == ISRRAN_SUCCESS);
  TESTASSERT(test_bitset_print() == ISRRAN_SUCCESS);
  TESTASSERT(test_bitset_resize() == ISRRAN_SUCCESS);
