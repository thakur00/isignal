...
#include "src/isrlog/formatters/json_formatter.h"
...
using basic_ctx_t = isrlog::build_context_type<myset1, myset2>;
} // namespace
...
using complex_ctx_t = isrlog::build_context_type<sector_list_t>;
} // namespace
...
using list_ctx_t = isrlog::build_context_type<list_metric3, list_metric4, metrics_list>;
}; // namespace
