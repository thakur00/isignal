...
void write_pcap_eutra_thread_function(isrran::mac_pcap_net*           pcap_handle,
...
void write_pcap_nr_thread_function(isrran::mac_pcap_net*          pcap_handle,
...
int lte_mac_pcap_net_test()
{
  ...
  std::unique_ptr<isrran::mac_pcap_net> pcap_handle = std::unique_ptr<isrran::mac_pcap_net>(new isrran::mac_pcap_net());
  TESTASSERT(pcap_handle->open("127.0.0.1") == ISRRAN_SUCCESS);
  TESTASSERT(pcap_handle->open("127.0.0.1") != ISRRAN_SUCCESS); // open again will fail
  ...
  TESTASSERT(pcap_handle->close() != ISRRAN_SUCCESS); // closing twice will fail
...
int main(int argc, char** argv)
{
  ...
  TESTASSERT(lte_mac_pcap_net_test() == ISRRAN_SUCCESS);
  TESTASSERT(nr_mac_pcap_net_test() == ISRRAN_SUCCESS);
}