...
int test_set_ksg()
{
  ...
  int   err_lte = ISRRAN_ERROR;
  int   err_cmp = ISRRAN_ERROR;
  ...
  err_lte              = isrran::security_generate_sk_gnb(k_enb, scg_counter, sk_gnb_o);
  TESTASSERT(err_lte == ISRRAN_SUCCESS);
...
int test_set_nr_rrc_up()
{
  ...
  err_lte = isrran::security_generate_k_nr_rrc(sk_gnb,
                                               isrran::CIPHERING_ALGORITHM_ID_ENUM::CIPHERING_ALGORITHM_ID_128_EEA2,
                                               isrran::INTEGRITY_ALGORITHM_ID_ENUM::INTEGRITY_ALGORITHM_ID_EIA0,
                                               k_rrc_enc_o,
                                               k_rrc_int_o);
  ...
  err_lte = isrran::security_generate_k_nr_up(sk_gnb,
                                              isrran::CIPHERING_ALGORITHM_ID_ENUM::CIPHERING_ALGORITHM_ID_128_EEA2,
                                              isrran::INTEGRITY_ALGORITHM_ID_ENUM::INTEGRITY_ALGORITHM_ID_EIA0,
                                              k_up_enc_o,
                                              k_up_int_o);
...
int test_generate_k_nas()
{
  ...
  TESTASSERT(isrran::security_generate_k_nas(k_asme,
                                             isrran::CIPHERING_ALGORITHM_ID_ENUM::CIPHERING_ALGORITHM_ID_EEA0,
                                             isrran::INTEGRITY_ALGORITHM_ID_ENUM::INTEGRITY_ALGORITHM_ID_128_EIA1,
                                             k_nas_enc_o,
                                             k_nas_int_o) == ISRRAN_SUCCESS);
...
int test_generate_k_gnb()
{
  ...
  TESTASSERT(isrran::security_generate_k_gnb(k_amf, nas_ul_count, k_gnb_o) == ISRRAN_SUCCESS);
...
int test_generate_k_enb()
{
  ...
  TESTASSERT(isrran::security_generate_k_enb(k_asme, nas_ul_count, k_enb_o) == ISRRAN_SUCCESS);
...
int test_generate_rrc_keys()
{
  ...
  TESTASSERT(isrran::security_generate_k_rrc(k_enb,
                                             isrran::CIPHERING_ALGORITHM_ID_ENUM::CIPHERING_ALGORITHM_ID_EEA0,
                                             isrran::INTEGRITY_ALGORITHM_ID_ENUM::INTEGRITY_ALGORITHM_ID_128_EIA2,
                                             k_rrc_enc_o,
                                             k_rrc_int_o) == ISRRAN_SUCCESS);
...
int test_generate_up_keys()
{
  ...
  TESTASSERT(isrran::security_generate_k_up(k_enb,
                                            isrran::CIPHERING_ALGORITHM_ID_ENUM::CIPHERING_ALGORITHM_ID_EEA0,
                                            isrran::INTEGRITY_ALGORITHM_ID_ENUM::INTEGRITY_ALGORITHM_ID_128_EIA2,
                                            k_up_enc_o,
                                            k_up_int_o) == ISRRAN_SUCCESS);
...
int test_generate_k_enb_star()
{
  ...
  TESTASSERT(isrran::security_generate_k_enb_star(k_enb, 32, 561, k_enb_star_o) == ISRRAN_SUCCESS);
...
int test_generate_k_nh()
{
  ...
  TESTASSERT(isrran::security_generate_nh(k_asme, sync, nh_o) == ISRRAN_SUCCESS);
...
int test_generate_res_star()
{
  ...
  TESTASSERT(isrran::security_generate_res_star(ck, ik, ssn.c_str(), rand, res, sizeof(res), res_star_o) ==
             ISRRAN_SUCCESS);
...
int test_generate_k_ausf()
{
  ...
  TESTASSERT(isrran::security_generate_k_ausf(ck, ik, ak_xor_sqn, ssn.c_str(), k_ausf_o) == ISRRAN_SUCCESS);
...
int test_generate_k_seaf()
{
  ...
  TESTASSERT(isrran::security_generate_k_seaf(k_ausf, ssn.c_str(), k_seaf_o) == ISRRAN_SUCCESS);
...
int test_generate_k_amf()
{
  ...
  TESTASSERT(isrran::security_generate_k_amf(k_seaf, supi.c_str(), abba, sizeof(abba), k_amf_o) == ISRRAN_SUCCESS);
...
int test_generate_nas_5g()
{
  ...
  TESTASSERT(isrran::security_generate_k_nas_5g(k_amf,
                                                isrran::CIPHERING_ALGORITHM_ID_ENUM::CIPHERING_ALGORITHM_ID_EEA0,
                                                isrran::INTEGRITY_ALGORITHM_ID_ENUM::INTEGRITY_ALGORITHM_ID_128_EIA2,
                                                k_nas_enc_o,
                                                k_nas_int_o) == ISRRAN_SUCCESS);
...
int main(int argc, char** argv)
{
  ...
  TESTASSERT(test_generate_k_asme() == ISRRAN_SUCCESS);
  TESTASSERT(test_generate_k_nas() == ISRRAN_SUCCESS);
  TESTASSERT(test_generate_k_enb() == ISRRAN_SUCCESS);
  TESTASSERT(test_generate_rrc_keys() == ISRRAN_SUCCESS);
  TESTASSERT(test_generate_up_keys() == ISRRAN_SUCCESS);
  TESTASSERT(test_generate_k_enb_star() == ISRRAN_SUCCESS);
  TESTASSERT(test_generate_k_nh() == ISRRAN_SUCCESS);
  TESTASSERT(test_generate_k_gnb() == ISRRAN_SUCCESS);
  TESTASSERT(test_generate_res_star() == ISRRAN_SUCCESS);
  TESTASSERT(test_generate_k_ausf() == ISRRAN_SUCCESS);
  TESTASSERT(test_generate_k_seaf() == ISRRAN_SUCCESS);
  TESTASSERT(test_generate_k_amf() == ISRRAN_SUCCESS);
  TESTASSERT(test_generate_k_amf_2() == ISRRAN_SUCCESS);
  TESTASSERT(test_generate_nas_5g() == ISRRAN_SUCCESS);
  TESTASSERT(test_set_ksg() == ISRRAN_SUCCESS);
  TESTASSERT(test_set_nr_rrc_up() == ISRRAN_SUCCESS);
