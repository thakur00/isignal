...
{
  TESTASSERT(test_set_1() == ISRRAN_SUCCESS);
  TESTASSERT(test_set_2() == ISRRAN_SUCCESS);
  TESTASSERT(test_set_3() == ISRRAN_SUCCESS);
  TESTASSERT(test_set_4() == ISRRAN_SUCCESS);
  TESTASSERT(test_set_5() == ISRRAN_SUCCESS);
  TESTASSERT(test_set_6() == ISRRAN_SUCCESS);
  TESTASSERT(test_set_1_block_size() == ISRRAN_SUCCESS);
  TESTASSERT(test_set_1_invalid() == ISRRAN_SUCCESS);
  return ISRRAN_SUCCESS;
}
