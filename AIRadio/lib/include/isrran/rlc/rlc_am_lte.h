...
#ifndef ISRRAN_RLC_AM_LTE_H
#define ISRRAN_RLC_AM_LTE_H
...
#include "isrran/rlc/rlc_am_data_structs.h"
...
private:
  ...
  isrran::timer_handler::unique_timer poll_retx_timer;
  isrran::timer_handler::unique_timer status_prohibit_timer;
...
private:
  ...
  isrran::timer_handler::unique_timer reordering_timer;

  isrran::rolling_average<double> sdu_rx_latency_ms;
};

} // namespace isrran

#endif // ISRRAN_RLC_AM_LTE_H
