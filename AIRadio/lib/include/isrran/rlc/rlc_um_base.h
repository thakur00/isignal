...
#ifndef ISRRAN_RLC_UM_BASE_H
#define ISRRAN_RLC_UM_BASE_H
...
{
public:
  rlc_um_base(isrlog::basic_logger&      logger,
              uint32_t                   lcid_,
...
protected:
  ...
  protected:
    ...
    isrran::rolling_average<double> mean_pdu_latency_us;
#endif
  ...
  rlc_config_t               cfg    = {};
  byte_buffer_pool*          pool   = nullptr;
  std::string                get_rb_name(isrue::rrc_interface_rlc* rrc, uint32_t lcid, bool is_mrb);
