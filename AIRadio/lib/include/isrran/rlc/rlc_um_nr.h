...
#ifndef ISRRAN_RLC_UM_NR_H
#define ISRRAN_RLC_UM_NR_H
...
{
public:
  rlc_um_nr(isrlog::basic_logger&      logger,
            uint32_t                   lcid_,
...
private:
  ...
  private:
    ...
    // TS 38.322 Sec. 7.3
    isrran::timer_handler::unique_timer reassembly_timer; // to detect loss of RLC PDUs at lower layers
