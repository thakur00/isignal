...
#ifndef ISRRAN_RLC_AM_NR_H
#define ISRRAN_RLC_AM_NR_H
...
private:
   ...
   ***************************************************************************/
  isrran::timer_handler::unique_timer poll_retransmit_timer;
...
private:
  ...
  isrran::timer_handler::unique_timer reassembly_timer;
