...
#ifndef ISRRAN_RLC_AM_LTE_PACKING_H
#define ISRRAN_RLC_AM_LTE_PACKING_H

#include "isrran/common/string_helpers.h"
#include "isrran/rlc/rlc_am_base.h"
#include "isrran/rlc/rlc_am_data_structs.h" // required for rlc_am_pdu_segment
#include <list>
...
void log_rlc_amd_pdu_header_to_string(isrlog::log_channel&        log_ch,
...
template <typename... Args>
void log_rlc_am_status_pdu_to_string(isrlog::log_channel& log_ch,
                                     const std::string&   rb_name,
                                     const char*          fmt_str,
...
#endif // ISRRAN_RLC_AM_LTE_PACKING_H
