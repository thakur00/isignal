...
#ifndef ISRRAN_RLC_AM_NR_PACKING_H
#define ISRRAN_RLC_AM_NR_PACKING_H
...
void log_rlc_am_nr_status_pdu_to_string(isrlog::log_channel&    log_ch,
                                        const char*             fmt_str,
                                        rlc_am_nr_status_pdu_t* status,
 ...
 * Log NR AMD PDUs
 */
inline void log_rlc_am_nr_pdu_header_to_string(isrlog::log_channel&          log_ch,
...
#endif // ISRRAN_RLC_AM_NR_PACKING_H
