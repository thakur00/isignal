...
#ifndef ISRRAN_RLC_AM_BASE_H
#define ISRRAN_RLC_AM_BASE_H
...
public:
  ...
  {
  public:
    explicit rlc_am_base_tx(isrlog::basic_logger& logger_) : logger(logger_) {}
  ...
  {
  public:
    explicit rlc_am_base_rx(rlc_am* parent_, isrlog::basic_logger& logger_) : parent(parent_), logger(logger_) {}
