...
#ifndef ISRLOG_EVENT_TRACE_H
#define ISRLOG_EVENT_TRACE_H
...
/// application.
/// To enable event tracing the ENABLE_ISRLOG_EVENT_TRACE macro symbol should
...
#define ISRLOG_TRACE_COMBINE1(X, Y) X##Y
#define ISRLOG_TRACE_COMBINE(X, Y) ISRLOG_TRACE_COMBINE1(X, Y)

/// Generates a complete event.
#define trace_complete_event(C, N)                                                                                     \
  auto ISRLOG_TRACE_COMBINE(scoped_complete_event, __LINE__) = isrlog::detail::scoped_complete_event(C, N)
...
#define trace_threshold_complete_event(C, N, T)                                                                        \
  auto ISRLOG_TRACE_COMBINE(scoped_complete_event, __LINE__) = isrlog::detail::scoped_complete_event(C, N, T)
