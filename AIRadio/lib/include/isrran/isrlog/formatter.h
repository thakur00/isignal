...
#ifndef ISRLOG_FORMATTER_H
#define ISRLOG_FORMATTER_H
...
public:
  ...
  void format_ctx(const isrlog::context<Ts...>& ctx, detail::log_entry_metadata&& metadata, fmt::memory_buffer& buffer)
  {
