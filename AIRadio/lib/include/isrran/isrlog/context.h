...
#ifndef ISRLOG_CONTEXT_H
#define ISRLOG_CONTEXT_H

#include "isrran/isrlog/detail/support/tmp_utils.h"
#include <cassert>
#include <string>
...
/// eg: using my_metric_t = isrlog::build_metric_set_type<m1_t, set1_t, m2_t>;
...
/// eg: using my_context_t = isrlog::build_context_type<set1_t, set2_t>;
/// NOTE: Adding duplicated types into the list is not allowed.
template <typename... Ts>
...
#define DECLARE_METRIC_SET(_name_rep, _type, ...)                                                                      \
  ...
  using _type = isrlog::detail::build_metric_set_type<metric_set_info::_type##__name_rep, __VA_ARGS__>
...
#define DECLARE_METRIC_LIST(_name_rep, _type, _list_type)                                                              \
  ...
  using _type = isrlog::metric_list<list_info::_type##__name_rep, typename std::decay<_list_type>::type>

} // namespace isrlog

#endif // ISRLOG_CONTEXT_H
