...
#ifndef ISRRAN_GTPU_H
#define ISRRAN_GTPU_H
...
bool gtpu_read_header(isrran::byte_buffer_t* pdu, gtpu_header_t* header, isrlog::basic_logger& logger);
bool gtpu_write_header(gtpu_header_t* header, isrran::byte_buffer_t* pdu, isrlog::basic_logger& logger);
void gtpu_ntoa(fmt::memory_buffer& buffer, uint32_t addr);

inline bool gtpu_supported_flags_check(gtpu_header_t* header, isrlog::basic_logger& logger)
{
  // flags
...
inline bool gtpu_supported_msg_type_check(gtpu_header_t* header, isrlog::basic_logger& logger)
{
  // msg_tpye
