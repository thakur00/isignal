...
#ifndef ISRRAN_BYTE_BUFFERQUEUE_H
#define ISRRAN_BYTE_BUFFERQUEUE_H
...
public:
  ...
  isrran::error_type<unique_byte_buffer_t> try_write(unique_byte_buffer_t&& msg)
  {
...
#endif // ISRRAN_BYTE_BUFFERQUEUE_H
