...
#ifndef ISRRAN_PDCP_ENTITY_NR_H
#define ISRRAN_PDCP_ENTITY_NR_H
...
{
public:
  pdcp_entity_nr(isrue::rlc_interface_pdcp* rlc_,
  ...
  std::map<uint32_t, isrran::unique_byte_buffer_t> get_buffered_pdus() override { return {}; }
