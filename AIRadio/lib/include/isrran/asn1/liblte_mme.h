 ...
 *           2016-2020 iSignal Research Labs Pvt Ltd.
 *
...
#ifndef ISRRAN_LIBLTE_MME_H
#define ISRRAN_LIBLTE_MME_H
...
// Functions
LIBLTE_ERROR_ENUM
isrran_mme_pack_esm_information_request_msg(LIBLTE_MME_ESM_INFORMATION_REQUEST_MSG_STRUCT* esm_info_req,
                                            uint8                                          sec_hdr_type,
                                            uint32                                         count,
                                            LIBLTE_BYTE_MSG_STRUCT*                        msg);
LIBLTE_ERROR_ENUM
...
LIBLTE_ERROR_ENUM
isrran_mme_unpack_esm_information_response_msg(LIBLTE_BYTE_MSG_STRUCT*                         msg,
                                               LIBLTE_MME_ESM_INFORMATION_RESPONSE_MSG_STRUCT* esm_info_resp);
