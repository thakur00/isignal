...
#ifndef ISRASN1_RRC_PHYCFG_H
#define ISRASN1_RRC_PHYCFG_H
...
struct p_c_and_cbsr_r13_s {
  struct cbsr_sel_r13_c_ {
    ...
    ISRASN_CODE pack(bit_ref& bref) const;
    ISRASN_CODE unpack(cbit_ref& bref);
...
typedef enumerated<isr_ant_port_opts> isr_ant_port_e;
...
struct isr_cc_set_idx_r14_s {
  ...
  ISRASN_CODE unpack(cbit_ref& bref);
  void        to_json(json_writer& j) const;
  bool        operator==(const isr_cc_set_idx_r14_s& other) const;
  bool        operator!=(const isr_cc_set_idx_r14_s& other) const { return not(*this == other); }
};

// ISR-ConfigAp-r10 ::= SEQUENCE
struct isr_cfg_ap_r10_s {
  struct isr_bw_ap_r10_opts {
  ...
  typedef enumerated<isr_bw_ap_r10_opts> isr_bw_ap_r10_e_;
  ...
  // member variables
  isr_ant_port_e         isr_ant_port_ap_r10;
  isr_bw_ap_r10_e_       isr_bw_ap_r10;
  ...
  ISRASN_CODE unpack(cbit_ref& bref);
  void        to_json(json_writer& j) const;
  bool        operator==(const isr_cfg_ap_r10_s& other) const;
  bool        operator!=(const isr_cfg_ap_r10_s& other) const { return not(*this == other); }
};

// ISR-ConfigAp-r13 ::= SEQUENCE
struct isr_cfg_ap_r13_s {
  struct isr_bw_ap_r13_opts {
    enum options { bw0, bw1, bw2, bw3, nulltype } value;
    typedef uint8_t number_type;
  ...
  typedef enumerated<isr_bw_ap_r13_opts> isr_bw_ap_r13_e_;
  ...
  // member variables
  isr_ant_port_e         isr_ant_port_ap_r13;
  isr_bw_ap_r13_e_       isr_bw_ap_r13;
  ...
  ISRASN_CODE unpack(cbit_ref& bref);
  void        to_json(json_writer& j) const;
  bool        operator==(const isr_cfg_ap_r13_s& other) const;
  bool        operator!=(const isr_cfg_ap_r13_s& other) const { return not(*this == other); }
};

// ISR-ConfigAp-v1310 ::= SEQUENCE
struct isr_cfg_ap_v1310_s {
  ...
  ISRASN_CODE unpack(cbit_ref& bref);
  void        to_json(json_writer& j) const;
  bool        operator==(const isr_cfg_ap_v1310_s& other) const;
  bool        operator!=(const isr_cfg_ap_v1310_s& other) const { return not(*this == other); }
};
...
struct ant_info_ded_v1530_c {
  struct setup_c_ {
    struct ue_tx_ant_sel_isr_minus2_t4_r_nr_of_pairs_r15_opts {
    ...
    typedef enumerated<ue_tx_ant_sel_isr_minus2_t4_r_nr_of_pairs_r15_opts>
        ue_tx_ant_sel_isr_minus2_t4_r_nr_of_pairs_r15_e_;
    struct types_opts {
      enum options {
        ue_tx_ant_sel_isr_minus1_t4_r_cfg_r15,
        ue_tx_ant_sel_isr_minus2_t4_r_nr_of_pairs_r15,
        nulltype
      } value;
      typedef int8_t number_type;
    ...
    void        to_json(json_writer& j) const;
    // getters
    ue_tx_ant_sel_isr_minus2_t4_r_nr_of_pairs_r15_e_& ue_tx_ant_sel_isr_minus2_t4_r_nr_of_pairs_r15()
    {
      assert_choice_type(types::ue_tx_ant_sel_isr_minus2_t4_r_nr_of_pairs_r15, type_, "setup");
      return c;
    }
    const ue_tx_ant_sel_isr_minus2_t4_r_nr_of_pairs_r15_e_& ue_tx_ant_sel_isr_minus2_t4_r_nr_of_pairs_r15() const
    {
      assert_choice_type(types::ue_tx_ant_sel_isr_minus2_t4_r_nr_of_pairs_r15, type_, "setup");
      return c;
    }
    void                                              set_ue_tx_ant_sel_isr_minus1_t4_r_cfg_r15();
    ue_tx_ant_sel_isr_minus2_t4_r_nr_of_pairs_r15_e_& set_ue_tx_ant_sel_isr_minus2_t4_r_nr_of_pairs_r15();

  private:
    types                                            type_;
    ue_tx_ant_sel_isr_minus2_t4_r_nr_of_pairs_r15_e_ c;
  };
  using types = setup_e;
...
struct phys_cfg_ded_stti_r15_c {
  struct setup_s_ {
    ...
    bool                                 isr_dci7_trigger_cfg_r15  = false;
...
struct isr_tpc_pdcch_cfg_r14_c {
  struct setup_s_ {
    using isr_cc_set_idxlist_r14_l_ = dyn_array<isr_cc_set_idx_r14_s>;

    // member variables
    bool                      isr_cc_set_idxlist_r14_present = false;
    fixed_bitstring<16>       isr_tpc_rnti_r14;
    uint8_t                   start_bit_of_format3_b_r14 = 0;
    uint8_t                   field_type_format3_b_r14   = 1;
    isr_cc_set_idxlist_r14_l_ isr_cc_set_idxlist_r14;
  };
  using types = setup_e;

  // choice methods
  isr_tpc_pdcch_cfg_r14_c() = default;
  void        set(types::options e = types::nulltype);
  types       type() const { return type_; }
  ISRASN_CODE pack(bit_ref& bref) const;
  ISRASN_CODE unpack(cbit_ref& bref);
  void        to_json(json_writer& j) const;
  bool        operator==(const isr_tpc_pdcch_cfg_r14_c& other) const;
  bool        operator!=(const isr_tpc_pdcch_cfg_r14_c& other) const { return not(*this == other); }
  // getters
  setup_s_& setup()
  {
    assert_choice_type(types::setup, type_, "ISR-TPC-PDCCH-Config-r14");
    return c;
  }
  const setup_s_& setup() const
  {
...
struct isr_ul_cfg_ded_c {
  struct setup_s_ {
    ...
    typedef enumerated<isr_bw_opts> isr_bw_e_;
    struct isr_hop_bw_opts {
    ...
    typedef enumerated<isr_hop_bw_opts> isr_hop_bw_e_;
    ...
    // member variables
    isr_bw_e_       isr_bw;
    isr_hop_bw_e_   isr_hop_bw;
    uint8_t         freq_domain_position = 0;
    bool            dur                  = false;
    uint16_t        isr_cfg_idx          = 0;
    uint8_t         tx_comb              = 0;
  ...
  // choice methods
  isr_ul_cfg_ded_c() = default;
  void        set(types::options e = types::nulltype);
  types       type() const { return type_; }
  ISRASN_CODE pack(bit_ref& bref) const;
  ISRASN_CODE unpack(cbit_ref& bref);
  void        to_json(json_writer& j) const;
  bool        operator==(const isr_ul_cfg_ded_c& other) const;
  bool        operator!=(const isr_ul_cfg_ded_c& other) const { return not(*this == other); }
  // getters
  setup_s_& setup()
  {
...
struct isr_ul_cfg_ded_v1020_s {
  isr_ant_port_e isr_ant_port_r10;

  // sequence methods
  ISRASN_CODE pack(bit_ref& bref) const;
  ISRASN_CODE unpack(cbit_ref& bref);
  void        to_json(json_writer& j) const;
  bool        operator==(const isr_ul_cfg_ded_v1020_s& other) const;
  bool        operator!=(const isr_ul_cfg_ded_v1020_s& other) const { return not(*this == other); }
};

// SoundingRS-UL-ConfigDedicated-v1310 ::= CHOICE
struct isr_ul_cfg_ded_v1310_c {
  struct setup_s_ {
  ...
  // choice methods
  isr_ul_cfg_ded_v1310_c() = default;
  void        set(types::options e = types::nulltype);
  types       type() const { return type_; }
  ISRASN_CODE pack(bit_ref& bref) const;
  ISRASN_CODE unpack(cbit_ref& bref);
  void        to_json(json_writer& j) const;
  bool        operator==(const isr_ul_cfg_ded_v1310_c& other) const;
  bool        operator!=(const isr_ul_cfg_ded_v1310_c& other) const { return not(*this == other); }
  // getters
  setup_s_& setup()
  {
...
struct isr_ul_cfg_ded_aperiodic_r10_c {
  struct setup_s_ {
    using isr_cfg_ap_dci_format4_r10_l_ = dyn_array<isr_cfg_ap_r10_s>;
    struct isr_activ_ap_r10_c_ {
      struct setup_s_ {
        bool             ext = false;
        isr_cfg_ap_r10_s isr_cfg_ap_dci_format0_r10;
        isr_cfg_ap_r10_s isr_cfg_ap_dci_format1a2b2c_r10;
        // ...
      };
      using types = setup_e;

      // choice methods
      isr_activ_ap_r10_c_() = default;
      void        set(types::options e = types::nulltype);
      types       type() const { return type_; }
      ISRASN_CODE pack(bit_ref& bref) const;
      ISRASN_CODE unpack(cbit_ref& bref);
      void        to_json(json_writer& j) const;
      bool        operator==(const isr_activ_ap_r10_c_& other) const;
      bool        operator!=(const isr_activ_ap_r10_c_& other) const { return not(*this == other); }
      // getters
      setup_s_& setup()
      {
        assert_choice_type(types::setup, type_, "isr-ActivateAp-r10");
        return c;
      }
      const setup_s_& setup() const
      {
    ...
    // member variables
    bool                          isr_cfg_ap_dci_format4_r10_present = false;
    bool                          isr_activ_ap_r10_present           = false;
    uint8_t                       isr_cfg_idx_ap_r10                 = 0;
    isr_cfg_ap_dci_format4_r10_l_ isr_cfg_ap_dci_format4_r10;
    isr_activ_ap_r10_c_           isr_activ_ap_r10;
  };
  using types = setup_e;

  // choice methods
  isr_ul_cfg_ded_aperiodic_r10_c() = default;
  void        set(types::options e = types::nulltype);
  types       type() const { return type_; }
  ISRASN_CODE pack(bit_ref& bref) const;
  ISRASN_CODE unpack(cbit_ref& bref);
  void        to_json(json_writer& j) const;
  bool        operator==(const isr_ul_cfg_ded_aperiodic_r10_c& other) const;
  bool        operator!=(const isr_ul_cfg_ded_aperiodic_r10_c& other) const { return not(*this == other); }
  // getters
  setup_s_& setup()
  {
...
struct isr_ul_cfg_ded_aperiodic_v1310_c {
  struct setup_s_ {
    using isr_cfg_ap_dci_format4_v1310_l_ = dyn_array<isr_cfg_ap_v1310_s>;
    struct isr_activ_ap_v1310_c_ {
      struct setup_s_ {
        bool               isr_cfg_ap_dci_format0_v1310_present      = false;
        bool               isr_cfg_ap_dci_format1a2b2c_v1310_present = false;
        isr_cfg_ap_v1310_s isr_cfg_ap_dci_format0_v1310;
        isr_cfg_ap_v1310_s isr_cfg_ap_dci_format1a2b2c_v1310;
      };
      using types = setup_e;

      // choice methods
      isr_activ_ap_v1310_c_() = default;
      void        set(types::options e = types::nulltype);
      types       type() const { return type_; }
      ISRASN_CODE pack(bit_ref& bref) const;
      ISRASN_CODE unpack(cbit_ref& bref);
      void        to_json(json_writer& j) const;
      bool        operator==(const isr_activ_ap_v1310_c_& other) const;
      bool        operator!=(const isr_activ_ap_v1310_c_& other) const { return not(*this == other); }
      // getters
      setup_s_& setup()
      {
        assert_choice_type(types::setup, type_, "isr-ActivateAp-v1310");
        return c;
      }
      const setup_s_& setup() const
      {
    ...
    // member variables
    bool                            isr_cfg_ap_dci_format4_v1310_present = false;
    bool                            isr_activ_ap_v1310_present           = false;
    isr_cfg_ap_dci_format4_v1310_l_ isr_cfg_ap_dci_format4_v1310;
    isr_activ_ap_v1310_c_           isr_activ_ap_v1310;
  };
  using types = setup_e;

  // choice methods
  isr_ul_cfg_ded_aperiodic_v1310_c() = default;
  void        set(types::options e = types::nulltype);
  types       type() const { return type_; }
  ISRASN_CODE pack(bit_ref& bref) const;
  ISRASN_CODE unpack(cbit_ref& bref);
  void        to_json(json_writer& j) const;
  bool        operator==(const isr_ul_cfg_ded_aperiodic_v1310_c& other) const;
  bool        operator!=(const isr_ul_cfg_ded_aperiodic_v1310_c& other) const { return not(*this == other); }
  // getters
  setup_s_& setup()
  {
...
struct isr_ul_cfg_ded_aperiodic_up_pts_ext_r13_c {
  struct setup_s_ {
    struct isr_up_pts_add_r13_opts {
    ...
    typedef enumerated<isr_up_pts_add_r13_opts> isr_up_pts_add_r13_e_;
    using isr_cfg_ap_dci_format4_r13_l_ = dyn_array<isr_cfg_ap_r13_s>;
    struct isr_activ_ap_r13_c_ {
      struct setup_s_ {
        isr_cfg_ap_r13_s isr_cfg_ap_dci_format0_r13;
        isr_cfg_ap_r13_s isr_cfg_ap_dci_format1a2b2c_r13;
      };
      using types = setup_e;

      // choice methods
      isr_activ_ap_r13_c_() = default;
      void        set(types::options e = types::nulltype);
      types       type() const { return type_; }
      ISRASN_CODE pack(bit_ref& bref) const;
      ISRASN_CODE unpack(cbit_ref& bref);
      void        to_json(json_writer& j) const;
      bool        operator==(const isr_activ_ap_r13_c_& other) const;
      bool        operator!=(const isr_activ_ap_r13_c_& other) const { return not(*this == other); }
      // getters
      setup_s_& setup()
      {
        assert_choice_type(types::setup, type_, "isr-ActivateAp-r13");
        return c;
      }
      const setup_s_& setup() const
      {
    ...
    // member variables
    bool                          isr_cfg_ap_dci_format4_r13_present = false;
    bool                          isr_activ_ap_r13_present           = false;
    isr_up_pts_add_r13_e_         isr_up_pts_add_r13;
    uint8_t                       isr_cfg_idx_ap_r13 = 0;
    isr_cfg_ap_dci_format4_r13_l_ isr_cfg_ap_dci_format4_r13;
    isr_activ_ap_r13_c_           isr_activ_ap_r13;
  };
  using types = setup_e;

  // choice methods
  isr_ul_cfg_ded_aperiodic_up_pts_ext_r13_c() = default;
  void        set(types::options e = types::nulltype);
  types       type() const { return type_; }
  ISRASN_CODE pack(bit_ref& bref) const;
  ISRASN_CODE unpack(cbit_ref& bref);
  void        to_json(json_writer& j) const;
  bool        operator==(const isr_ul_cfg_ded_aperiodic_up_pts_ext_r13_c& other) const;
  bool        operator!=(const isr_ul_cfg_ded_aperiodic_up_pts_ext_r13_c& other) const { return not(*this == other); }
  // getters
  setup_s_& setup()
  {
...
struct isr_ul_cfg_ded_up_pts_ext_r13_c {
  struct setup_s_ {
    struct isr_up_pts_add_r13_opts {
      enum options { sym2, sym4, nulltype } value;
      typedef uint8_t number_type;
    ...
    typedef enumerated<isr_bw_r13_opts> isr_bw_r13_e_;
    struct isr_hop_bw_r13_opts {
      enum options { hbw0, hbw1, hbw2, hbw3, nulltype } value;
      typedef uint8_t number_type;
    ...
    typedef enumerated<isr_hop_bw_r13_opts> isr_hop_bw_r13_e_;
    ...
    // member variables
    isr_up_pts_add_r13_e_ isr_up_pts_add_r13;
    isr_bw_r13_e_         isr_bw_r13;
    isr_hop_bw_r13_e_     isr_hop_bw_r13;
    uint8_t               freq_domain_position_r13 = 0;
    bool                  dur_r13                  = false;
    uint16_t              isr_cfg_idx_r13          = 0;
    uint8_t               tx_comb_r13              = 0;
    cyclic_shift_r13_e_   cyclic_shift_r13;
    isr_ant_port_e        isr_ant_port_r13;
    tx_comb_num_r13_e_    tx_comb_num_r13;
  };
  using types = setup_e;

  // choice methods
  isr_ul_cfg_ded_up_pts_ext_r13_c() = default;
  void        set(types::options e = types::nulltype);
  types       type() const { return type_; }
  ISRASN_CODE pack(bit_ref& bref) const;
  ISRASN_CODE unpack(cbit_ref& bref);
  void        to_json(json_writer& j) const;
  bool        operator==(const isr_ul_cfg_ded_up_pts_ext_r13_c& other) const;
  bool        operator!=(const isr_ul_cfg_ded_up_pts_ext_r13_c& other) const { return not(*this == other); }
  // getters
  setup_s_& setup()
  {
...
struct ul_pwr_ctrl_ded_v1130_s {
  bool                                 pisr_offset_v1130_present                  = false;
  bool                                 pisr_offset_ap_v1130_present               = false;
  bool                                 delta_tx_d_offset_list_pucch_v1130_present = false;
  uint8_t                              pisr_offset_v1130                          = 16;
  uint8_t                              pisr_offset_ap_v1130                       = 16;
...
struct phys_cfg_ded_s {
  ...
  struct type_a_isr_tpc_pdcch_group_r14_c_ {
    using setup_l_ = dyn_array<isr_tpc_pdcch_cfg_r14_c>;
    using types    = setup_e;

    // choice methods
    type_a_isr_tpc_pdcch_group_r14_c_() = default;
    void        set(types::options e = types::nulltype);
    types       type() const { return type_; }
    ISRASN_CODE pack(bit_ref& bref) const;
    ISRASN_CODE unpack(cbit_ref& bref);
    ...
    setup_l_& setup()
    {
      assert_choice_type(types::setup, type_, "typeA-ISR-TPC-PDCCH-Group-r14");
      return c;
    }
    const setup_l_& setup() const
    {
  ...
  using isr_ul_periodic_cfg_ded_list_r14_l_            = dyn_array<isr_ul_cfg_ded_c>;
  using isr_ul_periodic_cfg_ded_up_pts_ext_list_r14_l_ = dyn_array<isr_ul_cfg_ded_up_pts_ext_r13_c>;
  using isr_ul_aperiodic_cfg_ded_list_r14_l_           = dyn_array<isr_ul_cfg_ded_aperiodic_r10_c>;
  using isr_ul_cfg_ded_ap_up_pts_ext_list_r14_l_       = dyn_array<isr_ul_cfg_ded_aperiodic_up_pts_ext_r13_c>;
  ...
  bool                isr_ul_cfg_ded_present      = false;
  ...
  isr_ul_cfg_ded_c    isr_ul_cfg_ded;
  ...
  copy_ptr<isr_ul_cfg_ded_v1020_s>         isr_ul_cfg_ded_v1020;
  copy_ptr<isr_ul_cfg_ded_aperiodic_r10_c> isr_ul_cfg_ded_aperiodic_r10;
  ...
  copy_ptr<isr_ul_cfg_ded_v1310_c>                    isr_ul_cfg_ded_v1310;
  copy_ptr<isr_ul_cfg_ded_up_pts_ext_r13_c>           isr_ul_cfg_ded_up_pts_ext_r13;
  copy_ptr<isr_ul_cfg_ded_aperiodic_v1310_c>          isr_ul_cfg_ded_aperiodic_v1310;
  copy_ptr<isr_ul_cfg_ded_aperiodic_up_pts_ext_r13_c> isr_ul_cfg_ded_aperiodic_up_pts_ext_r13;
  ...
  copy_ptr<type_a_isr_tpc_pdcch_group_r14_c_>              type_a_isr_tpc_pdcch_group_r14;
  ...
  copy_ptr<isr_ul_periodic_cfg_ded_list_r14_l_>            isr_ul_periodic_cfg_ded_list_r14;
  copy_ptr<isr_ul_periodic_cfg_ded_up_pts_ext_list_r14_l_> isr_ul_periodic_cfg_ded_up_pts_ext_list_r14;
  copy_ptr<isr_ul_aperiodic_cfg_ded_list_r14_l_>           isr_ul_aperiodic_cfg_ded_list_r14;
  copy_ptr<isr_ul_cfg_ded_ap_up_pts_ext_list_r14_l_>       isr_ul_cfg_ded_ap_up_pts_ext_list_r14;
