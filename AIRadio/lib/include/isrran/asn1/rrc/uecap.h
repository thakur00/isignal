...
#ifndef ISRASN1_RRC_UECAP_H
#define ISRASN1_RRC_UECAP_H
...
struct isr_cap_per_band_pair_r14_s {
...
struct band_params_v1430_s {
  ...
  using isr_cap_per_band_pair_list_r14_l_       = dyn_array<isr_cap_per_band_pair_r14_s>;
  ...
  bool                                    isr_cap_per_band_pair_list_r14_present       = false;
  ...
  isr_cap_per_band_pair_list_r14_l_       isr_cap_per_band_pair_list_r14;
...
struct band_combination_params_v1470_s {
  ...
  bool                     isr_max_simul_ccs_r14_present = false;
  band_param_list_v1470_l_ band_param_list_v1470;
  uint8_t                  isr_max_simul_ccs_r14 = 1;
...
struct isr_cap_per_band_pair_v14b0_s {
  bool isr_flex_timing_r14_present  = false;
  bool isr_harq_ref_cfg_r14_present = false;
...
struct band_params_v14b0_s {
  using isr_cap_per_band_pair_list_v14b0_l_ = dyn_array<isr_cap_per_band_pair_v14b0_s>;

  // member variables
  bool                                isr_cap_per_band_pair_list_v14b0_present = false;
  isr_cap_per_band_pair_list_v14b0_l_ isr_cap_per_band_pair_list_v14b0;
...
struct band_params_v1530_s {
  bool                       ue_tx_ant_sel_isr_minus1_t4_r_r15_present              = false;
  bool                       ue_tx_ant_sel_isr_minus2_t4_r_minus2_pairs_r15_present = false;
  bool                       ue_tx_ant_sel_isr_minus2_t4_r_minus3_pairs_r15_present = false;
...
struct mimo_ue_params_r13_s {
  bool                        params_tm9_r13_present                 = false;
  bool                        params_tm10_r13_present                = false;
  bool                        isr_enhance_tdd_r13_present            = false;
  bool                        isr_enhance_r13_present                = false;
...
struct phy_layer_params_v1250_s {
  ...
  bool                 pusch_isr_pwr_ctrl_sf_set_r12_present        = false;
...
struct phy_layer_params_v1430_s {
  ...
  bool                         ce_isr_enhancement_r14_present         = false;
...
struct phy_layer_params_v1470_s {
  ...
  bool                   isr_up_pts_minus6sym_r14_present = false;
...
struct phy_layer_params_v1530_s {
  struct stti_spt_cap_r15_s_ {
    ...
    bool                                    isr_dci7_trigger_fs2_r15_present                  = false;
...
struct phy_layer_params_v1450_s {
  bool ce_isr_enhancement_without_comb4_r14_present = false;
