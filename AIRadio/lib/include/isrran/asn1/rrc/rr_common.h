...
#ifndef ISRASN1_RRC_RR_COMMON_H
#define ISRASN1_RRC_RR_COMMON_H
...
struct isr_ul_cfg_common_c {
  struct setup_s_ {
    struct isr_bw_cfg_opts {
    ...
    typedef enumerated<isr_bw_cfg_opts> isr_bw_cfg_e_;
    struct isr_sf_cfg_opts {
      enum options {
        sc0,
        sc1,
        sc2,
    ...
    typedef enumerated<isr_sf_cfg_opts> isr_sf_cfg_e_;

    // member variables
    bool          isr_max_up_pts_present = false;
    isr_bw_cfg_e_ isr_bw_cfg;
    isr_sf_cfg_e_ isr_sf_cfg;
    bool          ack_nack_isr_simul_tx = false;
  };
  using types = setup_e;

  // choice methods
  isr_ul_cfg_common_c() = default;
  void        set(types::options e = types::nulltype);
  types       type() const { return type_; }
  ISRASN_CODE pack(bit_ref& bref) const;
  ISRASN_CODE unpack(cbit_ref& bref);
  void        to_json(json_writer& j) const;
  bool        operator==(const isr_ul_cfg_common_c& other) const;
  bool        operator!=(const isr_ul_cfg_common_c& other) const { return not(*this == other); }
  // getters
  setup_s_& setup()
  {
...
struct rr_cfg_common_sib_s {
  ...
  isr_ul_cfg_common_c  isr_ul_cfg_common;
...
struct ul_pwr_ctrl_common_pusch_less_cell_v1430_s {
  bool        p0_nominal_periodic_isr_r14_present  = false;
  bool        p0_nominal_aperiodic_isr_r14_present = false;
  bool        alpha_isr_r14_present                = false;
  int8_t      p0_nominal_periodic_isr_r14          = -126;
  int8_t      p0_nominal_aperiodic_isr_r14         = -126;
  alpha_r12_e alpha_isr_r14;
...
struct rr_cfg_common_scell_r10_s {
  ...
  struct ul_cfg_r10_s_ {
    ...
    isr_ul_cfg_common_c            isr_ul_cfg_common_r10;
  ...
  struct ul_cfg_r14_s_ {
    ...
    int8_t                                     p_max_r14 = -30;
    isr_ul_cfg_common_c                        isr_ul_cfg_common_r14;
...
struct rr_cfg_common_s {
  ...
  bool                 isr_ul_cfg_common_present  = false;
