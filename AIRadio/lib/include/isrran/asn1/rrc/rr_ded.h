...
#ifndef ISRASN1_RRC_RRCFG_H
#define ISRASN1_RRC_RRCFG_H
...
struct isr_ul_cfg_ded_aperiodic_v1430_c {
  struct setup_s_ {
    bool    isr_sf_ind_r14_present = false;
    uint8_t isr_sf_ind_r14         = 1;
  };
  using types = setup_e;

  // choice methods
  isr_ul_cfg_ded_aperiodic_v1430_c() = default;
  void        set(types::options e = types::nulltype);
  types       type() const { return type_; }
  ISRASN_CODE pack(bit_ref& bref) const;
  ISRASN_CODE unpack(cbit_ref& bref);
  void        to_json(json_writer& j) const;
  bool        operator==(const isr_ul_cfg_ded_aperiodic_v1430_c& other) const;
  bool        operator!=(const isr_ul_cfg_ded_aperiodic_v1430_c& other) const { return not(*this == other); }
  // getters
  setup_s_& setup()
  {
...
struct laa_scell_cfg_v1430_s {
  ...
  bool                              isr_ul_cfg_ded_aperiodic_v1430_present      = false;
  ...
  isr_ul_cfg_ded_aperiodic_v1430_c  isr_ul_cfg_ded_aperiodic_v1430;
...
struct isr_aperiodic_set_r14_s {
  using isr_cc_set_idx_list_r14_l_ = dyn_array<isr_cc_set_idx_r14_s>;

  // member variables
  bool                           isr_cc_set_idx_list_r14_present = false;
  isr_cc_set_idx_list_r14_l_     isr_cc_set_idx_list_r14;
  isr_ul_cfg_ded_aperiodic_r10_c isr_ul_cfg_ded_aperiodic_r14;

  // sequence methods
  ISRASN_CODE pack(bit_ref& bref) const;
  ISRASN_CODE unpack(cbit_ref& bref);
  void        to_json(json_writer& j) const;
  bool        operator==(const isr_aperiodic_set_r14_s& other) const;
  bool        operator!=(const isr_aperiodic_set_r14_s& other) const { return not(*this == other); }
};

// SoundingRS-AperiodicSetUpPTsExt-r14 ::= SEQUENCE
struct isr_aperiodic_set_up_pts_ext_r14_s {
  using isr_cc_set_idx_list_r14_l_ = dyn_array<isr_cc_set_idx_r14_s>;

  // member variables
  bool                                      isr_cc_set_idx_list_r14_present = false;
  isr_cc_set_idx_list_r14_l_                isr_cc_set_idx_list_r14;
  isr_ul_cfg_ded_aperiodic_up_pts_ext_r13_c isr_ul_cfg_ded_aperiodic_up_pts_ext_r14;

  // sequence methods
  ISRASN_CODE pack(bit_ref& bref) const;
  ISRASN_CODE unpack(cbit_ref& bref);
  void        to_json(json_writer& j) const;
  bool        operator==(const isr_aperiodic_set_up_pts_ext_r14_s& other) const;
  bool        operator!=(const isr_aperiodic_set_up_pts_ext_r14_s& other) const { return not(*this == other); }
};
...
struct ul_pusch_less_pwr_ctrl_ded_v1430_s {
  bool   p0_ue_periodic_isr_r14_present  = false;
  bool   p0_ue_aperiodic_isr_r14_present = false;
  int8_t p0_ue_periodic_isr_r14          = -8;
  int8_t p0_ue_aperiodic_isr_r14         = -8;
...
struct phys_cfg_ded_scell_r10_s {
  ...
  struct ul_cfg_r10_s_ {
    ...
    bool                           isr_ul_cfg_ded_r10_present           = false;
    bool                           isr_ul_cfg_ded_v1020_present         = false;
    bool                           isr_ul_cfg_ded_aperiodic_r10_present = false;
    ...
    isr_ul_cfg_ded_c               isr_ul_cfg_ded_r10;
    isr_ul_cfg_ded_v1020_s         isr_ul_cfg_ded_v1020;
    isr_ul_cfg_ded_aperiodic_r10_c isr_ul_cfg_ded_aperiodic_r10;
  };
  ...
  using isr_ul_aperiodic_cfg_ded_list_r14_l_           = dyn_array<isr_aperiodic_set_r14_s>;
  using isr_ul_cfg_ded_ap_up_pts_ext_list_r14_l_       = dyn_array<isr_aperiodic_set_up_pts_ext_r14_s>;
  ...
  copy_ptr<isr_tpc_pdcch_cfg_r14_c>                        type_b_isr_tpc_pdcch_cfg_r14;
...
struct scell_to_add_mod_r10_s {
  ...
  // group 2
  bool    isr_switch_from_serv_cell_idx_r14_present = false;
  uint8_t isr_switch_from_serv_cell_idx_r14         = 0;
  // group 3
