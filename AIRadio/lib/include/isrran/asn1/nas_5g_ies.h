 ...
 *
 */
#ifndef ISRRAN_NAS_5G_IES_H
#define ISRRAN_NAS_5G_IES_H
...
public:
  ...
  public:
    ...
    ISRASN_CODE pack(asn1::bit_ref& bref, asn1::bit_ref& bref_tmp);
    ISRASN_CODE unpack(asn1::cbit_ref& bref, uint8_t tmp, uint32_t length);
...
private:
  ...
  isrlog::detail::any choice_container;
