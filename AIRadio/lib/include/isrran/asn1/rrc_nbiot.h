...
#ifndef ISRASN1_RRC_NBIOT_H
#define ISRASN1_RRC_NBIOT_H
...
struct npusch_cfg_common_nb_r13_s {
  ...
  typedef enumerated<isr_sf_cfg_r13_opts> isr_sf_cfg_r13_e_;
