 ...
 *
 */
#ifndef ISRRAN_NAS_5G_MSG_H
#define ISRRAN_NAS_5G_MSG_H
...
public:
  ISRASN_CODE pack(asn1::bit_ref& bref);
...
struct nas_5gs_hdr {
  ...
  ISRASN_CODE pack(asn1::bit_ref& bref);
  ISRASN_CODE pack_outer(asn1::bit_ref& bref);
  ISRASN_CODE unpack(asn1::cbit_ref& bref);
  ISRASN_CODE unpack_outer(asn1::cbit_ref& bref);
};
...
public:
  ...
  ISRASN_CODE pack(unique_byte_buffer_t& buf);
  ISRASN_CODE pack(std::vector<uint8_t>& buf);
  ISRASN_CODE unpack(const unique_byte_buffer_t& buf);
  ISRASN_CODE unpack(const std::vector<uint8_t>& buf);
  ISRASN_CODE unpack_outer_hdr(const unique_byte_buffer_t& buf);
  ISRASN_CODE unpack_outer_hdr(const std::vector<uint8_t>& buf);
  ...
  registration_request_t& registration_request()
  {
    ...
    return *isrlog::detail::any_cast<registration_request_t>(&msg_container);
  }
  ...
  registration_accept_t& registration_accept()
  {
    ...
    return *isrlog::detail::any_cast<registration_accept_t>(&msg_container);
  }
  ...
  registration_complete_t& registration_complete()
  {
    ...
    return *isrlog::detail::any_cast<registration_complete_t>(&msg_container);
  }
  ...
  registration_reject_t& registration_reject()
  {
    ...
    return *isrlog::detail::any_cast<registration_reject_t>(&msg_container);
  }
  ...
  deregistration_request_ue_originating_t& deregistration_request_ue_originating()
  {
    ...
    return *isrlog::detail::any_cast<deregistration_request_ue_originating_t>(&msg_container);
  }
  ...
  deregistration_accept_ue_originating_t& deregistration_accept_ue_originating()
  {
    ...
    return *isrlog::detail::any_cast<deregistration_accept_ue_originating_t>(&msg_container);
  }
  ...
  deregistration_request_ue_terminated_t& deregistration_request_ue_terminated()
  {
    ...
    return *isrlog::detail::any_cast<deregistration_request_ue_terminated_t>(&msg_container);
  }
  ...
  deregistration_accept_ue_terminated_t& deregistration_accept_ue_terminated()
  {
    ...
    return *isrlog::detail::any_cast<deregistration_accept_ue_terminated_t>(&msg_container);
  }
  ...
  configuration_update_command_t& configuration_update_command()
  {
    ...
    return *isrlog::detail::any_cast<configuration_update_command_t>(&msg_container);
  }
  ...
  configuration_update_complete_t& configuration_update_complete()
  {
    ...
    return *isrlog::detail::any_cast<configuration_update_complete_t>(&msg_container);
  }
  ...
  authentication_request_t& authentication_request()
  {
    ...
    return *isrlog::detail::any_cast<authentication_request_t>(&msg_container);
  }
  ...
  authentication_response_t& authentication_response()
  {
    ...
    return *isrlog::detail::any_cast<authentication_response_t>(&msg_container);
  }
  ...
  authentication_reject_t& authentication_reject()
  {
    ...
    return *isrlog::detail::any_cast<authentication_reject_t>(&msg_container);
  }
  ...
  authentication_failure_t& authentication_failure()
  {
    ...
    return *isrlog::detail::any_cast<authentication_failure_t>(&msg_container);
  }
  ...
  authentication_result_t& authentication_result()
  {
    ...
    return *isrlog::detail::any_cast<authentication_result_t>(&msg_container);
  }
  ...
  identity_request_t& identity_request()
  {
    ...
    return *isrlog::detail::any_cast<identity_request_t>(&msg_container);
  }
  ...
  identity_response_t& identity_response()
  {
    ...
    return *isrlog::detail::any_cast<identity_response_t>(&msg_container);
  }
  ...
  security_mode_command_t& security_mode_command()
  {
    ...
    return *isrlog::detail::any_cast<security_mode_command_t>(&msg_container);
  }
  ...
  security_mode_complete_t& security_mode_complete()
  {
    ...
    return *isrlog::detail::any_cast<security_mode_complete_t>(&msg_container);
  }
  ...
  notification_response_t& notification_response()
  {
    ...
    return *isrlog::detail::any_cast<notification_response_t>(&msg_container);
  }
  ...
  ul_nas_transport_t& ul_nas_transport()
  {
    ...
    return *isrlog::detail::any_cast<ul_nas_transport_t>(&msg_container);
  }
  ...
  dl_nas_transport_t& dl_nas_transport()
  {
    ...
    return *isrlog::detail::any_cast<dl_nas_transport_t>(&msg_container);
  }
  ...
  pdu_session_establishment_request_t& pdu_session_establishment_request()
  {
    ...
    return *isrlog::detail::any_cast<pdu_session_establishment_request_t>(&msg_container);
  }
  ...
  pdu_session_establishment_accept_t& pdu_session_establishment_accept()
  {
    ...
    return *isrlog::detail::any_cast<pdu_session_establishment_accept_t>(&msg_container);
  }
  ...
  pdu_session_establishment_reject_t& pdu_session_establishment_reject()
  {
    ...
    return *isrlog::detail::any_cast<pdu_session_establishment_reject_t>(&msg_container);
  }
  ...
  pdu_session_authentication_command_t& pdu_session_authentication_command()
  {
    ...
    return *isrlog::detail::any_cast<pdu_session_authentication_command_t>(&msg_container);
  }
  ...
  pdu_session_authentication_complete_t& pdu_session_authentication_complete()
  {
    ...
    return *isrlog::detail::any_cast<pdu_session_authentication_complete_t>(&msg_container);
  }
  ...
  pdu_session_authentication_result_t& pdu_session_authentication_result()
  {
    ...
    return *isrlog::detail::any_cast<pdu_session_authentication_result_t>(&msg_container);
  }
  ...
  pdu_session_modification_request_t& pdu_session_modification_request()
  {
    ...
    return *isrlog::detail::any_cast<pdu_session_modification_request_t>(&msg_container);
  }
  ...
  pdu_session_modification_reject_t& pdu_session_modification_reject()
  {
    ...
    return *isrlog::detail::any_cast<pdu_session_modification_reject_t>(&msg_container);
  }
  ...
  pdu_session_modification_command_t& pdu_session_modification_command()
  {
    ...
    return *isrlog::detail::any_cast<pdu_session_modification_command_t>(&msg_container);
  }
  ...
  pdu_session_modification_complete_t& pdu_session_modification_complete()
  {
    ...
    return *isrlog::detail::any_cast<pdu_session_modification_complete_t>(&msg_container);
  }
  ...
  pdu_session_modification_command_reject_t& pdu_session_modification_command_reject()
  {
    ...
    return *isrlog::detail::any_cast<pdu_session_modification_command_reject_t>(&msg_container);
  }
  ...
  pdu_session_release_request_t& pdu_session_release_request()
  {
    ...
    return *isrlog::detail::any_cast<pdu_session_release_request_t>(&msg_container);
  }
  ...
  pdu_session_release_reject_t& pdu_session_release_reject()
  {
    ...
    return *isrlog::detail::any_cast<pdu_session_release_reject_t>(&msg_container);
  }
  ...
  pdu_session_release_command_t& pdu_session_release_command()
  {
    ...
    return *isrlog::detail::any_cast<pdu_session_release_command_t>(&msg_container);
  }
  ...
  pdu_session_release_complete_t& pdu_session_release_complete()
  {
    ...
    return *isrlog::detail::any_cast<pdu_session_release_complete_t>(&msg_container);
  }

  status_5gsm_t& status_5gsm()
  {
    asn1::assert_choice_type(msg_types::options::status_5gsm, hdr.message_type, "status_5gsm");
    return *isrlog::detail::any_cast<status_5gsm_t>(&msg_container);
  }
...
private:
  ISRASN_CODE         unpack(asn1::cbit_ref& bref);
  ISRASN_CODE         pack(asn1::bit_ref& bref);
  isrlog::detail::any msg_container = isrlog::detail::any{registration_request_t()};
};
} // namespace nas_5g
} // namespace isrran
#endif
