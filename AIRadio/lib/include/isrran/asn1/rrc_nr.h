...
#ifndef ISRASN1_RRC_NR_H
#define ISRASN1_RRC_NR_H
...
#define ASN1_RRC_NR_MAX_NROF_ISR_RES_SETS 16
#define ASN1_RRC_NR_MAX_NROF_ISR_RES_SETS_MINUS1 15
#define ASN1_RRC_NR_MAX_NROF_ISR_RES 64
#define ASN1_RRC_NR_MAX_NROF_ISR_RES_MINUS1 63
#define ASN1_RRC_NR_MAX_NROF_ISR_RES_PER_SET 16
#define ASN1_RRC_NR_MAX_NROF_ISR_TRIGGER_STATES_MINUS1 3
#define ASN1_RRC_NR_MAX_NROF_ISR_TRIGGER_STATES_MINUS2 2
...
// ISR-TPC-CommandConfig ::= SEQUENCE
struct isr_tpc_cmd_cfg_s {
  bool    ext                                 = false;
...
struct pdcch_cfg_s {
  ...
  setup_release_c<isr_tpc_cmd_cfg_s>   tpc_isr;
  // ...
...
// ISR-PeriodicityAndOffset ::= CHOICE
struct isr_periodicity_and_offset_c {
  struct types_opts {
    enum options {
      sl1,
      sl2,
  ...
  // choice methods
  isr_periodicity_and_offset_c() = default;
  isr_periodicity_and_offset_c(const isr_periodicity_and_offset_c& other);
  isr_periodicity_and_offset_c& operator=(const isr_periodicity_and_offset_c& other);
  ~isr_periodicity_and_offset_c() { destroy_(); }
  void        set(types::options e = types::nulltype);
  types       type() const { return type_; }
  ISRASN_CODE pack(bit_ref& bref) const;
  ISRASN_CODE unpack(cbit_ref& bref);
  ...
  uint8_t& sl2()
  {
    assert_choice_type(types::sl2, type_, "ISR-PeriodicityAndOffset");
    return c.get<uint8_t>();
  }
  uint8_t& sl4()
  {
    assert_choice_type(types::sl4, type_, "ISR-PeriodicityAndOffset");
    return c.get<uint8_t>();
  }
  uint8_t& sl5()
  {
    assert_choice_type(types::sl5, type_, "ISR-PeriodicityAndOffset");
    return c.get<uint8_t>();
  }
  uint8_t& sl8()
  {
    assert_choice_type(types::sl8, type_, "ISR-PeriodicityAndOffset");
    return c.get<uint8_t>();
  }
  uint8_t& sl10()
  {
    assert_choice_type(types::sl10, type_, "ISR-PeriodicityAndOffset");
    return c.get<uint8_t>();
  }
  uint8_t& sl16()
  {
    assert_choice_type(types::sl16, type_, "ISR-PeriodicityAndOffset");
    return c.get<uint8_t>();
  }
  uint8_t& sl20()
  {
    assert_choice_type(types::sl20, type_, "ISR-PeriodicityAndOffset");
    return c.get<uint8_t>();
  }
  uint8_t& sl32()
  {
    assert_choice_type(types::sl32, type_, "ISR-PeriodicityAndOffset");
    return c.get<uint8_t>();
  }
  uint8_t& sl40()
  {
    assert_choice_type(types::sl40, type_, "ISR-PeriodicityAndOffset");
    return c.get<uint8_t>();
  }
  uint8_t& sl64()
  {
    assert_choice_type(types::sl64, type_, "ISR-PeriodicityAndOffset");
    return c.get<uint8_t>();
  }
  uint8_t& sl80()
  {
    assert_choice_type(types::sl80, type_, "ISR-PeriodicityAndOffset");
    return c.get<uint8_t>();
  }
  uint8_t& sl160()
  {
    assert_choice_type(types::sl160, type_, "ISR-PeriodicityAndOffset");
    return c.get<uint8_t>();
  }
  uint16_t& sl320()
  {
    assert_choice_type(types::sl320, type_, "ISR-PeriodicityAndOffset");
    return c.get<uint16_t>();
  }
  uint16_t& sl640()
  {
    assert_choice_type(types::sl640, type_, "ISR-PeriodicityAndOffset");
    return c.get<uint16_t>();
  }
  uint16_t& sl1280()
  {
    assert_choice_type(types::sl1280, type_, "ISR-PeriodicityAndOffset");
    return c.get<uint16_t>();
  }
  uint16_t& sl2560()
  {
    assert_choice_type(types::sl2560, type_, "ISR-PeriodicityAndOffset");
    return c.get<uint16_t>();
  }
  const uint8_t& sl2() const
  {
...
// ISR-SpatialRelationInfo ::= SEQUENCE
struct isr_spatial_relation_info_s {
  struct ref_sig_c_ {
    struct isr_s_ {
      uint8_t res_id = 0;
      uint8_t ul_bwp = 0;
    ...
    struct types_opts {
      enum options { ssb_idx, csi_rs_idx, isr, nulltype } value;
    ...
    isr_s_& isr()
    {
      assert_choice_type(types::isr, type_, "referenceSignal");
      return c.get<isr_s_>();
    }
    const uint8_t& ssb_idx() const
    {
...
// ISR-Resource ::= SEQUENCE
struct isr_res_s {
  struct nrof_isr_ports_opts {
  ...
  typedef enumerated<nrof_isr_ports_opts> nrof_isr_ports_e_;
  ...
  struct res_type_c_ {
    ...
    struct semi_persistent_s_ {
      bool                         ext = false;
      isr_periodicity_and_offset_c periodicity_and_offset_sp;
      // ...
    };
    struct periodic_s_ {
      bool                         ext = false;
      isr_periodicity_and_offset_c periodicity_and_offset_p;
      // ...
    };
    struct types_opts {
  ...
  uint8_t                     isr_res_id                    = 0;
  nrof_isr_ports_e_           nrof_isr_ports;
  ...
  uint16_t                    seq_id = 0;
  isr_spatial_relation_info_s spatial_relation_info;
  // ...
...
// ISR-ResourceSet ::= SEQUENCE
struct isr_res_set_s {
  using isr_res_id_list_l_ = bounded_array<uint8_t, 16>;
  struct res_type_c_ {
    struct aperiodic_s_ {
      using aperiodic_isr_res_trigger_list_l_ = bounded_array<uint8_t, 2>;

      // member variables
      bool    ext                       = false;
      bool    csi_rs_present            = false;
      bool    slot_offset_present       = false;
      uint8_t aperiodic_isr_res_trigger = 1;
      uint8_t csi_rs                    = 0;
      uint8_t slot_offset               = 1;
      // ...
      // group 0
      copy_ptr<aperiodic_isr_res_trigger_list_l_> aperiodic_isr_res_trigger_list;
  ...
  struct isr_pwr_ctrl_adjustment_states_opts {
  ...
  typedef enumerated<isr_pwr_ctrl_adjustment_states_opts> isr_pwr_ctrl_adjustment_states_e_;
  ...
  bool                              isr_pwr_ctrl_adjustment_states_present = false;
  uint8_t                           isr_res_set_id                         = 0;
  isr_res_id_list_l_                isr_res_id_list;
  res_type_c_                       res_type;
  usage_e_                          usage;
  alpha_e                           alpha;
  int16_t                           p0 = -202;
  pathloss_ref_rs_c_                pathloss_ref_rs;
  isr_pwr_ctrl_adjustment_states_e_ isr_pwr_ctrl_adjustment_states;
  // ...
...
struct cfgured_grant_cfg_s {
  ...
  struct rrc_cfgured_ul_grant_s_ {
    ...
    bool                isr_res_ind_present          = false;
...
// ISR-Config ::= SEQUENCE
struct isr_cfg_s {
  using isr_res_set_to_release_list_l_ = bounded_array<uint8_t, 16>;
  using isr_res_set_to_add_mod_list_l_ = dyn_array<isr_res_set_s>;
  using isr_res_to_release_list_l_     = dyn_array<uint8_t>;
  using isr_res_to_add_mod_list_l_     = dyn_array<isr_res_s>;

  // member variables
  bool                           ext                      = false;
  bool                           tpc_accumulation_present = false;
  isr_res_set_to_release_list_l_ isr_res_set_to_release_list;
  isr_res_set_to_add_mod_list_l_ isr_res_set_to_add_mod_list;
  isr_res_to_release_list_l_     isr_res_to_release_list;
  isr_res_to_add_mod_list_l_     isr_res_to_add_mod_list;
  // ...
...
struct bwp_ul_ded_s {
  ...
  setup_release_c<isr_cfg_s>                isr_cfg;
...
struct ca_params_nr_s {
  ...
  bool                 parallel_tx_isr_pucch_pusch_present                    = false;
  bool                 parallel_tx_prach_isr_pucch_pusch_present              = false;
...
// ISR-SwitchingTimeEUTRA ::= SEQUENCE
struct isr_switching_time_eutra_s {
...
// ISR-SwitchingTimeNR ::= SEQUENCE
struct isr_switching_time_nr_s {
  struct switching_time_dl_opts {
...
struct band_params_v1540_s {
  struct isr_carrier_switch_c_ {
    struct nr_s_ {
      using isr_switching_times_list_nr_l_ = dyn_array<isr_switching_time_nr_s>;

      // member variables
      isr_switching_times_list_nr_l_ isr_switching_times_list_nr;
    };
    struct eutra_s_ {
      using isr_switching_times_list_eutra_l_ = dyn_array<isr_switching_time_eutra_s>;

      // member variables
      isr_switching_times_list_eutra_l_ isr_switching_times_list_eutra;
    };
    struct types_opts {
      enum options { nr, eutra, nulltype } value;
    ...
    // choice methods
    isr_carrier_switch_c_() = default;
    isr_carrier_switch_c_(const isr_carrier_switch_c_& other);
    isr_carrier_switch_c_& operator=(const isr_carrier_switch_c_& other);
    ~isr_carrier_switch_c_() { destroy_(); }
    void        set(types::options e = types::nulltype);
    types       type() const { return type_; }
    ISRASN_CODE pack(bit_ref& bref) const;
    ISRASN_CODE unpack(cbit_ref& bref);
    ...
    nr_s_& nr()
    {
      assert_choice_type(types::nr, type_, "isr-CarrierSwitch");
      return c.get<nr_s_>();
    }
    eutra_s_& eutra()
    {
      assert_choice_type(types::eutra, type_, "isr-CarrierSwitch");
      return c.get<eutra_s_>();
    }
    const nr_s_& nr() const
    {
  ...
  struct isr_tx_switch_s_ {
    struct supported_isr_tx_port_switch_opts {
      enum options { t1r2, t1r4, t2r4, t1r4_t2r4, t1r1, t2r2, t4r4, not_supported, nulltype } value;

      const char* to_string() const;
    };
    typedef enumerated<supported_isr_tx_port_switch_opts> supported_isr_tx_port_switch_e_;

    // member variables
    bool                            tx_switch_impact_to_rx_present      = false;
    bool                            tx_switch_with_another_band_present = false;
    supported_isr_tx_port_switch_e_ supported_isr_tx_port_switch;
    uint8_t                         tx_switch_impact_to_rx      = 1;
    uint8_t                         tx_switch_with_another_band = 1;
  };

  // member variables
  bool                  isr_carrier_switch_present = false;
  bool                  isr_tx_switch_present      = false;
  isr_carrier_switch_c_ isr_carrier_switch;
  isr_tx_switch_s_      isr_tx_switch;
...
// CSI-RS-ProcFrameworkForISR ::= SEQUENCE
struct csi_rs_proc_framework_for_isr_s {
  uint8_t max_num_periodic_isr_assoc_csi_rs_per_bwp  = 1;
  uint8_t max_num_aperiodic_isr_assoc_csi_rs_per_bwp = 1;
  uint8_t max_num_sp_isr_assoc_csi_rs_per_bwp        = 0;
  uint8_t simul_isr_assoc_csi_rs_per_cc              = 1;
...
struct mimo_params_per_band_s {
  ...
  struct ul_beam_management_s_ {
    struct max_num_isr_res_per_set_bm_opts {
      enum options { n2, n4, n8, n16, nulltype } value;
      typedef uint8_t number_type;
    ...
    typedef enumerated<max_num_isr_res_per_set_bm_opts> max_num_isr_res_per_set_bm_e_;

    // member variables
    max_num_isr_res_per_set_bm_e_ max_num_isr_res_per_set_bm;
    uint8_t                       max_num_isr_res_set = 1;
  };
  ...
  using isr_assoc_csi_rs_l_ = dyn_array<supported_csi_rs_res_s>;
  ...
  copy_ptr<csi_rs_proc_framework_for_isr_s>    csi_rs_proc_framework_for_isr;
  copy_ptr<csi_report_framework_s>             csi_report_framework;
  copy_ptr<csi_rs_for_tracking_s>              csi_rs_for_tracking;
  copy_ptr<isr_assoc_csi_rs_l_>                isr_assoc_csi_rs;
...
// ISR-CC-SetIndex ::= SEQUENCE
struct isr_cc_set_idx_s {
...
// ISR-TPC-PDCCH-Config ::= SEQUENCE
struct isr_tpc_pdcch_cfg_s {
  using isr_cc_set_idxlist_l_ = dyn_array<isr_cc_set_idx_s>;

  // member variables
  isr_cc_set_idxlist_l_ isr_cc_set_idxlist;
...
// ISR-CarrierSwitching ::= SEQUENCE
struct isr_carrier_switching_s {
  struct isr_switch_from_carrier_opts {
    enum options { sul, nul, nulltype } value;

    const char* to_string() const;
  };
  typedef enumerated<isr_switch_from_carrier_opts> isr_switch_from_carrier_e_;
  struct isr_tpc_pdcch_group_c_ {
    using type_a_l_ = dyn_array<isr_tpc_pdcch_cfg_s>;
    struct types_opts {
      enum options { type_a, type_b, nulltype } value;
    ...
    // choice methods
    isr_tpc_pdcch_group_c_() = default;
    isr_tpc_pdcch_group_c_(const isr_tpc_pdcch_group_c_& other);
    isr_tpc_pdcch_group_c_& operator=(const isr_tpc_pdcch_group_c_& other);
    ~isr_tpc_pdcch_group_c_() { destroy_(); }
    void        set(types::options e = types::nulltype);
    types       type() const { return type_; }
    ISRASN_CODE pack(bit_ref& bref) const;
    ISRASN_CODE unpack(cbit_ref& bref);
    ...
    type_a_l_& type_a()
    {
      assert_choice_type(types::type_a, type_, "isr-TPC-PDCCH-Group");
      return c.get<type_a_l_>();
    }
    isr_tpc_pdcch_cfg_s& type_b()
    {
      assert_choice_type(types::type_b, type_, "isr-TPC-PDCCH-Group");
      return c.get<isr_tpc_pdcch_cfg_s>();
    }
    ...
    const isr_tpc_pdcch_cfg_s& type_b() const
    {
      assert_choice_type(types::type_b, type_, "isr-TPC-PDCCH-Group");
      return c.get<isr_tpc_pdcch_cfg_s>();
    }
    type_a_l_&           set_type_a();
    isr_tpc_pdcch_cfg_s& set_type_b();

  private:
    types                                           type_;
    choice_buffer_t<isr_tpc_pdcch_cfg_s, type_a_l_> c;
  ...
  // member variables
  bool                       ext                                   = false;
  bool                       isr_switch_from_serv_cell_idx_present = false;
  bool                       isr_tpc_pdcch_group_present           = false;
  uint8_t                    isr_switch_from_serv_cell_idx         = 0;
  isr_switch_from_carrier_e_ isr_switch_from_carrier;
  isr_tpc_pdcch_group_c_     isr_tpc_pdcch_group;
...
struct ul_cfg_s {
  ...
  setup_release_c<isr_carrier_switching_s>  carrier_switching;
  // ...
  // group 0
...
struct phys_cell_group_cfg_s {
  ...
  bool                                          tpc_isr_rnti_present                    = false;
...
struct feature_set_dl_v15a0_s {
  bool      supported_isr_res_present = false;
  isr_res_s supported_isr_res;
...
struct feature_set_ul_v1540_s {
  ...
  // member variables
  bool                      zero_slot_offset_aperiodic_isr_present = false;
...
struct feature_set_ul_per_cc_s {
  struct mimo_cb_pusch_s_ {
    ...
    uint8_t          max_num_isr_res_per_set = 1;
  };
...
struct feature_set_ul_per_cc_v1540_s {
  struct mimo_non_cb_pusch_s_ {
    uint8_t max_num_isr_res_per_set  = 1;
    uint8_t max_num_simul_isr_res_tx = 1;
  };
...
struct rf_params_s {
  ...
  // ...
  // group 0
  bool                                    isr_switching_time_requested_present = false;
...
struct ue_cap_request_filt_nr_v1540_s {
  bool isr_switching_time_request_present = false;
  bool non_crit_ext_present               = false;
