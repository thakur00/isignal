...
#ifndef ISRRAN_MAC_SCH_PDU_NR_H
#define ISRRAN_MAC_SCH_PDU_NR_H
...
public:
  ...
  mac_sch_subpdu_nr(mac_sch_pdu_nr* parent_) : parent(parent_), logger(&isrlog::fetch_basic_logger("MAC-NR")){};
...
{
public:
  mac_sch_pdu_nr(bool ulsch_ = false) : ulsch(ulsch_), logger(isrlog::fetch_basic_logger("MAC-NR")) {}
  ...
  // All functions will return ISRRAN_SUCCESS on success, and ISRRAN_ERROR otherwise
