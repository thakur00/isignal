...
#ifndef ISRRAN_RA_DL_NR_H
#define ISRRAN_RA_DL_NR_H
 ...
 */
ISRRAN_API int isrran_ra_dl_nr_time(const isrran_sch_hl_cfg_nr_t*    cfg,
 ...
 */
ISRRAN_API int
isrran_ra_dl_nr_time_default_A(uint32_t m, isrran_dmrs_sch_typeA_pos_t dmrs_typeA_pos, isrran_sch_grant_nr_t* grant);
 ...
 */
ISRRAN_API int isrran_ra_dl_nr_nof_front_load_symbols(const isrran_sch_hl_cfg_nr_t* cfg,
 ...
 * code
 */
ISRRAN_API int isrran_ra_dl_nr_nof_dmrs_cdm_groups_without_data(const isrran_sch_hl_cfg_nr_t* cfg,
                                                                const isrran_dci_dl_nr_t*     dci,
                                                                uint32_t                      L);
 ...
 */
ISRRAN_API int isrran_ra_dl_nr_freq(const isrran_carrier_nr_t*    carrier,
                                    const isrran_sch_hl_cfg_nr_t* cfg,
                                    const isrran_dci_dl_nr_t*     dci_dl,
                                    isrran_sch_grant_nr_t*        grant);

#endif // ISRRAN_RA_DL_NR_H
