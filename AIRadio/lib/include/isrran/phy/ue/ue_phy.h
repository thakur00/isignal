...
#include "isrran/phy/utils/queue.h"
#include "isrran/isrran.h"

#ifndef ISRRAN_UE_PHY_H
#define ISRRAN_UE_PHY_H
...
public:
  ...
  private:
    union {
      isrran_ra_ul_grant_t ul_grant;
      isrran_ra_dl_grant_t dl_grant;
    };
    direction_t dir;
  };
  ...
  {
  public:
    ul_buffer(isrran_cell_t cell);
    void generate_pusch(sched_grant pusch_grant, uint8_t* payload, isrran_uci_data_t uci_data);
    void generate_pucch(isrran_uci_data_t uci_data);
