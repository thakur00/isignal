...
#ifndef ISRRAN_DMRS_PDCCH_H
#define ISRRAN_DMRS_PDCCH_H
 ...
 *
 * @attention it expects sf_symbols to be size ISRRAN_SLOT_LEN_RE_NR(cfg->carrier.nof_prb)
 *
 ...
 */
ISRRAN_API int isrran_dmrs_pdcch_put(const isrran_carrier_nr_t*   carrier,
 ...
 *
 * @see isrran_dmrs_pdcch_estimator_init
 * @see isrran_dmrs_pdcch_estimator_free
 * @see isrran_dmrs_pdcch_estimator_estimate
 * @see isrran_dmrs_pdcch_estimator_measure
 */
typedef struct ISRRAN_API {
  ...
  isrran_interp_lin_t interpolator;
  ...
  cf_t* lse[ISRRAN_CORESET_DURATION_MAX];
 ...
 * @return ISRRAN_SUCCESS if the configurations are valid, otherwise it returns an ISRRAN_ERROR code
 */
ISRRAN_API int isrran_dmrs_pdcch_estimator_init(isrran_dmrs_pdcch_estimator_t* q,
 ...
 */
ISRRAN_API void isrran_dmrs_pdcch_estimator_free(isrran_dmrs_pdcch_estimator_t* q);
 ...
 * isrran_dmrs_pdcch_estimator_measure.
 *
 ...
 */
ISRRAN_API int
isrran_dmrs_pdcch_estimate(isrran_dmrs_pdcch_estimator_t* q, const isrran_slot_cfg_t* slot_cfg, const cf_t* sf_symbols);
 ...
 * @return ISRRAN_SUCCESS if the configurations are valid, otherwise it returns an ISRRAN_ERROR code
 */
ISRRAN_API int isrran_dmrs_pdcch_get_measure(const isrran_dmrs_pdcch_estimator_t* q,
 ...
 * @return ISRRAN_SUCCESS if the configurations are valid, otherwise it returns an ISRRAN_ERROR code
 */
ISRRAN_API int isrran_dmrs_pdcch_get_ce(const isrran_dmrs_pdcch_estimator_t* q,
                                        const isrran_dci_location_t*         location,
                                        isrran_dmrs_pdcch_ce_t*              ce);

#endif // ISRRAN_DMRS_PDCCH_H
