...
#ifndef ISRRAN_SIMD_H
#define ISRRAN_SIMD_H
...
#define ISRRAN_SIMD_BIT_ALIGN 512
#define ISRRAN_IS_ALIGNED(PTR) (((size_t)(PTR)&0x3F) == 0)
#else /* LV_HAVE_AVX512 */
#ifdef LV_HAVE_AVX
#define ISRRAN_SIMD_BIT_ALIGN 256
#define ISRRAN_IS_ALIGNED(PTR) (((size_t)(PTR)&0x1F) == 0)
#else /* LV_HAVE_AVX */
#ifdef LV_HAVE_SSE
#define ISRRAN_SIMD_BIT_ALIGN 128
#define ISRRAN_IS_ALIGNED(PTR) (((size_t)(PTR)&0x0F) == 0)
#else /* LV_HAVE_SSE */
#define ISRRAN_SIMD_BIT_ALIGN 64
#define ISRRAN_IS_ALIGNED(PTR) (1)
#endif /* LV_HAVE_SSE */
#endif /* LV_HAVE_AVX */
#endif /* LV_HAVE_AVX512 */

#define isrran_simd_aligned __attribute__((aligned(ISRRAN_SIMD_BIT_ALIGN / 8)))

/* Memory Sizes for Single Floating Point and fixed point */
#ifdef LV_HAVE_AVX512

#define ISRRAN_SIMD_F_SIZE 16
#define ISRRAN_SIMD_CF_SIZE 16

#define ISRRAN_SIMD_I_SIZE 16

#define ISRRAN_SIMD_B_SIZE 64
#define ISRRAN_SIMD_S_SIZE 32
#define ISRRAN_SIMD_C16_SIZE 0

#else
#ifdef LV_HAVE_AVX2

#define ISRRAN_SIMD_F_SIZE 8
#define ISRRAN_SIMD_CF_SIZE 8

#define ISRRAN_SIMD_I_SIZE 8

#define ISRRAN_SIMD_B_SIZE 32
#define ISRRAN_SIMD_S_SIZE 16
#define ISRRAN_SIMD_C16_SIZE 16

#else /* LV_HAVE_AVX2 */
#ifdef LV_HAVE_SSE

#define ISRRAN_SIMD_F_SIZE 4
#define ISRRAN_SIMD_CF_SIZE 4

#define ISRRAN_SIMD_I_SIZE 4

#define ISRRAN_SIMD_B_SIZE 16
#define ISRRAN_SIMD_S_SIZE 8
#define ISRRAN_SIMD_C16_SIZE 8
...
#else /* HAVE_NEON */
#define ISRRAN_SIMD_F_SIZE 0
#define ISRRAN_SIMD_CF_SIZE 0

#define ISRRAN_SIMD_I_SIZE 0
#define ISRRAN_SIMD_B_SIZE 0
#define ISRRAN_SIMD_S_SIZE 0
#define ISRRAN_SIMD_C16_SIZE 0
...
static inline simd_f_t isrran_simd_f_load(const float* ptr)
{
#ifdef LV_HAVE_AVX512
...
static inline simd_f_t isrran_simd_f_loadu(const float* ptr)
{
#ifdef LV_HAVE_AVX512
...
static inline void isrran_simd_f_store(float* ptr, simd_f_t simdreg)
{
#ifdef LV_HAVE_AVX512
...
static inline void isrran_simd_f_storeu(float* ptr, simd_f_t simdreg)
{
#ifdef LV_HAVE_AVX512
...
static inline simd_f_t isrran_simd_f_set1(float x)
{
#ifdef LV_HAVE_AVX512
...
static inline simd_f_t isrran_simd_f_mul(simd_f_t a, simd_f_t b)
{
#ifdef LV_HAVE_AVX512
...
static inline simd_f_t isrran_simd_f_rcp(simd_f_t a)
{
#ifdef LV_HAVE_AVX512
...
static inline simd_f_t isrran_simd_f_addsub(simd_f_t a, simd_f_t b)
{
#ifdef LV_HAVE_AVX512
...
static inline simd_f_t isrran_simd_f_sub(simd_f_t a, simd_f_t b)
{
#ifdef LV_HAVE_AVX512
...
static inline simd_f_t isrran_simd_f_add(simd_f_t a, simd_f_t b)
{
#ifdef LV_HAVE_AVX512
...
static inline simd_f_t isrran_simd_f_zero(void)
{
#ifdef LV_HAVE_AVX512
...
static inline simd_f_t isrran_simd_f_swap(simd_f_t a)
{
#ifdef LV_HAVE_AVX512
...
static inline simd_f_t isrran_simd_f_hadd(simd_f_t a, simd_f_t b)
{
#ifdef LV_HAVE_AVX512
...
static inline simd_f_t isrran_simd_f_sqrt(simd_f_t a)
{
#ifdef LV_HAVE_AVX512
...
static inline simd_f_t isrran_simd_f_neg(simd_f_t a)
{
#ifdef LV_HAVE_AVX512
...
static inline simd_f_t isrran_simd_f_neg_mask(simd_f_t a, simd_f_t mask)
{
#ifdef LV_HAVE_AVX512
...
static inline simd_f_t isrran_simd_f_abs(simd_f_t a)
{
#ifdef LV_HAVE_AVX512
...
static inline void isrran_simd_f_fprintf(FILE* stream, simd_f_t a)
{
  float x[ISRRAN_SIMD_F_SIZE];

  isrran_simd_f_storeu(x, a);

  fprintf(stream, "[");
  for (int i = 0; i < ISRRAN_SIMD_F_SIZE; i++) {
    fprintf(stream, "%+2.5f, ", x[i]);
  }
  fprintf(stream, "];\n");
}

#endif /* ISRRAN_SIMD_F_SIZE */
...
static inline simd_cf_t isrran_simd_cfi_load(const cf_t* ptr)
{
  simd_cf_t ret;
#ifdef LV_HAVE_AVX512
  __m512 in1 = _mm512_load_ps((float*)(ptr));
  __m512 in2 = _mm512_load_ps((float*)(ptr + ISRRAN_SIMD_CF_SIZE / 2));
...
/* Complex Single precission Floating point functions */
static inline simd_cf_t isrran_simd_cfi_loadu(const cf_t* ptr)
{
  simd_cf_t ret;
#ifdef LV_HAVE_AVX512
  __m512 in1 = _mm512_loadu_ps((float*)(ptr));
  __m512 in2 = _mm512_loadu_ps((float*)(ptr + ISRRAN_SIMD_CF_SIZE / 2));
  ret.re     = _mm512_permutex2var_ps(
      in1,
      _mm512_setr_epi32(0x00, 0x02, 0x04, 0x06, 0x08, 0x0A, 0x0C, 0x0E, 0x10, 0x12, 0x14, 0x16, 0x18, 0x1A, 0x1C, 0x1E),
      in2);
...
static inline simd_cf_t isrran_simd_cf_load(const float* re, const float* im)
{
  simd_cf_t ret;
#ifdef LV_HAVE_AVX512
...
static inline simd_cf_t isrran_simd_cf_loadu(const float* re, const float* im)
{
  simd_cf_t ret;
#ifdef LV_HAVE_AVX512
...
static inline void isrran_simd_cfi_store(cf_t* ptr, simd_cf_t simdreg)
{
#ifdef LV_HAVE_AVX512
...
static inline void isrran_simd_cfi_storeu(cf_t* ptr, simd_cf_t simdreg)
{
#ifdef LV_HAVE_AVX512
  __m512 s1 = _mm512_permutex2var_ps(
      simdreg.re,
...
static inline void isrran_simd_cf_store(float* re, float* im, simd_cf_t simdreg)
{
#ifdef LV_HAVE_AVX512
...
static inline void isrran_simd_cf_storeu(float* re, float* im, simd_cf_t simdreg)
{
#ifdef LV_HAVE_AVX512
...
static inline simd_f_t isrran_simd_cf_re(simd_cf_t in)
{
#ifdef HAVE_NEON
...
static inline simd_f_t isrran_simd_cf_im(simd_cf_t in)
{
#ifdef HAVE_NEON
...
static inline simd_cf_t isrran_simd_cf_set1(cf_t x)
{
  simd_cf_t ret;
#ifdef LV_HAVE_AVX512
...
static inline simd_cf_t isrran_simd_cf_prod(simd_cf_t a, simd_cf_t b)
{
  simd_cf_t ret;
#ifdef LV_HAVE_AVX512
...
static inline simd_cf_t isrran_simd_cf_conjprod(simd_cf_t a, simd_cf_t b)
{
  simd_cf_t ret;
#ifdef LV_HAVE_AVX512
...
static inline simd_cf_t isrran_simd_cf_add(simd_cf_t a, simd_cf_t b)
{
  simd_cf_t ret;
#ifdef LV_HAVE_AVX512
...
static inline simd_cf_t isrran_simd_cf_sub(simd_cf_t a, simd_cf_t b)
{
  simd_cf_t ret;
#ifdef LV_HAVE_AVX512
...
static inline simd_cf_t isrran_simd_cf_mul(simd_cf_t a, simd_f_t b)
{
  simd_cf_t ret;
#ifdef LV_HAVE_AVX512
...
static inline simd_cf_t isrran_simd_cf_rcp(simd_cf_t a)
{
  simd_cf_t ret;
#ifdef LV_HAVE_AVX512
...
static inline simd_cf_t isrran_simd_cf_neg(simd_cf_t a)
{
  simd_cf_t ret;
#if HAVE_NEON
  ret.val[0] = isrran_simd_f_neg(a.val[0]);
  ret.val[1] = isrran_simd_f_neg(a.val[1]);
#else  /* HAVE_NEON */
  ret.re            = isrran_simd_f_neg(a.re);
  ret.im            = isrran_simd_f_neg(a.im);
#endif /* HAVE_NEON */
  return ret;
}

static inline simd_cf_t isrran_simd_cf_neg_mask(simd_cf_t a, simd_f_t mask)
{
  simd_cf_t ret;
#ifndef LV_HAVE_AVX512
#ifdef LV_HAVE_AVX2
...
#endif /* LV_HAVE_AVX512 */
#if HAVE_NEON
  ret.val[0] = isrran_simd_f_neg_mask(a.val[0], mask);
  ret.val[1] = isrran_simd_f_neg_mask(a.val[1], mask);
#else  /* HAVE_NEON */
  ret.re            = isrran_simd_f_neg_mask(a.re, mask);
  ret.im            = isrran_simd_f_neg_mask(a.im, mask);
#endif /* HAVE_NEON */
  return ret;
}

static inline simd_cf_t isrran_simd_cf_conj(simd_cf_t a)
{
  simd_cf_t ret;
#if HAVE_NEON
  ret.val[0] = a.val[0];
...
static inline simd_cf_t isrran_simd_cf_mulj(simd_cf_t a)
{
  simd_cf_t ret;
#if HAVE_NEON
  ret.val[0] = isrran_simd_f_neg(a.val[1]);
  ret.val[1] = a.val[0];
#else  /* HAVE_NEON */
  ret.re            = isrran_simd_f_neg(a.im);
  ret.im            = a.re;
#endif /* HAVE_NEON */
  return ret;
}

static inline simd_cf_t isrran_simd_cf_zero(void)
{
  simd_cf_t ret;
#ifdef LV_HAVE_AVX512
...
static inline void isrran_simd_cf_fprintf(FILE* stream, simd_cf_t a)
{
  cf_t x[ISRRAN_SIMD_CF_SIZE];

  isrran_simd_cfi_storeu(x, a);

  fprintf(stream, "[");
  for (int i = 0; i < ISRRAN_SIMD_CF_SIZE; i++) {
...
static inline simd_i_t isrran_simd_i_load(int* x)
{
#ifdef LV_HAVE_AVX512
...
static inline void isrran_simd_i_store(int* x, simd_i_t reg)
{
#ifdef LV_HAVE_AVX512
...
static inline simd_i_t isrran_simd_i_set1(int x)
{
#ifdef LV_HAVE_AVX512
...
static inline simd_i_t isrran_simd_i_add(simd_i_t a, simd_i_t b)
{
#ifdef LV_HAVE_AVX512
...
static inline simd_i_t isrran_simd_i_mul(simd_i_t a, simd_i_t b)
{
#ifdef LV_HAVE_AVX512
...
static inline simd_i_t isrran_simd_i_and(simd_i_t a, simd_i_t b)
{
#ifdef LV_HAVE_AVX512
...
static inline simd_sel_t isrran_simd_f_max(simd_f_t a, simd_f_t b)
{
#ifdef LV_HAVE_AVX512
...
static inline simd_sel_t isrran_simd_f_min(simd_f_t a, simd_f_t b)
{
#ifdef LV_HAVE_AVX512
...
static inline simd_f_t isrran_simd_f_select(simd_f_t a, simd_f_t b, simd_sel_t selector)
{
#ifdef LV_HAVE_AVX512
...
static inline simd_i_t isrran_simd_i_select(simd_i_t a, simd_i_t b, simd_sel_t selector)
{
#ifdef LV_HAVE_AVX512
...
static inline simd_s_t isrran_simd_s_load(const int16_t* ptr)
{
#ifdef LV_HAVE_AVX512
...
static inline simd_s_t isrran_simd_s_loadu(const int16_t* ptr)
{
#ifdef LV_HAVE_AVX512
...
static inline void isrran_simd_s_store(int16_t* ptr, simd_s_t simdreg)
{
#ifdef LV_HAVE_AVX512
...
static inline void isrran_simd_s_storeu(int16_t* ptr, simd_s_t simdreg)
{
#ifdef LV_HAVE_AVX512
...
static inline simd_s_t isrran_simd_s_zero(void)
{
#ifdef LV_HAVE_AVX512
...
static inline simd_s_t isrran_simd_s_mul(simd_s_t a, simd_s_t b)
{
#ifdef LV_HAVE_AVX512
...
static inline simd_s_t isrran_simd_s_neg(simd_s_t a, simd_s_t b)
{
#ifdef LV_HAVE_AVX512
...
static inline simd_s_t isrran_simd_s_add(simd_s_t a, simd_s_t b)
{
#ifdef LV_HAVE_AVX512
...
static inline simd_s_t isrran_simd_s_sub(simd_s_t a, simd_s_t b)
{
#ifdef LV_HAVE_AVX512
...
static inline simd_c16_t isrran_simd_c16i_load(const c16_t* ptr)
{
  simd_c16_t ret;
#ifdef LV_HAVE_AVX512
...
static inline simd_c16_t isrran_simd_c16_load(const int16_t* re, const int16_t* im)
{
  simd_c16_t ret;
#ifdef LV_HAVE_AVX2
...
static inline simd_c16_t isrran_simd_c16_loadu(const int16_t* re, const int16_t* im)
{
  simd_c16_t ret;
#ifdef LV_HAVE_AVX2
...
static inline void isrran_simd_c16i_store(c16_t* ptr, simd_c16_t simdreg)
{
#ifdef LV_HAVE_AVX2
...
static inline void isrran_simd_c16i_storeu(c16_t* ptr, simd_c16_t simdreg)
{
#ifdef LV_HAVE_AVX2
  __m256i re_sw = _mm256_shufflelo_epi16(_mm256_shufflehi_epi16(simdreg.re.m256, 0b10110001), 0b10110001);
  __m256i im_sw = _mm256_shufflelo_epi16(_mm256_shufflehi_epi16(simdreg.im.m256, 0b10110001), 0b10110001);
...
static inline void isrran_simd_c16_store(int16_t* re, int16_t* im, simd_c16_t simdreg)
{
#ifdef LV_HAVE_AVX2
...
static inline void isrran_simd_c16_storeu(int16_t* re, int16_t* im, simd_c16_t simdreg)
{
#ifdef LV_HAVE_AVX2
...
static inline simd_c16_t isrran_simd_c16_prod(simd_c16_t a, simd_c16_t b)
{
  simd_c16_t ret;
#ifdef LV_HAVE_AVX2
...
static inline simd_c16_t isrran_simd_c16_add(simd_c16_t a, simd_c16_t b)
{
  simd_c16_t ret;
#ifdef LV_HAVE_AVX2
...
static inline simd_c16_t isrran_simd_c16_zero(void)
{
  simd_c16_t ret;
#ifdef LV_HAVE_AVX2
...
#endif /* ISRRAN_SIMD_C16_SIZE */

#if ISRRAN_SIMD_F_SIZE && ISRRAN_SIMD_S_SIZE

static inline simd_s_t isrran_simd_convert_2f_s(simd_f_t a, simd_f_t b)
{
#ifdef LV_HAVE_AVX512
...
#endif /* ISRRAN_SIMD_F_SIZE && ISRRAN_SIMD_C16_SIZE */
...
static inline simd_b_t isrran_simd_b_load(const int8_t* ptr)
{
#ifdef LV_HAVE_AVX512
  return _mm512_load_si512(ptr);
#else /* LV_HAVE_AVX512 */
...
static inline simd_b_t isrran_simd_b_loadu(const int8_t* ptr)
{
#ifdef LV_HAVE_AVX512
  return _mm512_loadu_si512(ptr);
#else /* LV_HAVE_AVX512 */
...
static inline void isrran_simd_b_store(int8_t* ptr, simd_b_t simdreg)
{
#ifdef LV_HAVE_AVX512
  _mm512_store_si512(ptr, simdreg);
#else /* LV_HAVE_AVX512 */
...
static inline void isrran_simd_b_storeu(int8_t* ptr, simd_b_t simdreg)
{
#ifdef LV_HAVE_AVX512
  _mm512_storeu_si512(ptr, simdreg);
#else /* LV_HAVE_AVX512 */
...
static inline simd_b_t isrran_simd_b_xor(simd_b_t a, simd_b_t b)
{
...
static inline simd_b_t isrran_simd_b_sub(simd_b_t a, simd_b_t b)
{
#ifdef LV_HAVE_AVX512
...
static inline simd_b_t isrran_simd_b_neg(simd_b_t a, simd_b_t b)
{
#ifdef LV_HAVE_AVX512
  __m256i a0 = _mm512_extracti64x4_epi64(a, 0);
  __m256i a1 = _mm512_extracti64x4_epi64(a, 1);
