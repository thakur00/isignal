...
#ifndef ISRRAN_CBSEGM_H
#define ISRRAN_CBSEGM_H
...
#define ISRRAN_NOF_TC_CB_SIZES 188
 ...
 * @return It returns ISRRAN_SUCCESS if the provided arguments are valid, otherwise it returns ISRRAN_ERROR code
 */
ISRRAN_API int isrran_cbsegm(isrran_cbsegm_t* s, uint32_t tbs);
 ...
 * ISRRAN_ERROR code
 */
ISRRAN_API int isrran_cbsegm_cbsize(uint32_t index);
 ...
 */
ISRRAN_API bool isrran_cbsegm_cbsize_isvalid(uint32_t size);
 ...
 */
ISRRAN_API int isrran_cbsegm_cbindex(uint32_t long_cb);
 ...
 * @return It returns ISRRAN_SUCCESS if the provided arguments are valid, otherwise it returns ISRRAN_ERROR code
 */
ISRRAN_API int isrran_cbsegm_ldpc_bg1(isrran_cbsegm_t* s, uint32_t tbs);
 ...
 * @return It returns ISRRAN_SUCCESS if the provided arguments are valid, otherwise it returns ISRRAN_ERROR code
 */
ISRRAN_API int isrran_cbsegm_ldpc_bg2(isrran_cbsegm_t* s, uint32_t tbs);

#endif // ISRRAN_CBSEGM_H
