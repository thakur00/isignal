...
#ifndef ISRRAN_BASEGRAPH_H
#define ISRRAN_BASEGRAPH_H

#include "isrran/config.h"

#include <stdint.h>

#define ISRRAN_LDPC_BG1_MAX_LEN_CB 8448                   /*!< \brief Maximum code block size for LDPC BG1 */
#define ISRRAN_LDPC_BG2_MAX_LEN_CB 3840                   /*!< \brief Maximum code block size for LDPC BG2 */
#define ISRRAN_LDPC_MAX_LEN_CB ISRRAN_LDPC_BG1_MAX_LEN_CB /*!< \brief Maximum code block size for LDPC BG1 or BG2 */
...
#define ISRRAN_LDPC_MAX_LEN_ENCODED_CB (MAX_LIFTSIZE * ISRRAN_MAX(BG1N, BG2N))
 ...
 */
ISRRAN_API int create_compact_pcm(uint16_t* pcm, int8_t (*positions)[MAX_CNCT], isrran_basegraph_t bg, uint16_t ls);
