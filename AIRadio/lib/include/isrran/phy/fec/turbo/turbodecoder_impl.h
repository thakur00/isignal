...
#ifndef ISRRAN_TURBODECODER_IMPL_H
#define ISRRAN_TURBODECODER_IMPL_H
...
typedef enum ISRRAN_API {
  ...
  ISRRAN_TDEC_GENERIC,
  ISRRAN_TDEC_SSE,
  ISRRAN_TDEC_SSE_WINDOW,
  ISRRAN_TDEC_NEON_WINDOW,
  ISRRAN_TDEC_AVX_WINDOW,
  ISRRAN_TDEC_SSE8_WINDOW,
  ISRRAN_TDEC_AVX8_WINDOW,
  ISRRAN_TDEC_NOF_IMP
} isrran_tdec_impl_type_t;

#endif

#ifdef LLR_IS_8BIT
#define llr_t int8_t
#define type_name isrran_tdec_8bit_impl_t
#else
#ifdef LLR_IS_16BIT
#define llr_t int16_t
#define type_name isrran_tdec_16bit_impl_t
#else
