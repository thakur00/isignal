...
#ifndef ISRRAN_POLARRM_H
#define ISRRAN_POLARRM_H
 ...
 * \param[out] q           A pointer to a isrran_polar_rm_t structure.
 * \return An integer: 0 if the function executes correctly, -1 otherwise.
 */
ISRRAN_API int isrran_polar_rm_tx_init(isrran_polar_rm_t* q);

/*!
 * Carries out the actual rate-matching.
 * \param[in] q            A pointer to the Rate-Matcher (a isrran_polar_rm_t structure
 ...
 * \return An integer: 0 if the function executes correctly, -1 otherwise.
 */
ISRRAN_API int isrran_polar_rm_tx(isrran_polar_rm_t* q,
                                  const uint8_t*     input,
                                  uint8_t*           output,
                                  const uint8_t      n,
                                  const uint32_t     E,
 ...
 * \return An integer: 0 if the function executes correctly, -1 otherwise.
 */
ISRRAN_API int isrran_polar_rm_rx_init_f(isrran_polar_rm_t* q);

/*!
 * Carries out the actual rate-dematching.
 * \param[in] q          A pointer to the Rate-DeMatcher (a isrran_polar_rm_t structure
 *                       instance) that carries out the rate matching.
 ...
 * \return An integer: 0 if the function executes correctly, -1 otherwise.
 */
ISRRAN_API int isrran_polar_rm_rx_f(isrran_polar_rm_t* q,
                                    const float*       input,
                                    float*             output,
                                    const uint32_t     E,
                                    const uint8_t      n,
 ...
 * \return An integer: 0 if the function executes correctly, -1 otherwise.
 */
ISRRAN_API int isrran_polar_rm_rx_init_s(isrran_polar_rm_t* q);
 ...
 * \return An integer: 0 if the function executes correctly, -1 otherwise.
 */
ISRRAN_API int isrran_polar_rm_rx_s(isrran_polar_rm_t* q,
                                    const int16_t*     input,
                                    int16_t*           output,
                                    const uint32_t     E,
                                    const uint8_t      n,
 ...
 * \return An integer: 0 if the function executes correctly, -1 otherwise.
 */
ISRRAN_API int isrran_polar_rm_rx_init_c(isrran_polar_rm_t* q);
 ...
 * \return An integer: 0 if the function executes correctly, -1 otherwise.
 */
ISRRAN_API int isrran_polar_rm_rx_c(isrran_polar_rm_t* q,
                                    const int8_t*      input,
                                    int8_t*            output,
                                    const uint32_t     E,
                                    const uint8_t      n,
 ...
 */
ISRRAN_API void isrran_polar_rm_tx_free(isrran_polar_rm_t* q);
