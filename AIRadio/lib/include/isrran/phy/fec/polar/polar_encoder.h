...
#ifndef ISRRAN_POLAR_ENCODER_H
#define ISRRAN_POLAR_ENCODER_H
 ...
 */
typedef enum {
  ISRRAN_POLAR_ENCODER_PIPELINED = 0, /*!< \brief Non-optimized version of the pipelined polar encoder*/
  ISRRAN_POLAR_ENCODER_AVX2      = 1, /*!< \brief SIMD implementation of the polar encoder */
} isrran_polar_encoder_type_t;
 ...
 */
ISRRAN_API int isrran_polar_encoder_init(isrran_polar_encoder_t*     q,
                                         isrran_polar_encoder_type_t polar_encoder_type,
 ...
 */
ISRRAN_API void isrran_polar_encoder_free(isrran_polar_encoder_t* q);
 ...
 *     the isrran_polar_encoder_t structure.
 * \param[out] output The encoder output vector.
 * \return An integer: 0 if the function executes correctly, -1 otherwise.
 */
ISRRAN_API int
isrran_polar_encoder_encode(isrran_polar_encoder_t* q, const uint8_t* input, uint8_t* output, uint8_t code_size_log);

#endif // ISRRAN_POLAR_ENCODER_H
