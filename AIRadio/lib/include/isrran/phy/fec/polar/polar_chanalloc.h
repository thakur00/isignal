...
#ifndef ISRRAN_CHANALLOC_H
#define ISRRAN_CHANALLOC_H
 ...
 */
void isrran_polar_chanalloc_tx(const uint8_t*  message,
 ...
 * \param[in] PC_set Pointer to the indices of the parity check bits.
 */
void isrran_polar_chanalloc_rx(const uint8_t*  output_decoder,
                               uint8_t*        message,
                               const uint16_t  K,
                               const uint8_t   nPC,
                               const uint16_t* K_set,
