...
#ifndef ISRRAN_POLAR_CODE_H
#define ISRRAN_POLAR_CODE_H
 ...
 * \return An integer: 0 if the function executes correctly, -1 otherwise.
 */
int isrran_polar_code_get(isrran_polar_code_t* c, const uint16_t K, const uint16_t E, const uint8_t nMax);
