...
#ifndef ISRRAN_ENB_RRC_INTERFACES_H
#define ISRRAN_ENB_RRC_INTERFACES_H
...
public:
  ...
  virtual int notify_ue_erab_updates(uint16_t rnti, isrran::const_span<uint8_t> nas_pdu) = 0;
  ...
  virtual void ho_preparation_complete(uint16_t                     rnti,
                                       ...
                                       isrran::unique_byte_buffer_t container) = 0;
  virtual uint16_t
...
#endif // ISRRAN_ENB_RRC_INTERFACES_H
