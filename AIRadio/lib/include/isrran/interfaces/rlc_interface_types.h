...
#ifndef ISRRAN_RLC_INTERFACE_TYPES_H
#define ISRRAN_RLC_INTERFACE_TYPES_H
...
public:
  ...
  rlc_config_t() :
    rat(isrran_rat_t::lte), rlc_mode(rlc_mode_t::tm), am(), am_nr(), um(), um_nr(), tx_queue_length(RLC_TX_QUEUE_LEN){};

  // Factory for MCH
  static rlc_config_t mch_config()
  {
    rlc_config_t cfg          = {};
    cfg.rat                   = isrran_rat_t::lte;
  ...
  static rlc_config_t default_rlc_am_nr_config(uint32_t sn_size = 12)
  {
    ...
    rlc_cnfg.rlc_mode     = rlc_mode_t::am;
    if (sn_size == 12) {
      rlc_cnfg.am_nr.tx_sn_field_length = isrran::rlc_am_nr_sn_size_t::size12bits;
      rlc_cnfg.am_nr.rx_sn_field_length = isrran::rlc_am_nr_sn_size_t::size12bits;
    } else if (sn_size == 18) {
      rlc_cnfg.am_nr.tx_sn_field_length = isrran::rlc_am_nr_sn_size_t::size18bits;
      rlc_cnfg.am_nr.rx_sn_field_length = isrran::rlc_am_nr_sn_size_t::size18bits;
    } else {
      return {};
    }
...
#endif // ISRRAN_RLC_INTERFACE_TYPES_H
