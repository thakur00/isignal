...
#ifndef ISRRAN_PHY_COMMON_INTERFACE_H
#define ISRRAN_PHY_COMMON_INTERFACE_H
...
public:
  ...
  struct worker_context_t {
    ...
    isrran::rf_timestamp_t tx_time    = {};      ///< Transmit time, used only by last worker
   ...
   */
  virtual void worker_end(const worker_context_t& w_ctx, const bool& tx_enable, isrran::rf_buffer_t& buffer) = 0;
};

} // namespace isrran

#endif // ISRRAN_PHY_COMMON_INTERFACE_H
