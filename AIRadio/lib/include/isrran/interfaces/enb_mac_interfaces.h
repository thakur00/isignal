...
#ifndef ISRRAN_ENB_MAC_INTERFACES_H
#define ISRRAN_ENB_MAC_INTERFACES_H
...
public:
   ...
   */
  using dl_sched_list_t = isrran::bounded_vector<dl_sched_t, ISRRAN_MAX_CARRIERS>;
   ...
   */
  using ul_sched_list_t = isrran::bounded_vector<ul_sched_t, ISRRAN_MAX_CARRIERS>;
   ...
   * @return ISRRAN_SUCCESS if no error occurs, ISRRAN_ERROR* if an error occurs
   */
  ...
  typedef enum { PUSCH = 0, PUCCH, ISR } ul_channel_t;
   ...
   * @param ch Indicates uplink channel (PUSCH, PUCCH or ISR)
   * @return ISRRAN_SUCCESS if no error occurs, ISRRAN_ERROR* if an error occurs
   */
...
public:
  ...
  virtual void write_mcch(const isrran::sib2_mbms_t* sib2_,
...
#endif // ISRRAN_ENB_MAC_INTERFACES_H
