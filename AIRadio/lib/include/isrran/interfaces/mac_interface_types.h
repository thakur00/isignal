...
#ifndef ISRRAN_MAC_INTERFACE_TYPES_H
#define ISRRAN_MAC_INTERFACE_TYPES_H
...
struct dl_harq_cfg_nr_t {
  ...
  void reset() { nof_procs = ISRRAN_DEFAULT_HARQ_PROC_DL_NR; }
};
...
#define ISRRAN_MAX_MAX_NR_OF_SR_CFG_PER_CELL_GROUP (8)
struct sr_cfg_nr_t {
  bool             enabled;
  uint8_t          num_items;
  sr_cfg_item_nr_t item[ISRRAN_MAX_MAX_NR_OF_SR_CFG_PER_CELL_GROUP];
};
...
#endif // ISRRAN_MAC_INTERFACE_TYPES_H
