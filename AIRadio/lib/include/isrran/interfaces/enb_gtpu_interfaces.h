...
#ifndef ISRRAN_ENB_GTPU_INTERFACES_H
#define ISRRAN_ENB_GTPU_INTERFACES_H
...
public:
  ...
  virtual isrran::expected<uint32_t> add_bearer(uint16_t            rnti,
...
#endif // ISRRAN_ENB_GTPU_INTERFACES_H
