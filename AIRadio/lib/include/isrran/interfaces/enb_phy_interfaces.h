...
#ifndef ISRRAN_ENB_PHY_INTERFACES_H
#define ISRRAN_ENB_PHY_INTERFACES_H
...
public:
  ...
  virtual void set_activation_deactivation_scell(uint16_t                                     rnti,
                                                 const std::array<bool, ISRRAN_MAX_CARRIERS>& activation) = 0;
};
...
{
public:
  isrran::phy_cfg_mbsfn_t mbsfn_cfg;

  virtual void configure_mbsfn(isrran::sib2_mbms_t* sib2, isrran::sib13_t* sib13, const isrran::mcch_msg_t& mcch) = 0;
  ...
  struct phy_rrc_cfg_t {
    ...
    isrran::phy_cfg_t phy_cfg    = {};    ///< Dedicated physical layer configuration
  };
...
#endif // ISRRAN_ENB_PHY_INTERFACES_H
