...
#ifndef ISRRAN_ENB_X2_INTERFACES_H
#define ISRRAN_ENB_X2_INTERFACES_H
...
public:
  ...
  struct sgnb_addition_ack_params_t {
    uint16_t            nr_rnti = ISRRAN_INVALID_RNTI; // RNTI that was assigned to the UE
...
#endif // ISRRAN_ENB_X2_INTERFACES_H
