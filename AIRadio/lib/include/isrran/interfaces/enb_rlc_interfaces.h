...
#ifndef ISRRAN_ENB_RLC_INTERFACES_H
#define ISRRAN_ENB_RLC_INTERFACES_H
...
public:
  ...
  virtual void add_bearer(uint16_t rnti, uint32_t lcid, const isrran::rlc_config_t& cnfg) = 0;
...
#endif // ISRRAN_ENB_RLC_INTERFACES_H
