...
#ifndef ISRRAN_UE_MAC_INTERFACES_H
#define ISRRAN_UE_MAC_INTERFACES_H
...
public:
  ...
  virtual void tb_decoded(uint32_t cc_idx, mac_grant_dl_t grant, bool ack[ISRRAN_MAX_CODEWORDS]) = 0;
...
public:
  ...
  virtual void set_config(isrran::mac_cfg_t& mac_cfg) = 0;

  /* Update SR config only for PUCCH release */
  virtual void set_config(isrran::sr_cfg_t& sr_cfg) = 0;
...
#endif // ISRRAN_UE_MAC_INTERFACES_H
