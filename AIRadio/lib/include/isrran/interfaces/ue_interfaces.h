...
#ifndef ISRRAN_UE_INTERFACES_H
#define ISRRAN_UE_INTERFACES_H
...
{
public:
  virtual isrran::tti_point get_current_tti()                                                              = 0;
  virtual void              add_eps_bearer(uint8_t eps_bearer_id, isrran::isrran_rat_t rat, uint32_t lcid) = 0;
