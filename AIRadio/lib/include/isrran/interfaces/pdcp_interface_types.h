...
#ifndef ISRRAN_PDCP_INTERFACE_TYPES_H
#define ISRRAN_PDCP_INTERFACE_TYPES_H
...
public:
  ...
  isrran::isrran_rat_t rat           = isrran::isrran_rat_t::lte;
...
enum isrran_direction_t { DIRECTION_NONE = 0, DIRECTION_TX, DIRECTION_RX, DIRECTION_TXRX, DIRECTION_N_ITEMS };
static const char* isrran_direction_text[DIRECTION_N_ITEMS] = {"none", "tx", "rx", "tx/rx"};
...
typedef isrran::bounded_vector<uint32_t, MAX_SDUS_TO_NOTIFY> pdcp_sn_vector_t;

} // namespace isrran

#endif // ISRRAN_PDCP_INTERFACE_TYPES_H
