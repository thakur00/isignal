...
#include "isrran/asn1/s1ap_utils.h"
#include "isrran/interfaces/rrc_interface_types.h"

#ifndef ISRRAN_ENB_S1AP_INTERFACES_H
#define ISRRAN_ENB_S1AP_INTERFACES_H
...
public:
  ...
  virtual void write_pdu(uint16_t rnti, isrran::unique_byte_buffer_t pdu)                 = 0;
  ...
  virtual bool send_ho_req_ack(const asn1::s1ap::ho_request_s&                msg,
                               ...
                               isrran::const_span<asn1::s1ap::erab_item_s>    not_admitted_bearers) = 0;
  ...
  virtual bool send_ue_cap_info_indication(uint16_t rnti, isrran::unique_byte_buffer_t ue_radio_cap) = 0;
};

} // namespace isrenb

#endif // ISRRAN_ENB_S1AP_INTERFACES_H
