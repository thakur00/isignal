...
#ifndef ISRRAN_GNB_MAC_INTERFACES_H
#define ISRRAN_GNB_MAC_INTERFACES_H
...
public:
  ...
  /// Allocates a new user/RNTI at MAC. Returns RNTI on success or ISRRAN_INVALID_RNTI otherwise.
...
#endif // ISRRAN_GNB_MAC_INTERFACES_H
