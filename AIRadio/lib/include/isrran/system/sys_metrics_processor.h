...
#ifndef ISRRAN_SYS_METRICS_PROCESSOR_H
#define ISRRAN_SYS_METRICS_PROCESSOR_H
...
public:
  explicit sys_metrics_processor(isrlog::basic_logger& logger);
...
#endif // ISRRAN_SYS_METRICS_PROCESSOR_H
