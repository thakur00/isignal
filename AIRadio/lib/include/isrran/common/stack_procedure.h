...
#ifndef ISRRAN_RESUMABLE_PROCEDURES_H
#define ISRRAN_RESUMABLE_PROCEDURES_H
...
public:
  ...
  using callback_t    = isrran::move_callback<void(Args...)>;
...
#endif // ISRRAN_RESUMABLE_PROCEDURES_H
