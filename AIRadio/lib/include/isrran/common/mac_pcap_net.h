...
#ifndef ISRRAN_MAC_PCAP_NET_H
#define ISRRAN_MAC_PCAP_NET_H
...
private:
  ...
  void write_mac_lte_pdu_to_net(isrran::mac_pcap_base::pcap_pdu_t& pdu);
  void write_mac_nr_pdu_to_net(isrran::mac_pcap_base::pcap_pdu_t& pdu);

  isrran::unique_socket socket;
  struct sockaddr_in    client_addr;
};
} // namespace isrran

#endif // ISRRAN_MAC_PCAP_NET_H
