...
#ifndef ISRRAN_BAND_HELPER_H
#define ISRRAN_BAND_HELPER_H
...
class isrran_band_helper
{
public:
  isrran_band_helper()  = default;
  ~isrran_band_helper() = default;
   ...
   * @return The SSB pattern case if band and subcarrier spacing match, ISRRAN_SSB_PATTERN_INVALID otherwise
   */
  static isrran_ssb_pattern_t get_ssb_pattern(uint16_t band, isrran_subcarrier_spacing_t scs);
   ...
   */
  isrran_subcarrier_spacing_t get_ssb_scs(uint16_t band) const;

  /**
   * @brief gets the NR band duplex mode
   * @param band Given band
   * @return A valid ISRRAN_DUPLEX_MODE if the band is valid, ISRRAN_DUPLEX_MODE_INVALID otherwise
   */
  isrran_duplex_mode_t get_duplex_mode(uint16_t band) const;
   ...
   */
  uint32_t find_lower_bound_abs_freq_ssb(uint16_t band, isrran_subcarrier_spacing_t scs, uint32_t min_center_freq_hz);
   ...
   * @return double Frequency in Hz
   */
  double get_ssb_center_freq(const isrran_carrier_nr_t& carrier);
  ...
  sync_raster_t get_sync_raster(uint16_t band, isrran_subcarrier_spacing_t scs) const;
...
private:
  ...
  static constexpr std::array<nr_operating_band, nof_nr_operating_band_fr1> nr_operating_bands_fr1 = {{
      // clang-format off
    {1,  1920, 1080, 2110, 2170, ISRRAN_DUPLEX_MODE_FDD},
    {2,  1850, 1810, 1930, 1990, ISRRAN_DUPLEX_MODE_FDD},
    {3,  1710, 1785, 1805, 1880, ISRRAN_DUPLEX_MODE_FDD},
    {5,  824,  849,  869,  894,  ISRRAN_DUPLEX_MODE_FDD},
    {7,  2500, 2570, 2620, 2690, ISRRAN_DUPLEX_MODE_FDD},
    {8,  880,  915,  925,  960,  ISRRAN_DUPLEX_MODE_FDD},
    {12, 699,  716,  729,  746,  ISRRAN_DUPLEX_MODE_FDD},
    {20, 832,  862,  791,  821,  ISRRAN_DUPLEX_MODE_FDD},
    {25, 1850, 1915, 1930, 1995, ISRRAN_DUPLEX_MODE_FDD},
    {28, 703,  748,  758,  803,  ISRRAN_DUPLEX_MODE_FDD},
    {34, 2010, 2025, 2010, 2025, ISRRAN_DUPLEX_MODE_TDD},
    {38, 2570, 2620, 2570, 2620, ISRRAN_DUPLEX_MODE_TDD},
    {39, 1880, 1920, 1880, 1920, ISRRAN_DUPLEX_MODE_TDD},
    {40, 2300, 2400, 2300, 2400, ISRRAN_DUPLEX_MODE_TDD},
    {41, 2496, 2690, 2496, 2690, ISRRAN_DUPLEX_MODE_TDD},
    {50, 1432, 1517, 1432, 1517, ISRRAN_DUPLEX_MODE_TDD},
    {51, 1427, 1432, 1427, 1432, ISRRAN_DUPLEX_MODE_TDD},
    {66, 1710, 1780, 2110, 2200, ISRRAN_DUPLEX_MODE_FDD},
    {70, 1695, 1710, 1995, 2020, ISRRAN_DUPLEX_MODE_FDD},
    {71, 663,  698,  617,  652,  ISRRAN_DUPLEX_MODE_FDD},
    {74, 1427, 1470, 1475, 1518, ISRRAN_DUPLEX_MODE_FDD},
    {75, 0,    0,    1432, 1517, ISRRAN_DUPLEX_MODE_SDL},
    {76, 0,    0,    1427, 1432, ISRRAN_DUPLEX_MODE_SDL},
    {77, 3300, 4200, 3300, 4200, ISRRAN_DUPLEX_MODE_TDD},
    {78, 3300, 3800, 3300, 3800, ISRRAN_DUPLEX_MODE_TDD},
    {79, 4400, 5000, 4400, 5000, ISRRAN_DUPLEX_MODE_TDD},
    {80, 1710, 1785, 0,    0,    ISRRAN_DUPLEX_MODE_SUL},
    {81, 880,  915,  0,    0,    ISRRAN_DUPLEX_MODE_SUL},
    {82, 832,  862,  0,    0,    ISRRAN_DUPLEX_MODE_SUL},
    {83, 703,  748,  0,    0,    ISRRAN_DUPLEX_MODE_SUL},
    {84, 1920, 1980, 0,    0,    ISRRAN_DUPLEX_MODE_SUL},
    {86, 1710, 1780, 0,    0,    ISRRAN_DUPLEX_MODE_SUL}
      // clang-format on
  }};
  ...
  static constexpr std::array<nr_band_ss_raster, nof_nr_band_ss_raster> nr_band_ss_raster_table = {{
      {1, isrran_subcarrier_spacing_15kHz, ISRRAN_SSB_PATTERN_A, 5279, 1, 5419},
      {2, isrran_subcarrier_spacing_15kHz, ISRRAN_SSB_PATTERN_A, 4829, 1, 4969},
      {3, isrran_subcarrier_spacing_15kHz, ISRRAN_SSB_PATTERN_A, 4517, 1, 4693},
      {5, isrran_subcarrier_spacing_15kHz, ISRRAN_SSB_PATTERN_A, 2177, 1, 2230},
      {5, isrran_subcarrier_spacing_30kHz, ISRRAN_SSB_PATTERN_B, 2183, 1, 2224},
      {7, isrran_subcarrier_spacing_15kHz, ISRRAN_SSB_PATTERN_A, 6554, 1, 6718},
      {8, isrran_subcarrier_spacing_15kHz, ISRRAN_SSB_PATTERN_A, 2318, 1, 2395},
      {12, isrran_subcarrier_spacing_15kHz, ISRRAN_SSB_PATTERN_A, 1828, 1, 1858},
      {20, isrran_subcarrier_spacing_15kHz, ISRRAN_SSB_PATTERN_A, 1982, 1, 2047},
      {25, isrran_subcarrier_spacing_15kHz, ISRRAN_SSB_PATTERN_A, 4829, 1, 4981},
      {28, isrran_subcarrier_spacing_15kHz, ISRRAN_SSB_PATTERN_A, 1901, 1, 2002},
      {34, isrran_subcarrier_spacing_15kHz, ISRRAN_SSB_PATTERN_A, 5030, 1, 5056},
      {38, isrran_subcarrier_spacing_15kHz, ISRRAN_SSB_PATTERN_A, 6431, 1, 6544},
      {39, isrran_subcarrier_spacing_15kHz, ISRRAN_SSB_PATTERN_A, 4706, 1, 4795},
      {40, isrran_subcarrier_spacing_15kHz, ISRRAN_SSB_PATTERN_A, 5756, 1, 5995},
      {41, isrran_subcarrier_spacing_15kHz, ISRRAN_SSB_PATTERN_A, 6246, 3, 6717},
      {41, isrran_subcarrier_spacing_30kHz, ISRRAN_SSB_PATTERN_C, 6252, 3, 6714},
      {50, isrran_subcarrier_spacing_15kHz, ISRRAN_SSB_PATTERN_A, 3584, 1, 3787},
      {51, isrran_subcarrier_spacing_15kHz, ISRRAN_SSB_PATTERN_A, 3572, 1, 3574},
      {66, isrran_subcarrier_spacing_15kHz, ISRRAN_SSB_PATTERN_A, 5279, 1, 5494},
      {66, isrran_subcarrier_spacing_30kHz, ISRRAN_SSB_PATTERN_B, 5285, 1, 5488},
      {70, isrran_subcarrier_spacing_15kHz, ISRRAN_SSB_PATTERN_A, 4993, 1, 5044},
      {71, isrran_subcarrier_spacing_15kHz, ISRRAN_SSB_PATTERN_A, 1547, 1, 1624},
      {74, isrran_subcarrier_spacing_15kHz, ISRRAN_SSB_PATTERN_A, 3692, 1, 3790},
      {75, isrran_subcarrier_spacing_15kHz, ISRRAN_SSB_PATTERN_A, 3584, 1, 3787},
      {76, isrran_subcarrier_spacing_15kHz, ISRRAN_SSB_PATTERN_A, 3572, 1, 3574},
      {77, isrran_subcarrier_spacing_30kHz, ISRRAN_SSB_PATTERN_C, 7711, 1, 8329},
      {78, isrran_subcarrier_spacing_30kHz, ISRRAN_SSB_PATTERN_C, 7711, 1, 8051},
      {79, isrran_subcarrier_spacing_30kHz, ISRRAN_SSB_PATTERN_C, 8480, 16, 8880},
  }};
};

} // namespace isrran

#endif // ISRRAN_BAND_HELPER_H
