...
#ifndef ISRRAN_BLOCK_QUEUE_H
#define ISRRAN_BLOCK_QUEUE_H
...
public:
  ...
  isrran::error_type<myobj> try_push(myobj&& value) { return push_(std::move(value), false); }
...
private:
  ...
  isrran::error_type<myobj> push_(myobj&& value, bool block)
  {
    if (!enable) {
