...
#ifndef ISRRAN_MULTIQUEUE_H
#define ISRRAN_MULTIQUEUE_H
...
class multiqueue_handler
{
  ...
  public:
    ...
    isrran::error_type<myobj> try_push(myobj&& o)
    {
      if (push_(&o, false)) {
        return {};
      }
  ...
  private:
    ...
    isrran::dyn_circular_buffer<myobj> buffer;
...
public:
  ...
  public:
    ...
    isrran::error_type<myobj> try_push(myobj&& value) { return impl->try_push(std::move(value)); }
    void                      reset()
    {
      if (impl != nullptr) {
