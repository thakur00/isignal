...
#ifndef ISRRAN_THREAD_POOL_H
#define ISRRAN_THREAD_POOL_H
...
{
  using task_t                             = isrran::move_callback<void(), default_move_callback_buffer_size, true>;
...
private:
  ...
  isrran::dyn_circular_buffer<task_t>     pending_tasks;
...
private:
  ...
  isrran::dyn_blocking_queue<task_t> pending_tasks;
};

isrran::task_thread_pool& get_background_workers();

} // namespace isrran

#endif // ISRRAN_THREAD_POOL_H
