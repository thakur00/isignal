...
#ifndef ISRRAN_PHY_CFG_NR_DEFAULT_H
#define ISRRAN_PHY_CFG_NR_DEFAULT_H
...
private:
   ...
   */
  static void make_carrier_custom_10MHz(isrran_carrier_nr_t& carrier);
  static void make_carrier_custom_20MHz(isrran_carrier_nr_t& carrier);

  /**
   * TDD make helper methods
   */
  static void make_tdd_custom_6_4(isrran_duplex_config_nr_t& duplex);
  static void make_tdd_fr1_15_1(isrran_duplex_config_nr_t& duplex);

  /**
   * PDCCH make helper methods
   */
  static void make_pdcch_custom_common_ss(isrran_pdcch_cfg_nr_t& pdcch, const isrran_carrier_nr_t& carrier);

  /**
   * PDSCH make helper methods
   */
  static void make_pdsch_default(isrran_sch_hl_cfg_nr_t& pdsch);
  static void make_pdsch_2_1_1_tdd(const isrran_carrier_nr_t& carrier, isrran_sch_hl_cfg_nr_t& pdsch);

  /**
   * PUSCH make helper methods
   */
  static void make_pusch_default(isrran_sch_hl_cfg_nr_t& pusch);

  /**
   * PUCCH make helper methods
   */
  static void make_pucch_custom_one(isrran_pucch_nr_hl_cfg_t& pucch);

  /**
   * HARQ make helper methods
   */
  static void make_harq_auto(isrran_harq_ack_cfg_hl_t&        harq,
   ...
   */
  static void make_prach_default_lte(isrran_prach_cfg_t& prach);
};

} // namespace isrran

#endif // ISRRAN_PHY_CFG_NR_DEFAULT_H
