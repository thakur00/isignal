...
#ifndef ISRRAN_NETSOURE_HANDLER_H
#define ISRRAN_NETSOURE_HANDLER_H
...
class netsource_handler : public isrran::thread
{
public:
  ...
  isrran_netsource_t net_source;
};

#endif // ISRRAN_NETSOURE_HANDLER_H
