...
#ifndef ISRRAN_TSAN_OPTIONS_H
#define ISRRAN_TSAN_OPTIONS_H
...
const char* __tsan_default_suppressions()
{
  return
      ...
      "deadlock:isrenb::mac::rlc_buffer_state\n"
      "deadlock:isrenb::mac::snr_info\n"
      "deadlock:isrenb::mac::ack_info\n"
      "deadlock:isrenb::mac::cqi_info\n"
      "deadlock:isrenb::rlc::rb_is_um\n"
      "deadlock:isrenb::mac::sr_detected\n";
}
