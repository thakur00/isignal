...
#ifndef ISRRAN_LINEAR_ALLOCATOR_H
#define ISRRAN_LINEAR_ALLOCATOR_H
...
public:
  ...
  void deallocate(void* p) { isrran_assert(p >= start and p < end, "pointer does not belong to pool"); }
...
#endif // ISRRAN_LINEAR_ALLOCATOR_H
