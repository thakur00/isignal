...
#ifndef ISRRAN_POOL_INTERFACE_H
#define ISRRAN_POOL_INTERFACE_H
...
template <typename T>
using unique_pool_ptr = std::unique_ptr<T, isrran::move_callback<void(T*), unique_pool_deleter_small_buffer> >;
