...
#ifndef ISRRAN_TYPE_UTILS_H
#define ISRRAN_TYPE_UTILS_H
...
//! isrran::get<Type> access methods
...
{
  isrran_assert(c.template is<T>(), "Bad access via get<T>");
