...
#ifndef ISRRAN_MOVE_CALLBACK_H
#define ISRRAN_MOVE_CALLBACK_H
...
#define THROW_BAD_FUNCTION_CALL(cause)                                                                                 \
  isrran_assert(false, "ERROR: exception thrown due to bad function call (cause: %s)\n", cause);
#endif
...
public:
  ...
  {
    isrran_assertion_failure("bad function call (cause: function ptr is empty)");
  }
