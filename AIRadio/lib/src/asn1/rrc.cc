...
ISRASN_CODE mib_mbms_r14_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE mib_mbms_r14_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE bcch_bch_msg_mbms_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE bcch_bch_msg_mbms_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE bcch_dl_sch_msg_type_mbms_r14_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::c1:
...
ISRASN_CODE bcch_dl_sch_msg_type_mbms_r14_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE bcch_dl_sch_msg_type_mbms_r14_c::c1_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::sys_info_mbms_r14:
...
ISRASN_CODE bcch_dl_sch_msg_type_mbms_r14_c::c1_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE bcch_dl_sch_msg_mbms_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(msg.pack(bref));
...
ISRASN_CODE bcch_dl_sch_msg_mbms_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(msg.unpack(bref));
...
{
  static const char* options[] = {"ue-TxAntennaSelection-ISR-1T4R-Config-r15",
                                  "ue-TxAntennaSelection-ISR-2T4R-NrOfPairs-r15"};
...
ISRASN_CODE mbms_session_info_r9_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE mbms_session_info_r9_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE pmch_cfg_r12_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE pmch_cfg_r12_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE pmch_cfg_r12_s::data_mcs_r12_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::normal_r12:
...
ISRASN_CODE pmch_cfg_r12_s::data_mcs_r12_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE pmch_info_ext_r12_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE pmch_info_ext_r12_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE mbsfn_area_cfg_v1430_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE mbsfn_area_cfg_v1430_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE pmch_cfg_r9_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE pmch_cfg_r9_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE count_request_info_r10_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE count_request_info_r10_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE mbsfn_area_cfg_v1250_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE mbsfn_area_cfg_v1250_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE pmch_info_r9_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE pmch_info_r9_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE mbsfn_area_cfg_v930_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE mbsfn_area_cfg_v930_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE mbms_count_request_r10_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(late_non_crit_ext_present, 1));
  HANDLE_CODE(bref.pack(non_crit_ext_present, 1));
...
ISRASN_CODE mbms_count_request_r10_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(late_non_crit_ext_present, 1));
  HANDLE_CODE(bref.unpack(non_crit_ext_present, 1));
...
ISRASN_CODE mbsfn_area_cfg_r9_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(non_crit_ext_present, 1));
...
ISRASN_CODE mbsfn_area_cfg_r9_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(non_crit_ext_present, 1));
...
ISRASN_CODE mcch_msg_type_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::c1:
...
ISRASN_CODE mcch_msg_type_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE mcch_msg_type_c::c1_c_::pack(bit_ref& bref) const
{
  HANDLE_CODE(c.pack(bref));
  return ISRASN_SUCCESS;
}
ISRASN_CODE mcch_msg_type_c::c1_c_::unpack(cbit_ref& bref)
{
  HANDLE_CODE(c.unpack(bref));
  return ISRASN_SUCCESS;
}
...
ISRASN_CODE mcch_msg_type_c::later_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::c2:
...
ISRASN_CODE mcch_msg_type_c::later_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE mcch_msg_type_c::later_c_::c2_c_::pack(bit_ref& bref) const
{
  HANDLE_CODE(c.pack(bref));
  return ISRASN_SUCCESS;
}
ISRASN_CODE mcch_msg_type_c::later_c_::c2_c_::unpack(cbit_ref& bref)
{
  HANDLE_CODE(c.unpack(bref));
  return ISRASN_SUCCESS;
}
...
ISRASN_CODE mcch_msg_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(msg.pack(bref));
...
ISRASN_CODE mcch_msg_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(msg.unpack(bref));
...
ISRASN_CODE mbms_session_info_r13_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE mbms_session_info_r13_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sc_mtch_sched_info_br_r14_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sc_mtch_sched_info_br_r14_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sc_mtch_sched_info_br_r14_s::sched_period_start_offset_scptm_r14_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::sf10:
...
ISRASN_CODE sc_mtch_sched_info_br_r14_s::sched_period_start_offset_scptm_r14_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE sc_mtch_sched_info_r13_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sc_mtch_sched_info_r13_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sc_mtch_sched_info_r13_s::sched_period_start_offset_scptm_r13_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::sf10:
...
ISRASN_CODE sc_mtch_sched_info_r13_s::sched_period_start_offset_scptm_r13_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE pci_arfcn_r13_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE pci_arfcn_r13_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sc_mtch_info_br_r14_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sc_mtch_info_br_r14_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sc_mtch_info_br_r14_s::mpdcch_start_sf_sc_mtch_r14_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::fdd_r14:
...
ISRASN_CODE sc_mtch_info_br_r14_s::mpdcch_start_sf_sc_mtch_r14_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE sc_mtch_info_r13_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sc_mtch_info_r13_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE scptm_cfg_v1340_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE scptm_cfg_v1340_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE scptm_cfg_br_r14_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE scptm_cfg_br_r14_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE scptm_cfg_r13_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE scptm_cfg_r13_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sc_mcch_msg_type_r13_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::c1:
...
ISRASN_CODE sc_mcch_msg_type_r13_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE sc_mcch_msg_type_r13_c::c1_c_::pack(bit_ref& bref) const
{
  HANDLE_CODE(c.pack(bref));
  return ISRASN_SUCCESS;
}
ISRASN_CODE sc_mcch_msg_type_r13_c::c1_c_::unpack(cbit_ref& bref)
{
  HANDLE_CODE(c.unpack(bref));
  return ISRASN_SUCCESS;
}
...
ISRASN_CODE sc_mcch_msg_type_r13_c::msg_class_ext_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::c2:
...
ISRASN_CODE sc_mcch_msg_type_r13_c::msg_class_ext_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE sc_mcch_msg_type_r13_c::msg_class_ext_c_::c2_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::scptm_cfg_br_r14:
...
ISRASN_CODE sc_mcch_msg_type_r13_c::msg_class_ext_c_::c2_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE sc_mcch_msg_r13_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(msg.pack(bref));
...
ISRASN_CODE sc_mcch_msg_r13_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(msg.unpack(bref));
...
ISRASN_CODE fail_report_scg_v12d0_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE fail_report_scg_v12d0_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE mimo_weighted_layers_cap_r13_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE mimo_weighted_layers_cap_r13_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE mimo_ue_params_v13e0_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE mimo_ue_params_v13e0_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE meas_result3_eutra_r15_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE meas_result3_eutra_r15_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE meas_result_scg_fail_mrdc_r15_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE meas_result_scg_fail_mrdc_r15_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE phy_layer_params_v13e0_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(mimo_ue_params_v13e0.pack(bref));

  return ISRASN_SUCCESS;
}
ISRASN_CODE phy_layer_params_v13e0_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE scg_fail_info_v12d0b_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE scg_fail_info_v12d0b_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE ue_eutra_cap_v13e0b_ies_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(non_crit_ext_present, 1));
...
ISRASN_CODE ue_eutra_cap_v13e0b_ies_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(non_crit_ext_present, 1));
...
ISRASN_CODE cells_triggered_list_item_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::pci_eutra:
...
ISRASN_CODE cells_triggered_list_item_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE cells_triggered_list_item_c_::pci_utra_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::fdd:
...
ISRASN_CODE cells_triggered_list_item_c_::pci_utra_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE drb_info_scg_r12_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE drb_info_scg_r12_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE tdd_cfg_sl_r12_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(sf_assign_sl_r12.pack(bref));

  return ISRASN_SUCCESS;
}
ISRASN_CODE tdd_cfg_sl_r12_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE mib_sl_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE mib_sl_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE mib_sl_v2x_r14_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE mib_sl_v2x_r14_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE meas_result_rssi_scg_r13_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE meas_result_rssi_scg_r13_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE meas_result_serv_cell_scg_r12_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE meas_result_serv_cell_scg_r12_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sbcch_sl_bch_msg_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(msg.pack(bref));
...
ISRASN_CODE sbcch_sl_bch_msg_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(msg.unpack(bref));
...
ISRASN_CODE sbcch_sl_bch_msg_v2x_r14_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(msg.pack(bref));
...
ISRASN_CODE sbcch_sl_bch_msg_v2x_r14_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(msg.unpack(bref));
...
ISRASN_CODE scg_cfg_v12i0b_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE scg_cfg_v12i0b_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE scg_cfg_info_v1530_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE scg_cfg_info_v1530_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE scg_cfg_info_v1430_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE scg_cfg_info_v1430_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE scg_cfg_info_v1330_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE scg_cfg_info_v1330_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE scg_cfg_info_v1310_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE scg_cfg_info_v1310_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE scg_cfg_restrict_info_r12_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE scg_cfg_restrict_info_r12_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE scg_cfg_info_r12_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE scg_cfg_info_r12_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE scg_cfg_info_r12_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(crit_exts.pack(bref));

  return ISRASN_SUCCESS;
}
ISRASN_CODE scg_cfg_info_r12_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE scg_cfg_info_r12_s::crit_exts_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::c1:
...
ISRASN_CODE scg_cfg_info_r12_s::crit_exts_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE scg_cfg_info_r12_s::crit_exts_c_::c1_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::scg_cfg_info_r12:
...
ISRASN_CODE scg_cfg_info_r12_s::crit_exts_c_::c1_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE sl_pppp_tx_precfg_idx_r14_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sl_pppp_tx_precfg_idx_r14_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sl_pppp_tx_precfg_idx_v1530_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sl_pppp_tx_precfg_idx_v1530_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sl_cbr_precfg_tx_cfg_list_r14_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sl_cbr_precfg_tx_cfg_list_r14_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sl_precfg_comm_pool_r12_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sl_precfg_comm_pool_r12_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sl_precfg_disc_pool_r13_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sl_precfg_disc_pool_r13_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sl_precfg_general_r12_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sl_precfg_general_r12_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sl_precfg_relay_r13_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(resel_info_oo_c_r13.pack(bref));

  return ISRASN_SUCCESS;
}
ISRASN_CODE sl_precfg_relay_r13_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sl_precfg_sync_r12_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sl_precfg_sync_r12_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sl_v2x_precfg_comm_pool_r14_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sl_v2x_precfg_comm_pool_r14_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sl_v2x_sync_offset_inds_r14_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sl_v2x_sync_offset_inds_r14_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sl_precfg_v2x_sync_r14_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sl_precfg_v2x_sync_r14_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sl_precfg_r12_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sl_precfg_r12_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sl_v2x_precfg_freq_info_r14_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sl_v2x_precfg_freq_info_r14_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sl_v2x_precfg_r14_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sl_v2x_precfg_r14_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE var_conn_est_fail_report_r11_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE var_conn_est_fail_report_r11_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE var_log_meas_cfg_r10_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE var_log_meas_cfg_r10_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE var_log_meas_cfg_r11_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(area_cfg_r10_present, 1));
...
ISRASN_CODE var_log_meas_cfg_r11_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(area_cfg_r10_present, 1));
...
ISRASN_CODE var_log_meas_cfg_r12_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(area_cfg_r10_present, 1));
  HANDLE_CODE(bref.pack(area_cfg_v1130_present, 1));
...
ISRASN_CODE var_log_meas_cfg_r12_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(area_cfg_r10_present, 1));
  HANDLE_CODE(bref.unpack(area_cfg_v1130_present, 1));
...
ISRASN_CODE var_log_meas_cfg_r15_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(area_cfg_r10_present, 1));
  HANDLE_CODE(bref.pack(area_cfg_v1130_present, 1));
  HANDLE_CODE(bref.pack(target_mbsfn_area_list_r12_present, 1));
...
ISRASN_CODE var_log_meas_cfg_r15_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(area_cfg_r10_present, 1));
  HANDLE_CODE(bref.unpack(area_cfg_v1130_present, 1));
  HANDLE_CODE(bref.unpack(target_mbsfn_area_list_r12_present, 1));
...
ISRASN_CODE var_log_meas_report_r10_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE var_log_meas_report_r10_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE var_log_meas_report_r11_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(trace_ref_r10.pack(bref));
  HANDLE_CODE(trace_recording_session_ref_r10.pack(bref));
  HANDLE_CODE(tce_id_r10.pack(bref));
...
ISRASN_CODE var_log_meas_report_r11_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(trace_ref_r10.unpack(bref));
  HANDLE_CODE(trace_recording_session_ref_r10.unpack(bref));
  HANDLE_CODE(tce_id_r10.unpack(bref));
...
ISRASN_CODE var_meas_idle_cfg_r15_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE var_meas_idle_cfg_r15_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE var_meas_idle_report_r15_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(pack_dyn_seq_of(bref, meas_report_idle_r15, 1, 3));

  return ISRASN_SUCCESS;
}
ISRASN_CODE var_meas_idle_report_r15_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE var_meas_report_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE var_meas_report_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE var_rlf_report_r10_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE var_rlf_report_r10_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE var_rlf_report_r11_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(rlf_report_r10.pack(bref));
  HANDLE_CODE(pack_dyn_seq_of(bref, plmn_id_list_r11, 1, 16));
...
ISRASN_CODE var_rlf_report_r11_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(rlf_report_r10.unpack(bref));
  HANDLE_CODE(unpack_dyn_seq_of(plmn_id_list_r11, bref, 1, 16));
...
ISRASN_CODE var_short_inactive_mac_input_r15_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE var_short_inactive_mac_input_r15_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE var_short_resume_mac_input_r13_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE var_short_resume_mac_input_r13_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE var_wlan_mob_cfg_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE var_wlan_mob_cfg_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE var_wlan_status_r13_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE var_wlan_status_r13_s::unpack(cbit_ref& bref)
{
