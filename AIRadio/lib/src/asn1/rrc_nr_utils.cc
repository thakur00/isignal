...
#include "isrran/asn1/obj_id_cmp_utils.h"
...
isrran::pdcp_config_t make_nr_srb_pdcp_config_t(const uint8_t bearer_id, bool is_ue)
{
...
isrran::pdcp_config_t make_drb_pdcp_config_t(const uint8_t bearer_id, bool is_ue, const pdcp_cfg_s& pdcp_cfg)
{
  ...
  uint8_t sn_len = isrran::PDCP_SN_LEN_12;
                       ...
                       isrran_prach_cfg_t*      prach_cfg)
{
  ...
  if (duplex_mode == ISRRAN_DUPLEX_MODE_TDD) {
                      ...
                      isrran_duplex_config_nr_t*    in_isrran_duplex_config_nr)
{
  ...
  isrran_duplex_config_nr.tdd.pattern1.nof_dl_slots   = tdd_ul_dl_cfg_common.pattern1.nrof_dl_slots;
  isrran_duplex_config_nr.tdd.pattern1.nof_dl_symbols = tdd_ul_dl_cfg_common.pattern1.nrof_dl_symbols;
  isrran_duplex_config_nr.tdd.pattern1.nof_ul_slots   = tdd_ul_dl_cfg_common.pattern1.nrof_ul_slots;
  isrran_duplex_config_nr.tdd.pattern1.nof_ul_symbols = tdd_ul_dl_cfg_common.pattern1.nrof_ul_symbols;

  if (tdd_ul_dl_cfg_common.pattern2_present) {
    switch (tdd_ul_dl_cfg_common.pattern2.dl_ul_tx_periodicity) {
      case tdd_ul_dl_pattern_s::dl_ul_tx_periodicity_opts::ms1:
        isrran_duplex_config_nr.tdd.pattern2.period_ms = 1;
        break;
      case tdd_ul_dl_pattern_s::dl_ul_tx_periodicity_opts::ms2:
        isrran_duplex_config_nr.tdd.pattern2.period_ms = 2;
        break;
      case tdd_ul_dl_pattern_s::dl_ul_tx_periodicity_opts::ms5:
        isrran_duplex_config_nr.tdd.pattern2.period_ms = 5;
        break;
      case tdd_ul_dl_pattern_s::dl_ul_tx_periodicity_opts::ms10:
        isrran_duplex_config_nr.tdd.pattern2.period_ms = 10;
        break;
    ...
    isrran_duplex_config_nr.tdd.pattern2.nof_dl_slots   = tdd_ul_dl_cfg_common.pattern2.nrof_dl_slots;
    isrran_duplex_config_nr.tdd.pattern2.nof_dl_symbols = tdd_ul_dl_cfg_common.pattern2.nrof_dl_symbols;
    isrran_duplex_config_nr.tdd.pattern2.nof_ul_slots   = tdd_ul_dl_cfg_common.pattern2.nrof_ul_slots;
    isrran_duplex_config_nr.tdd.pattern2.nof_ul_symbols = tdd_ul_dl_cfg_common.pattern2.nrof_ul_symbols;
  }

  // Copy and return struct
  *in_isrran_duplex_config_nr = isrran_duplex_config_nr;
...
{
  if (isrran_duplex_config_nr.mode == ISRRAN_DUPLEX_MODE_FDD) {
    return true;
  }
  tdd_ul_dl_cfg_common->ref_subcarrier_spacing.value = (asn1::rrc_nr::subcarrier_spacing_e::options)scs;

  switch (isrran_duplex_config_nr.tdd.pattern1.period_ms) {
    case 1:
    ...
    default:
      asn1::log_warning("Invalid option for dl_ul_tx_periodicity_opts %d",
                        isrran_duplex_config_nr.tdd.pattern1.period_ms);
      return false;
  }
  tdd_ul_dl_cfg_common->pattern1.nrof_dl_slots   = isrran_duplex_config_nr.tdd.pattern1.nof_dl_slots;
  tdd_ul_dl_cfg_common->pattern1.nrof_dl_symbols = isrran_duplex_config_nr.tdd.pattern1.nof_dl_symbols;
  tdd_ul_dl_cfg_common->pattern1.nrof_ul_slots   = isrran_duplex_config_nr.tdd.pattern1.nof_ul_slots;
  tdd_ul_dl_cfg_common->pattern1.nrof_ul_symbols = isrran_duplex_config_nr.tdd.pattern1.nof_ul_symbols;

  if (isrran_duplex_config_nr.tdd.pattern2.period_ms == 0) {
    return true;
  }

  tdd_ul_dl_cfg_common->pattern2_present = true;
  switch (isrran_duplex_config_nr.tdd.pattern2.period_ms) {
    case 1:
    ...
    default:
      asn1::log_warning("Invalid option for pattern2 dl_ul_tx_periodicity_opts %d",
                        isrran_duplex_config_nr.tdd.pattern2.period_ms);
      return false;
  }
  tdd_ul_dl_cfg_common->pattern2.nrof_dl_slots   = isrran_duplex_config_nr.tdd.pattern2.nof_dl_slots;
  tdd_ul_dl_cfg_common->pattern2.nrof_dl_symbols = isrran_duplex_config_nr.tdd.pattern2.nof_dl_symbols;
  tdd_ul_dl_cfg_common->pattern2.nrof_ul_slots   = isrran_duplex_config_nr.tdd.pattern2.nof_ul_slots;
  tdd_ul_dl_cfg_common->pattern2.nrof_ul_symbols = isrran_duplex_config_nr.tdd.pattern2.nof_ul_symbols;

  return true;
}

bool make_phy_harq_ack_cfg(const phys_cell_group_cfg_s& phys_cell_group_cfg,
                           isrran_harq_ack_cfg_hl_t*    in_isrran_ue_dl_nr_harq_ack_cfg)
{
  ...
  switch (phys_cell_group_cfg.pdsch_harq_ack_codebook) {
    case phys_cell_group_cfg_s::pdsch_harq_ack_codebook_opts::dynamic_value:
      isrran_ue_dl_nr_harq_ack_cfg.harq_ack_codebook = isrran_pdsch_harq_ack_codebook_dynamic;
      break;
    case phys_cell_group_cfg_s::pdsch_harq_ack_codebook_opts::semi_static:
      isrran_ue_dl_nr_harq_ack_cfg.harq_ack_codebook = isrran_pdsch_harq_ack_codebook_semi_static;
      break;
    case phys_cell_group_cfg_s::pdsch_harq_ack_codebook_opts::nulltype:
      isrran_ue_dl_nr_harq_ack_cfg.harq_ack_codebook = isrran_pdsch_harq_ack_codebook_none;
      break;
    default:
  ...
  *in_isrran_ue_dl_nr_harq_ack_cfg = isrran_ue_dl_nr_harq_ack_cfg;
  return true;
}

void make_phy_search_space0_cfg(isrran_search_space_t* in_isrran_search_space)
{
  in_isrran_search_space->id                = 0;
  in_isrran_search_space->coreset_id        = 0;
  in_isrran_search_space->type              = isrran_search_space_type_common_0;
  in_isrran_search_space->nof_candidates[0] = 0;
  in_isrran_search_space->nof_candidates[1] = 0;
  in_isrran_search_space->nof_candidates[2] = 4;
  in_isrran_search_space->nof_candidates[3] = 2;
  in_isrran_search_space->nof_candidates[4] = 0;
  in_isrran_search_space->nof_formats       = 1;
  in_isrran_search_space->formats[0]        = isrran_dci_format_nr_1_0;
  in_isrran_search_space->duration          = 1;
}

bool make_phy_search_space_cfg(const search_space_s& search_space, isrran_search_space_t* in_isrran_search_space)
{
  isrran_search_space_t isrran_search_space = {};
  isrran_search_space.id                    = search_space.search_space_id;
  if (not search_space.ctrl_res_set_id_present) {
    asn1::log_warning("ctrl_res_set_id option not present");
    return false;
  }
  isrran_search_space.coreset_id = search_space.ctrl_res_set_id;

  isrran_search_space.duration = 1;
  if (search_space.dur_present) {
    isrran_search_space.duration = search_space.dur;
  }
  ...
  isrran_search_space.nof_candidates[0] = search_space.nrof_candidates.aggregation_level1.to_number();
  isrran_search_space.nof_candidates[1] = search_space.nrof_candidates.aggregation_level2.to_number();
  isrran_search_space.nof_candidates[2] = search_space.nrof_candidates.aggregation_level4.to_number();
  isrran_search_space.nof_candidates[3] = search_space.nrof_candidates.aggregation_level8.to_number();
  isrran_search_space.nof_candidates[4] = search_space.nrof_candidates.aggregation_level16.to_number();
  ...
  switch (search_space.search_space_type.type()) {
    case search_space_s::search_space_type_c_::types_opts::options::common:
      isrran_search_space.type = isrran_search_space_type_common_3;
      ...
      if (search_space.search_space_type.common().dci_format0_minus0_and_format1_minus0_present) {
        isrran_search_space.formats[isrran_search_space.nof_formats++] = isrran_dci_format_nr_0_0;
        isrran_search_space.formats[isrran_search_space.nof_formats++] = isrran_dci_format_nr_1_0;
      }
      ...
      if (search_space.search_space_type.common().dci_format2_minus0_present) {
        isrran_search_space.formats[isrran_search_space.nof_formats++] = isrran_dci_format_nr_2_0;
      }
      ...
      if (search_space.search_space_type.common().dci_format2_minus1_present) {
        isrran_search_space.formats[isrran_search_space.nof_formats++] = isrran_dci_format_nr_2_1;
      }
      ...
      if (search_space.search_space_type.common().dci_format2_minus2_present) {
        isrran_search_space.formats[isrran_search_space.nof_formats++] = isrran_dci_format_nr_2_2;
      }
      ...
      if (search_space.search_space_type.common().dci_format2_minus3_present) {
        isrran_search_space.formats[isrran_search_space.nof_formats++] = isrran_dci_format_nr_2_3;
      }

      break;
    case search_space_s::search_space_type_c_::types_opts::options::ue_specific:
      isrran_search_space.type = isrran_search_space_type_ue;
      switch (search_space.search_space_type.ue_specific().dci_formats.value) {
        ...
        case search_space_s::search_space_type_c_::ue_specific_s_::dci_formats_e_::formats0_minus1_and_minus1_minus1:
          isrran_search_space.formats[isrran_search_space.nof_formats++] = isrran_dci_format_nr_0_1;
          isrran_search_space.formats[isrran_search_space.nof_formats++] = isrran_dci_format_nr_1_1;
          break;
      }
      break;
    default:
  ...
  *in_isrran_search_space = isrran_search_space;
  return true;
}

bool make_phy_csi_report(const csi_report_cfg_s&     csi_report_cfg,
                         isrran_csi_hl_report_cfg_t* in_isrran_csi_hl_report_cfg)
{
  ...
  switch (csi_report_cfg.report_cfg_type.type()) {
    case csi_report_cfg_s::report_cfg_type_c_::types_opts::options::nulltype:
      isrran_csi_hl_report_cfg.type = ISRRAN_CSI_REPORT_TYPE_NONE;
      break;
    case csi_report_cfg_s::report_cfg_type_c_::types_opts::options::periodic:
      isrran_csi_hl_report_cfg.type = ISRRAN_CSI_REPORT_TYPE_PERIODIC;
      break;
    case csi_report_cfg_s::report_cfg_type_c_::types_opts::options::aperiodic:
      isrran_csi_hl_report_cfg.type = ISRRAN_CSI_REPORT_TYPE_APERIODIC;
      break;
    case csi_report_cfg_s::report_cfg_type_c_::types_opts::options::semi_persistent_on_pucch:
      isrran_csi_hl_report_cfg.type = ISRRAN_CSI_REPORT_TYPE_SEMI_PERSISTENT_ON_PUCCH;
      break;
    case csi_report_cfg_s::report_cfg_type_c_::types_opts::options::semi_persistent_on_pusch:
      isrran_csi_hl_report_cfg.type = ISRRAN_CSI_REPORT_TYPE_SEMI_PERSISTENT_ON_PUSCH;
      break;
    default:
  ...
  if (isrran_csi_hl_report_cfg.type == ISRRAN_CSI_REPORT_TYPE_PERIODIC) {
    const auto& csi_periodic                 = csi_report_cfg.report_cfg_type.periodic();
    isrran_csi_hl_report_cfg.periodic.period = csi_periodic.report_slot_cfg.type().to_number();
    switch (csi_periodic.report_slot_cfg.type()) {
      case csi_report_periodicity_and_offset_c::types_opts::slots4:
        isrran_csi_hl_report_cfg.periodic.offset = csi_periodic.report_slot_cfg.slots4();
        break;
      case csi_report_periodicity_and_offset_c::types_opts::slots5:
        isrran_csi_hl_report_cfg.periodic.offset = csi_periodic.report_slot_cfg.slots5();
        break;
      case csi_report_periodicity_and_offset_c::types_opts::slots8:
        isrran_csi_hl_report_cfg.periodic.offset = csi_periodic.report_slot_cfg.slots8();
        break;
      case csi_report_periodicity_and_offset_c::types_opts::slots10:
        isrran_csi_hl_report_cfg.periodic.offset = csi_periodic.report_slot_cfg.slots10();
        break;
      case csi_report_periodicity_and_offset_c::types_opts::slots16:
        isrran_csi_hl_report_cfg.periodic.offset = csi_periodic.report_slot_cfg.slots16();
        break;
      case csi_report_periodicity_and_offset_c::types_opts::slots20:
        isrran_csi_hl_report_cfg.periodic.offset = csi_periodic.report_slot_cfg.slots20();
        break;
      case csi_report_periodicity_and_offset_c::types_opts::slots40:
        isrran_csi_hl_report_cfg.periodic.offset = csi_periodic.report_slot_cfg.slots40();
        break;
      case csi_report_periodicity_and_offset_c::types_opts::slots80:
        isrran_csi_hl_report_cfg.periodic.offset = csi_periodic.report_slot_cfg.slots80();
        break;
      case csi_report_periodicity_and_offset_c::types_opts::slots160:
        isrran_csi_hl_report_cfg.periodic.offset = csi_periodic.report_slot_cfg.slots160();
        break;
      case csi_report_periodicity_and_offset_c::types_opts::slots320:
        isrran_csi_hl_report_cfg.periodic.offset = csi_periodic.report_slot_cfg.slots320();
        break;
      default:
  ...
  isrran_csi_hl_report_cfg.channel_meas_id = csi_report_cfg.res_for_ch_meas;

  isrran_csi_hl_report_cfg.interf_meas_present = csi_report_cfg.csi_im_res_for_interference_present;
  isrran_csi_hl_report_cfg.interf_meas_id      = csi_report_cfg.csi_im_res_for_interference;

  switch (csi_report_cfg.report_quant.type()) {
    case csi_report_cfg_s::report_quant_c_::types_opts::none:
      isrran_csi_hl_report_cfg.quantity = ISRRAN_CSI_REPORT_QUANTITY_NONE;
      break;
    case csi_report_cfg_s::report_quant_c_::types_opts::cri_ri_pmi_cqi:
      isrran_csi_hl_report_cfg.quantity = ISRRAN_CSI_REPORT_QUANTITY_CRI_RI_PMI_CQI;
      break;
    case csi_report_cfg_s::report_quant_c_::types_opts::cri_ri_i1:
      isrran_csi_hl_report_cfg.quantity = ISRRAN_CSI_REPORT_QUANTITY_CRI_RI_I1;
      break;
    case csi_report_cfg_s::report_quant_c_::types_opts::cri_ri_i1_cqi:
      isrran_csi_hl_report_cfg.quantity = ISRRAN_CSI_REPORT_QUANTITY_CRI_RI_I1_CQI;
      break;
    case csi_report_cfg_s::report_quant_c_::types_opts::cri_ri_cqi:
      isrran_csi_hl_report_cfg.quantity = ISRRAN_CSI_REPORT_QUANTITY_CRI_RI_CQI;
      break;
    case csi_report_cfg_s::report_quant_c_::types_opts::cri_rsrp:
      isrran_csi_hl_report_cfg.quantity = ISRRAN_CSI_REPORT_QUANTITY_CRI_RSRP;
      break;
    case csi_report_cfg_s::report_quant_c_::types_opts::ssb_idx_rsrp:
      isrran_csi_hl_report_cfg.quantity = ISRRAN_CSI_REPORT_QUANTITY_SSB_INDEX_RSRP;
      break;
    case csi_report_cfg_s::report_quant_c_::types_opts::cri_ri_li_pmi_cqi:
      isrran_csi_hl_report_cfg.quantity = ISRRAN_CSI_REPORT_QUANTITY_CRI_RI_LI_PMI_CQI;
      break;
    default:
  ...
  switch (csi_report_cfg.report_freq_cfg.cqi_format_ind) {
    case csi_report_cfg_s::report_freq_cfg_s_::cqi_format_ind_opts::wideband_cqi:
      isrran_csi_hl_report_cfg.freq_cfg = ISRRAN_CSI_REPORT_FREQ_WIDEBAND;
      break;
    case csi_report_cfg_s::report_freq_cfg_s_::cqi_format_ind_opts::subband_cqi:
      isrran_csi_hl_report_cfg.freq_cfg = ISRRAN_CSI_REPORT_FREQ_SUBBAND;
      break;
    default:
  ...
  switch (csi_report_cfg.cqi_table) {
    case csi_report_cfg_s::cqi_table_opts::table1:
      isrran_csi_hl_report_cfg.cqi_table = ISRRAN_CSI_CQI_TABLE_1;
      break;
    case csi_report_cfg_s::cqi_table_opts::table2:
      isrran_csi_hl_report_cfg.cqi_table = ISRRAN_CSI_CQI_TABLE_2;
      break;
    case csi_report_cfg_s::cqi_table_opts::table3:
      isrran_csi_hl_report_cfg.cqi_table = ISRRAN_CSI_CQI_TABLE_3;
      break;
    default:
  ...
  *in_isrran_csi_hl_report_cfg = isrran_csi_hl_report_cfg;
  return true;
}

bool make_phy_coreset_cfg(const ctrl_res_set_s& ctrl_res_set, isrran_coreset_t* in_isrran_coreset)
{
  isrran_coreset_t isrran_coreset = {};
  isrran_coreset.id               = ctrl_res_set.ctrl_res_set_id;
  switch (ctrl_res_set.precoder_granularity) {
    case ctrl_res_set_s::precoder_granularity_opts::same_as_reg_bundle:
      isrran_coreset.precoder_granularity = isrran_coreset_precoder_granularity_reg_bundle;
      break;
    case ctrl_res_set_s::precoder_granularity_opts::all_contiguous_rbs:
      isrran_coreset.precoder_granularity = isrran_coreset_precoder_granularity_contiguous;
    default:
  ...
  switch (ctrl_res_set.cce_reg_map_type.type()) {
    case ctrl_res_set_s::cce_reg_map_type_c_::types_opts::options::interleaved:
      isrran_coreset.mapping_type = isrran_coreset_mapping_type_interleaved;
      break;
    case ctrl_res_set_s::cce_reg_map_type_c_::types_opts::options::non_interleaved:
      isrran_coreset.mapping_type = isrran_coreset_mapping_type_non_interleaved;
      break;
    default:
      asn1::log_warning("Invalid option for cce_reg_map_type: %s", ctrl_res_set.cce_reg_map_type.type().to_string());
      return false;
  }
  isrran_coreset.duration = ctrl_res_set.dur;
  for (uint32_t i = 0; i < ISRRAN_CORESET_FREQ_DOMAIN_RES_SIZE; i++) {
    isrran_coreset.freq_resources[i] = ctrl_res_set.freq_domain_res.get(ISRRAN_CORESET_FREQ_DOMAIN_RES_SIZE - 1 - i);
  }
  *in_isrran_coreset = isrran_coreset;
  return true;
}

bool make_phy_common_time_ra(const pdsch_time_domain_res_alloc_s& pdsch_time_domain_res_alloc,
                             isrran_sch_time_ra_t*                in_isrran_sch_time_ra)
{
  isrran_sch_time_ra_t isrran_sch_time_ra = {};
  isrran_sch_time_ra.sliv                 = pdsch_time_domain_res_alloc.start_symbol_and_len;
  switch (pdsch_time_domain_res_alloc.map_type) {
    case pdsch_time_domain_res_alloc_s::map_type_opts::type_a:
      isrran_sch_time_ra.mapping_type = isrran_sch_mapping_type_A;
      break;
    case pdsch_time_domain_res_alloc_s::map_type_opts::type_b:
      isrran_sch_time_ra.mapping_type = isrran_sch_mapping_type_B;
      break;
    default:
  ...
  if (pdsch_time_domain_res_alloc.k0_present) {
    isrran_sch_time_ra.k = pdsch_time_domain_res_alloc.k0;
  } else {
    isrran_sch_time_ra.k = 0;
  }
  *in_isrran_sch_time_ra = isrran_sch_time_ra;
  return true;
}
...
{
  isrran_sch_time_ra_t isrran_sch_time_ra = {};
  isrran_sch_time_ra.sliv                 = pusch_time_domain_res_alloc.start_symbol_and_len;
  ...
  if (pusch_time_domain_res_alloc.k2_present) {
    isrran_sch_time_ra.k = pusch_time_domain_res_alloc.k2;
  } else {
    isrran_sch_time_ra.k = 0;
  }
  *in_isrran_sch_time_ra = isrran_sch_time_ra;
...
bool make_phy_res_config(const pucch_res_s&          pucch_res,
                         ...
                         isrran_pucch_nr_resource_t* in_isrran_pucch_nr_resource)
{
  isrran_pucch_nr_resource_t isrran_pucch_nr_resource = {};
  isrran_pucch_nr_resource.starting_prb               = pucch_res.start_prb;
  isrran_pucch_nr_resource.intra_slot_hopping         = pucch_res.intra_slot_freq_hop_present;
  if (pucch_res.second_hop_prb_present) {
    isrran_pucch_nr_resource.second_hop_prb = pucch_res.second_hop_prb;
  }
  switch (pucch_res.format.type()) {
    case pucch_res_s::format_c_::types_opts::format0:
      isrran_pucch_nr_resource.format = ISRRAN_PUCCH_NR_FORMAT_0;
      break;
    case pucch_res_s::format_c_::types_opts::format1:
      isrran_pucch_nr_resource.format               = ISRRAN_PUCCH_NR_FORMAT_1;
      isrran_pucch_nr_resource.initial_cyclic_shift = pucch_res.format.format1().init_cyclic_shift;
      isrran_pucch_nr_resource.nof_symbols          = pucch_res.format.format1().nrof_symbols;
      isrran_pucch_nr_resource.start_symbol_idx     = pucch_res.format.format1().start_symbol_idx;
      isrran_pucch_nr_resource.time_domain_occ      = pucch_res.format.format1().time_domain_occ;
      break;
    case pucch_res_s::format_c_::types_opts::format2:
      isrran_pucch_nr_resource.format           = ISRRAN_PUCCH_NR_FORMAT_2;
      isrran_pucch_nr_resource.nof_symbols      = pucch_res.format.format2().nrof_symbols;
      isrran_pucch_nr_resource.start_symbol_idx = pucch_res.format.format2().start_symbol_idx;
      isrran_pucch_nr_resource.nof_prb          = pucch_res.format.format2().nrof_prbs;
      break;
    case pucch_res_s::format_c_::types_opts::format3:
      isrran_pucch_nr_resource.format = ISRRAN_PUCCH_NR_FORMAT_3;
      asn1::log_warning("ISRRAN_PUCCH_NR_FORMAT_3 conversion not supported");
      return false;
    case pucch_res_s::format_c_::types_opts::format4:
      isrran_pucch_nr_resource.format = ISRRAN_PUCCH_NR_FORMAT_4;
      asn1::log_warning("ISRRAN_PUCCH_NR_FORMAT_4 conversion not supported");
      return false;
    default:
      isrran_pucch_nr_resource.format = ISRRAN_PUCCH_NR_FORMAT_ERROR;
      return false;
  }
  isrran_pucch_nr_resource.max_code_rate = format_2_max_code_rate;
  *in_isrran_pucch_nr_resource           = isrran_pucch_nr_resource;
  return true;
}
                         ...
                         uint32_t                          pucch_res_id)
{
  ...
  switch (in_pucch_res.format) {
    case ISRRAN_PUCCH_NR_FORMAT_0:
      asn1::log_warning("ISRRAN_PUCCH_NR_FORMAT_0 conversion not supported");
      return false;
...
bool make_phy_sr_resource(const sched_request_res_cfg_s& sched_request_res_cfg,
                          isrran_pucch_nr_sr_resource_t* in_isrran_pucch_nr_sr_resource)
{
  isrran_pucch_nr_sr_resource_t isrran_pucch_nr_sr_resource = {};
  isrran_pucch_nr_sr_resource.sr_id                         = sched_request_res_cfg.sched_request_id;
  if (sched_request_res_cfg.periodicity_and_offset_present && sched_request_res_cfg.res_present) {
    isrran_pucch_nr_sr_resource.configured = true;
    switch (sched_request_res_cfg.periodicity_and_offset.type()) {
      case sched_request_res_cfg_s::periodicity_and_offset_c_::types_opts::sl2:
        isrran_pucch_nr_sr_resource.period = 2;
        isrran_pucch_nr_sr_resource.offset = sched_request_res_cfg.periodicity_and_offset.sl2();
        break;
      case sched_request_res_cfg_s::periodicity_and_offset_c_::types_opts::sl4:
        isrran_pucch_nr_sr_resource.period = 4;
        isrran_pucch_nr_sr_resource.offset = sched_request_res_cfg.periodicity_and_offset.sl4();
        break;
      case sched_request_res_cfg_s::periodicity_and_offset_c_::types_opts::sl5:
        isrran_pucch_nr_sr_resource.period = 5;
        isrran_pucch_nr_sr_resource.offset = sched_request_res_cfg.periodicity_and_offset.sl5();
        break;
      case sched_request_res_cfg_s::periodicity_and_offset_c_::types_opts::sl8:
        isrran_pucch_nr_sr_resource.period = 8;
        isrran_pucch_nr_sr_resource.offset = sched_request_res_cfg.periodicity_and_offset.sl8();
        break;
      case sched_request_res_cfg_s::periodicity_and_offset_c_::types_opts::sl10:
        isrran_pucch_nr_sr_resource.period = 10;
        isrran_pucch_nr_sr_resource.offset = sched_request_res_cfg.periodicity_and_offset.sl10();
        break;
      case sched_request_res_cfg_s::periodicity_and_offset_c_::types_opts::sl16:
        isrran_pucch_nr_sr_resource.period = 16;
        isrran_pucch_nr_sr_resource.offset = sched_request_res_cfg.periodicity_and_offset.sl16();
        break;
      case sched_request_res_cfg_s::periodicity_and_offset_c_::types_opts::sl20:
        isrran_pucch_nr_sr_resource.period = 20;
        isrran_pucch_nr_sr_resource.offset = sched_request_res_cfg.periodicity_and_offset.sl20();
        break;
      case sched_request_res_cfg_s::periodicity_and_offset_c_::types_opts::sl40:
        isrran_pucch_nr_sr_resource.period = 40;
        isrran_pucch_nr_sr_resource.offset = sched_request_res_cfg.periodicity_and_offset.sl40();
        break;
      case sched_request_res_cfg_s::periodicity_and_offset_c_::types_opts::sl80:
        isrran_pucch_nr_sr_resource.period = 80;
        isrran_pucch_nr_sr_resource.offset = sched_request_res_cfg.periodicity_and_offset.sl80();
        break;
      case sched_request_res_cfg_s::periodicity_and_offset_c_::types_opts::sl160:
        isrran_pucch_nr_sr_resource.period = 160;
        isrran_pucch_nr_sr_resource.offset = sched_request_res_cfg.periodicity_and_offset.sl160();
        break;
      case sched_request_res_cfg_s::periodicity_and_offset_c_::types_opts::sl320:
        isrran_pucch_nr_sr_resource.period = 320;
        isrran_pucch_nr_sr_resource.offset = sched_request_res_cfg.periodicity_and_offset.sl320();
        break;
      case sched_request_res_cfg_s::periodicity_and_offset_c_::types_opts::sl640:
        isrran_pucch_nr_sr_resource.period = 640;
        isrran_pucch_nr_sr_resource.offset = sched_request_res_cfg.periodicity_and_offset.sl640();
        break;
      ...
      default:
        isrran_pucch_nr_sr_resource.configured = false;
  ...
  *in_isrran_pucch_nr_sr_resource = isrran_pucch_nr_sr_resource;
  return true;
}
                                     ...
                                     isrran_dmrs_sch_add_pos_t* in_isrran_dmrs_sch_add_pos)
{
  ...
  switch (dmrs_dl_cfg.dmrs_add_position) {
    case dmrs_dl_cfg_s::dmrs_add_position_opts::pos0:
      isrran_dmrs_sch_add_pos = isrran_dmrs_sch_add_pos_0;
      break;
    case dmrs_dl_cfg_s::dmrs_add_position_opts::pos1:
      isrran_dmrs_sch_add_pos = isrran_dmrs_sch_add_pos_1;
      break;
    case dmrs_dl_cfg_s::dmrs_add_position_opts::pos3:
      isrran_dmrs_sch_add_pos = isrran_dmrs_sch_add_pos_3;
      break;
    default:
      asn1::log_warning("Invalid option for dmrs_add_position %s", dmrs_dl_cfg.dmrs_add_position.to_string());
      return false;
  }
  *in_isrran_dmrs_sch_add_pos = isrran_dmrs_sch_add_pos;
  return true;
}
...
bool make_phy_beta_offsets(const beta_offsets_s& beta_offsets, isrran_beta_offsets_t* in_isrran_beta_offsets)
{
  isrran_beta_offsets_t isrran_beta_offsets = {};

  isrran_beta_offsets.ack_index1 = beta_offsets.beta_offset_ack_idx1_present ? beta_offsets.beta_offset_ack_idx1 : 11;
  isrran_beta_offsets.ack_index2 = beta_offsets.beta_offset_ack_idx2_present ? beta_offsets.beta_offset_ack_idx2 : 11;
  isrran_beta_offsets.ack_index3 = beta_offsets.beta_offset_ack_idx3_present ? beta_offsets.beta_offset_ack_idx3 : 11;
  isrran_beta_offsets.csi1_index1 =
      beta_offsets.beta_offset_csi_part1_idx1_present ? beta_offsets.beta_offset_csi_part1_idx1 : 13;
  isrran_beta_offsets.csi1_index2 =
      beta_offsets.beta_offset_csi_part1_idx2_present ? beta_offsets.beta_offset_csi_part1_idx2 : 13;
  isrran_beta_offsets.csi2_index1 =
      beta_offsets.beta_offset_csi_part2_idx1_present ? beta_offsets.beta_offset_csi_part2_idx1 : 13;
  isrran_beta_offsets.csi2_index2 =
      beta_offsets.beta_offset_csi_part2_idx2_present ? beta_offsets.beta_offset_csi_part2_idx2 : 13;
  *in_isrran_beta_offsets = isrran_beta_offsets;
  return true;
}
...
bool make_phy_zp_csi_rs_resource(const asn1::rrc_nr::zp_csi_rs_res_s& zp_csi_rs_res,
                                 isrran_csi_rs_zp_resource_t*         out_zp_csi_rs_resource)
{
  ...
  switch (zp_csi_rs_res.res_map.freq_domain_alloc.type()) {
    case csi_rs_res_map_s::freq_domain_alloc_c_::types_opts::options::row1:
      zp_csi_rs_resource.resource_mapping.row = isrran_csi_rs_resource_mapping_row_1;
    ...
    case csi_rs_res_map_s::freq_domain_alloc_c_::types_opts::options::row2:
      zp_csi_rs_resource.resource_mapping.row = isrran_csi_rs_resource_mapping_row_2;
    ...
    case csi_rs_res_map_s::freq_domain_alloc_c_::types_opts::options::row4:
      zp_csi_rs_resource.resource_mapping.row = isrran_csi_rs_resource_mapping_row_4;
    ...
    case csi_rs_res_map_s::freq_domain_alloc_c_::types_opts::options::other:
      zp_csi_rs_resource.resource_mapping.row = isrran_csi_rs_resource_mapping_row_other;
      break;
    default:
  ...
  switch (zp_csi_rs_res.res_map.cdm_type) {
    case csi_rs_res_map_s::cdm_type_opts::options::no_cdm:
      zp_csi_rs_resource.resource_mapping.cdm = isrran_csi_rs_cdm_t::isrran_csi_rs_cdm_nocdm;
      break;
    case csi_rs_res_map_s::cdm_type_opts::options::fd_cdm2:
      zp_csi_rs_resource.resource_mapping.cdm = isrran_csi_rs_cdm_t::isrran_csi_rs_cdm_fd_cdm2;
      break;
    case csi_rs_res_map_s::cdm_type_opts::options::cdm4_fd2_td2:
      zp_csi_rs_resource.resource_mapping.cdm = isrran_csi_rs_cdm_t::isrran_csi_rs_cdm_cdm4_fd2_td2;
      break;
    case csi_rs_res_map_s::cdm_type_opts::options::cdm8_fd2_td4:
      zp_csi_rs_resource.resource_mapping.cdm = isrran_csi_rs_cdm_t::isrran_csi_rs_cdm_cdm8_fd2_td4;
      break;
    default:
  ...
  switch (zp_csi_rs_res.res_map.density.type()) {
    case csi_rs_res_map_s::density_c_::types_opts::options::dot5:
      switch (zp_csi_rs_res.res_map.density.dot5()) {
        case csi_rs_res_map_s::density_c_::dot5_opts::options::even_prbs:
          zp_csi_rs_resource.resource_mapping.density = isrran_csi_rs_resource_mapping_density_dot5_even;
          break;
        case csi_rs_res_map_s::density_c_::dot5_opts::options::odd_prbs:
          zp_csi_rs_resource.resource_mapping.density = isrran_csi_rs_resource_mapping_density_dot5_odd;
          break;
        default:
    ...
    case csi_rs_res_map_s::density_c_::types_opts::options::one:
      zp_csi_rs_resource.resource_mapping.density = isrran_csi_rs_resource_mapping_density_one;
      break;
    case csi_rs_res_map_s::density_c_::types_opts::options::three:
      zp_csi_rs_resource.resource_mapping.density = isrran_csi_rs_resource_mapping_density_three;
      break;
    case csi_rs_res_map_s::density_c_::types_opts::options::spare:
      zp_csi_rs_resource.resource_mapping.density = isrran_csi_rs_resource_mapping_density_spare;
      break;
    default:
  ...
  if (not isrran_csi_rs_resource_mapping_is_valid(&zp_csi_rs_resource.resource_mapping)) {
...
bool make_phy_nzp_csi_rs_resource(const asn1::rrc_nr::nzp_csi_rs_res_s& asn1_nzp_csi_rs_res,
                                  isrran_csi_rs_nzp_resource_t*         out_csi_rs_nzp_resource)
{
  ...
  switch (asn1_nzp_csi_rs_res.res_map.freq_domain_alloc.type()) {
    case csi_rs_res_map_s::freq_domain_alloc_c_::types_opts::options::row1:
      csi_rs_nzp_resource.resource_mapping.row = isrran_csi_rs_resource_mapping_row_1;
      ...
      break;
    case csi_rs_res_map_s::freq_domain_alloc_c_::types_opts::options::row2:
      csi_rs_nzp_resource.resource_mapping.row = isrran_csi_rs_resource_mapping_row_2;
      ...
      break;
    case csi_rs_res_map_s::freq_domain_alloc_c_::types_opts::options::row4:
      csi_rs_nzp_resource.resource_mapping.row = isrran_csi_rs_resource_mapping_row_4;
      ...
      break;
    case csi_rs_res_map_s::freq_domain_alloc_c_::types_opts::options::other:
      csi_rs_nzp_resource.resource_mapping.row = isrran_csi_rs_resource_mapping_row_other;
      break;
    default:
      asn1::log_warning("Invalid option for freq_domain_alloc %s",
  ...
  switch (asn1_nzp_csi_rs_res.res_map.cdm_type) {
    case csi_rs_res_map_s::cdm_type_opts::options::no_cdm:
      csi_rs_nzp_resource.resource_mapping.cdm = isrran_csi_rs_cdm_t::isrran_csi_rs_cdm_nocdm;
      break;
    case csi_rs_res_map_s::cdm_type_opts::options::fd_cdm2:
      csi_rs_nzp_resource.resource_mapping.cdm = isrran_csi_rs_cdm_t::isrran_csi_rs_cdm_fd_cdm2;
      break;
    case csi_rs_res_map_s::cdm_type_opts::options::cdm4_fd2_td2:
      csi_rs_nzp_resource.resource_mapping.cdm = isrran_csi_rs_cdm_t::isrran_csi_rs_cdm_cdm4_fd2_td2;
      break;
    case csi_rs_res_map_s::cdm_type_opts::options::cdm8_fd2_td4:
      csi_rs_nzp_resource.resource_mapping.cdm = isrran_csi_rs_cdm_t::isrran_csi_rs_cdm_cdm8_fd2_td4;
      break;
    default:
  ...
  switch (asn1_nzp_csi_rs_res.res_map.density.type()) {
    case csi_rs_res_map_s::density_c_::types_opts::options::dot5:
      switch (asn1_nzp_csi_rs_res.res_map.density.dot5()) {
        case csi_rs_res_map_s::density_c_::dot5_opts::options::even_prbs:
          csi_rs_nzp_resource.resource_mapping.density = isrran_csi_rs_resource_mapping_density_dot5_even;
          break;
        case csi_rs_res_map_s::density_c_::dot5_opts::options::odd_prbs:
          csi_rs_nzp_resource.resource_mapping.density = isrran_csi_rs_resource_mapping_density_dot5_odd;
          break;
        default:
      ...
      break;
    case csi_rs_res_map_s::density_c_::types_opts::options::one:
      csi_rs_nzp_resource.resource_mapping.density = isrran_csi_rs_resource_mapping_density_one;
      break;
    case csi_rs_res_map_s::density_c_::types_opts::options::three:
      csi_rs_nzp_resource.resource_mapping.density = isrran_csi_rs_resource_mapping_density_three;
      break;
    case csi_rs_res_map_s::density_c_::types_opts::options::spare:
      csi_rs_nzp_resource.resource_mapping.density = isrran_csi_rs_resource_mapping_density_spare;
      break;
    default:
  ...
  // Validate CSI-RS resource mapping
  if (not isrran_csi_rs_resource_mapping_is_valid(&csi_rs_nzp_resource.resource_mapping)) {
    asn1::json_writer json_writer;
...
static inline isrran_subcarrier_spacing_t make_subcarrier_spacing(const subcarrier_spacing_e& asn1_scs)
{
  switch (asn1_scs) {
    case subcarrier_spacing_opts::options::khz15:
      return isrran_subcarrier_spacing_15kHz;
    case subcarrier_spacing_opts::options::khz30:
      return isrran_subcarrier_spacing_30kHz;
    case subcarrier_spacing_opts::options::khz60:
      return isrran_subcarrier_spacing_60kHz;
    case subcarrier_spacing_opts::options::khz120:
      return isrran_subcarrier_spacing_120kHz;
    case subcarrier_spacing_opts::options::khz240:
      return isrran_subcarrier_spacing_240kHz;
  ...
  return isrran_subcarrier_spacing_invalid;
}

bool make_phy_carrier_cfg(const freq_info_dl_s& asn1_freq_info_dl, isrran_carrier_nr_t* out_carrier_nr)
{
...
{
  for (uint32_t i = 0; i < ISRRAN_SSB_NOF_CANDIDATES; i++) {
                          ...
                          isrran_subcarrier_spacing_t* ssb_scs)
{
  ...
  *pattern = bands.get_ssb_pattern(band, isrran_subcarrier_spacing_15kHz);
  if (*pattern == ISRRAN_SSB_PATTERN_A) {
    *ssb_scs = carrier.scs;
  } else {
    // try to optain SSB pattern for same band with 30kHz SCS
    *pattern = bands.get_ssb_pattern(band, isrran_subcarrier_spacing_30kHz);
    if (*pattern == ISRRAN_SSB_PATTERN_B || *pattern == ISRRAN_SSB_PATTERN_C) {
      // SSB SCS is 30 kHz
                      ...
                      isrran_ssb_cfg_t*                                  out_ssb)
{
  *out_ssb = {};
  ...
  out_ssb->duplex_mode = ISRRAN_DUPLEX_MODE_FDD;
  if (serv_cell_cfg.tdd_ul_dl_cfg_common_present) {
    out_ssb->duplex_mode = ISRRAN_DUPLEX_MODE_TDD;
  }
                      ...
                      phy_cfg_nr_t::ssb_cfg_t*                       out_ssb)
{
  ...
  if (serv_cell_cfg.ssb_subcarrier_spacing_present) {
    switch (serv_cell_cfg.ssb_subcarrier_spacing) {
      case subcarrier_spacing_e::khz15:
        ssb.scs = isrran_subcarrier_spacing_15kHz;
        break;
      case subcarrier_spacing_e::khz30:
        ssb.scs = isrran_subcarrier_spacing_30kHz;
        break;
      default:
    ...
    if (ssb.scs == isrran_subcarrier_spacing_invalid) {
  ...
  if (ssb.pattern == ISRRAN_SSB_PATTERN_INVALID) {
    asn1::log_error(
        "Band %d and SS/PBCH block SCS %s results on invalid pattern", band, isrran_subcarrier_spacing_to_str(ssb.scs));
    return false;
  }
...
bool make_phy_mib(const asn1::rrc_nr::mib_s& mib_cfg, isrran_mib_nr_t* mib)
{
  ...
  mib->scs_common =
      mib_cfg.sub_carrier_spacing_common.value == asn1::rrc_nr::mib_s::sub_carrier_spacing_common_opts::scs15or60
          ? isrran_subcarrier_spacing_15kHz
          : isrran_subcarrier_spacing_30kHz;
  mib->ssb_offset             = mib_cfg.ssb_subcarrier_offset;
  mib->dmrs_typeA_pos         = (isrran_dmrs_sch_typeA_pos_t)mib_cfg.dmrs_type_a_position.value;
  ...
  if (serv_cell.csi_meas_cfg_present and serv_cell.csi_meas_cfg.is_setup()) {
    ...
    for (auto& nzp_set : setup.nzp_csi_rs_res_set_to_add_mod_list) {
      ...
      for (uint8_t nzp_rs_idx : nzp_set.nzp_csi_rs_res) {
        ...
        if (not isrran::make_phy_nzp_csi_rs_resource(setup.nzp_csi_rs_res_to_add_mod_list[nzp_rs_idx], &res)) {
          return false;
        }
      }
    }
  ...
  if (serv_cell.init_dl_bwp.pdsch_cfg_present and serv_cell.init_dl_bwp.pdsch_cfg.is_setup()) {
    ...
    if (setup.p_zp_csi_rs_res_set_present) {
      ...
      for (uint8_t zp_res_id : setup_set.zp_csi_rs_res_id_list) {
        ...
        if (not isrran::make_phy_zp_csi_rs_resource(setup_res, &res)) {
          return false;
        }
      }
    }
  ...
  if (serv_cell.csi_meas_cfg_present and serv_cell.csi_meas_cfg.is_setup()) {
    ...
    for (uint32_t i = 0; i < setup.csi_report_cfg_to_add_mod_list.size(); ++i) {
      ...
      if (csi_rep.report_cfg_type.type().value == csi_report_cfg_s::report_cfg_type_c_::types_opts::periodic) {
        ...
        isrran_pucch_nr_resource_t& resource    = csi_hl->reports[i].periodic.resource;
...
{
  duplex_cfg->mode = serv_cell.tdd_ul_dl_cfg_common_present ? ISRRAN_DUPLEX_MODE_TDD : ISRRAN_DUPLEX_MODE_FDD;
...
bool fill_phy_pdcch_cfg_common(const asn1::rrc_nr::pdcch_cfg_common_s& pdcch_cfg, isrran_pdcch_cfg_nr_t* pdcch)
{
  ...
  for (const search_space_s& ss : pdcch_cfg.common_search_space_list) {
    ...
    if (pdcch_cfg.ra_search_space_present and pdcch_cfg.ra_search_space == ss.search_space_id) {
      ...
      pdcch->ra_search_space.type        = isrran_search_space_type_common_1;
      pdcch->ra_search_space.nof_formats = 1;
      pdcch->ra_search_space.formats[0]  = isrran_dci_format_nr_1_0;
    }
  }
  return true;
}
...
void fill_phy_pucch_cfg_common(const asn1::rrc_nr::pucch_cfg_common_s& pucch_cfg, isrran_pucch_nr_common_cfg_t* pucch)
{
  ...
  switch (pucch_cfg.pucch_group_hop) {
    case pucch_cfg_common_s::pucch_group_hop_opts::enable:
      pucch->group_hopping = ISRRAN_PUCCH_NR_GROUP_HOPPING_ENABLE;
      break;
    case pucch_cfg_common_s::pucch_group_hop_opts::disable:
      pucch->group_hopping = ISRRAN_PUCCH_NR_GROUP_HOPPING_DISABLE;
      break;
    default:
      pucch->group_hopping = ISRRAN_PUCCH_NR_GROUP_HOPPING_NEITHER;
      break;
  }
}
...
bool fill_phy_pucch_cfg(const asn1::rrc_nr::pucch_cfg_s& pucch_cfg, isrran_pucch_nr_hl_cfg_t* pucch)
{
  ...
  if (pucch_cfg.res_set_to_add_mod_list.size() > ISRRAN_PUCCH_NR_MAX_NOF_SETS) {
    return false;
  }
  ...
  for (size_t n = 0; n < pucch_cfg.res_set_to_add_mod_list.size(); n++) {
    ...
    for (size_t res_idx = 0; res_idx < res_set.res_list.size(); res_idx++) {
      ...
      if (res_idx >= ISRRAN_PUCCH_NR_MAX_NOF_RESOURCES_PER_SET) {
        return false;
      }
...
bool fill_phy_pucch_hl_cfg(const asn1::rrc_nr::pucch_cfg_s& pucch_cfg, isrran_pucch_nr_hl_cfg_t* pucch)
{
  for (size_t n = 0; n < pucch_cfg.sched_request_res_to_add_mod_list.size(); n++) {
    ...
    isrran_pucch_nr_sr_resource_t* sr_res     = &pucch->sr_resources[asn_sr_res.sched_request_res_id];
...
bool fill_phy_pdsch_cfg_common(const asn1::rrc_nr::pdsch_cfg_common_s& pdsch_cfg, isrran_sch_hl_cfg_nr_t* pdsch)
{
  for (uint32_t i = 0; i < pdsch_cfg.pdsch_time_domain_alloc_list.size(); i++) {
    isrran_sch_time_ra_t common_time_ra;
...
void fill_phy_carrier_cfg(const asn1::rrc_nr::serving_cell_cfg_common_sib_s& serv_cell_cfg,
                          isrran_carrier_nr_t*                               out_carrier_nr)
{
