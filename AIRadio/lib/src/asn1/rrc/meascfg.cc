...
#include "isrran/asn1/rrc/meascfg.h"
#include <sstream>
...
ISRASN_CODE speed_state_scale_factors_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE speed_state_scale_factors_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE pre_regist_info_hrpd_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE pre_regist_info_hrpd_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE carrier_freqs_geran_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE carrier_freqs_geran_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE carrier_freqs_geran_s::following_arfcns_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::explicit_list_of_arfcns:
...
ISRASN_CODE carrier_freqs_geran_s::following_arfcns_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE mtc_ssb_nr_r15_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE mtc_ssb_nr_r15_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE mtc_ssb_nr_r15_s::periodicity_and_offset_r15_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::sf5_r15:
...
ISRASN_CODE mtc_ssb_nr_r15_s::periodicity_and_offset_r15_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE ss_rssi_meas_r15_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE ss_rssi_meas_r15_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE ssb_to_measure_r15_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::short_bitmap_r15:
...
ISRASN_CODE ssb_to_measure_r15_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE thres_list_nr_r15_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE thres_list_nr_r15_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE mob_state_params_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE mob_state_params_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE carrier_freq_cdma2000_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE carrier_freq_cdma2000_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE meas_csi_rs_cfg_r12_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE meas_csi_rs_cfg_r12_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE pci_range_utra_fdd_r9_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE pci_range_utra_fdd_r9_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE alt_ttt_cells_to_add_mod_r12_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE alt_ttt_cells_to_add_mod_r12_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE black_cells_to_add_mod_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE black_cells_to_add_mod_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE cells_to_add_mod_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(pack_integer(bref, cell_idx, (uint8_t)1u, (uint8_t)32u));
...
ISRASN_CODE cells_to_add_mod_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(unpack_integer(cell_idx, bref, (uint8_t)1u, (uint8_t)32u));
...
ISRASN_CODE cells_to_add_mod_cdma2000_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(pack_integer(bref, cell_idx, (uint8_t)1u, (uint8_t)32u));
...
ISRASN_CODE cells_to_add_mod_cdma2000_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(unpack_integer(cell_idx, bref, (uint8_t)1u, (uint8_t)32u));
...
ISRASN_CODE cells_to_add_mod_nr_r15_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE cells_to_add_mod_nr_r15_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE cells_to_add_mod_utra_fdd_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(pack_integer(bref, cell_idx, (uint8_t)1u, (uint8_t)32u));
  HANDLE_CODE(pack_integer(bref, pci, (uint16_t)0u, (uint16_t)511u));
...
ISRASN_CODE cells_to_add_mod_utra_fdd_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(unpack_integer(cell_idx, bref, (uint8_t)1u, (uint8_t)32u));
  HANDLE_CODE(unpack_integer(pci, bref, (uint16_t)0u, (uint16_t)511u));
...
ISRASN_CODE cells_to_add_mod_utra_tdd_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(pack_integer(bref, cell_idx, (uint8_t)1u, (uint8_t)32u));
...
ISRASN_CODE cells_to_add_mod_utra_tdd_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(unpack_integer(cell_idx, bref, (uint8_t)1u, (uint8_t)32u));
...
ISRASN_CODE white_cells_to_add_mod_r13_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE white_cells_to_add_mod_r13_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE bt_name_list_cfg_r15_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE bt_name_list_cfg_r15_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE csg_allowed_report_cells_r9_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE csg_allowed_report_cells_r9_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE meas_ds_cfg_r12_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE meas_ds_cfg_r12_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE meas_ds_cfg_r12_c::setup_s_::dmtc_period_offset_r12_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::ms40_r12:
...
ISRASN_CODE meas_ds_cfg_r12_c::setup_s_::dmtc_period_offset_r12_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE meas_ds_cfg_r12_c::setup_s_::ds_occasion_dur_r12_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::dur_fdd_r12:
...
ISRASN_CODE meas_ds_cfg_r12_c::setup_s_::ds_occasion_dur_r12_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE meas_gap_cfg_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE meas_gap_cfg_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE meas_gap_cfg_c::setup_s_::gap_offset_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::gp0:
...
ISRASN_CODE meas_gap_cfg_c::setup_s_::gap_offset_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE meas_rssi_report_cfg_r13_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE meas_rssi_report_cfg_r13_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE meas_sensing_cfg_r15_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE meas_sensing_cfg_r15_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE meas_sf_pattern_cfg_neigh_r10_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE meas_sf_pattern_cfg_neigh_r10_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE pci_geran_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE pci_geran_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE quant_cfg_rs_nr_r15_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE quant_cfg_rs_nr_r15_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE rmtc_cfg_r13_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE rmtc_cfg_r13_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE rs_cfg_ssb_nr_r15_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE rs_cfg_ssb_nr_r15_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE rs_cfg_ssb_nr_r15_s::ssb_to_measure_r15_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE rs_cfg_ssb_nr_r15_s::ssb_to_measure_r15_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE rsrq_range_cfg_r12_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE rsrq_range_cfg_r12_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE report_quant_nr_r15_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE report_quant_nr_r15_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE report_quant_wlan_r13_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE report_quant_wlan_r13_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE thres_eutra_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::thres_rsrp:
...
ISRASN_CODE thres_eutra_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE thres_nr_r15_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::nr_rsrp_r15:
...
ISRASN_CODE thres_nr_r15_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE thres_utra_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::utra_rscp:
...
ISRASN_CODE thres_utra_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE ul_delay_cfg_r13_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE ul_delay_cfg_r13_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE wlan_carrier_info_r13_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE wlan_carrier_info_r13_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE wlan_name_list_cfg_r15_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE wlan_name_list_cfg_r15_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE meas_gap_cfg_per_cc_r14_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE meas_gap_cfg_per_cc_r14_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE meas_obj_cdma2000_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE meas_obj_cdma2000_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE meas_obj_eutra_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
  HANDLE_CODE(bref.pack(offset_freq_present, 1));
  HANDLE_CODE(bref.pack(cells_to_rem_list_present, 1));
...
ISRASN_CODE meas_obj_eutra_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
  HANDLE_CODE(bref.unpack(offset_freq_present, 1));
  HANDLE_CODE(bref.unpack(cells_to_rem_list_present, 1));
...
ISRASN_CODE meas_obj_eutra_s::t312_r12_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE meas_obj_eutra_s::t312_r12_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE meas_obj_eutra_v9e0_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(pack_integer(bref, carrier_freq_v9e0, (uint32_t)65536u, (uint32_t)262143u));

  return ISRASN_SUCCESS;
}
ISRASN_CODE meas_obj_eutra_v9e0_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE meas_obj_geran_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
  HANDLE_CODE(bref.pack(offset_freq_present, 1));
...
ISRASN_CODE meas_obj_geran_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
  HANDLE_CODE(bref.unpack(offset_freq_present, 1));
...
ISRASN_CODE meas_obj_nr_r15_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE meas_obj_nr_r15_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE meas_obj_nr_r15_s::band_nr_r15_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE meas_obj_nr_r15_s::band_nr_r15_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE meas_obj_utra_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
  HANDLE_CODE(bref.pack(offset_freq_present, 1));
  HANDLE_CODE(bref.pack(cells_to_rem_list_present, 1));
...
ISRASN_CODE meas_obj_utra_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
  HANDLE_CODE(bref.unpack(offset_freq_present, 1));
  HANDLE_CODE(bref.unpack(cells_to_rem_list_present, 1));
...
ISRASN_CODE meas_obj_utra_s::cells_to_add_mod_list_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::cells_to_add_mod_list_utra_fdd:
...
ISRASN_CODE meas_obj_utra_s::cells_to_add_mod_list_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE meas_obj_utra_s::cell_for_which_to_report_cgi_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::utra_fdd:
...
ISRASN_CODE meas_obj_utra_s::cell_for_which_to_report_cgi_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE meas_obj_wlan_r13_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
  HANDLE_CODE(bref.pack(carrier_freq_r13_present, 1));
...
ISRASN_CODE meas_obj_wlan_r13_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
  HANDLE_CODE(bref.unpack(carrier_freq_r13_present, 1));
...
ISRASN_CODE meas_obj_wlan_r13_s::carrier_freq_r13_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::band_ind_list_wlan_r13:
...
ISRASN_CODE meas_obj_wlan_r13_s::carrier_freq_r13_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE quant_cfg_nr_r15_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE quant_cfg_nr_r15_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE eutra_event_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE eutra_event_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE eutra_event_s::event_id_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::event_a1:
...
ISRASN_CODE eutra_event_s::event_id_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE report_cfg_eutra_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE report_cfg_eutra_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE report_cfg_eutra_s::trigger_type_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::event:
...
ISRASN_CODE report_cfg_eutra_s::trigger_type_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE report_cfg_eutra_s::alt_time_to_trigger_r12_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE report_cfg_eutra_s::alt_time_to_trigger_r12_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE report_cfg_eutra_s::rs_sinr_cfg_r13_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE report_cfg_eutra_s::rs_sinr_cfg_r13_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE report_cfg_inter_rat_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
  HANDLE_CODE(trigger_type.pack(bref));
  HANDLE_CODE(pack_integer(bref, max_report_cells, (uint8_t)1u, (uint8_t)8u));
...
ISRASN_CODE report_cfg_inter_rat_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
  HANDLE_CODE(trigger_type.unpack(bref));
  HANDLE_CODE(unpack_integer(max_report_cells, bref, (uint8_t)1u, (uint8_t)8u));
...
ISRASN_CODE report_cfg_inter_rat_s::trigger_type_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::event:
...
ISRASN_CODE report_cfg_inter_rat_s::trigger_type_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE report_cfg_inter_rat_s::trigger_type_c_::event_s_::event_id_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::event_b1:
...
ISRASN_CODE report_cfg_inter_rat_s::trigger_type_c_::event_s_::event_id_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE report_cfg_inter_rat_s::b2_thres1_v1250_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE report_cfg_inter_rat_s::b2_thres1_v1250_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE meas_id_to_add_mod_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE meas_id_to_add_mod_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE meas_id_to_add_mod_v1310_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE meas_id_to_add_mod_v1310_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE meas_id_to_add_mod_ext_r12_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE meas_id_to_add_mod_ext_r12_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE meas_obj_to_add_mod_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(pack_integer(bref, meas_obj_id, (uint8_t)1u, (uint8_t)32u));
...
ISRASN_CODE meas_obj_to_add_mod_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(unpack_integer(meas_obj_id, bref, (uint8_t)1u, (uint8_t)32u));
...
ISRASN_CODE meas_obj_to_add_mod_s::meas_obj_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::meas_obj_eutra:
...
ISRASN_CODE meas_obj_to_add_mod_s::meas_obj_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE meas_obj_to_add_mod_v9e0_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE meas_obj_to_add_mod_v9e0_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE meas_obj_to_add_mod_ext_r13_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE meas_obj_to_add_mod_ext_r13_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE meas_obj_to_add_mod_ext_r13_s::meas_obj_r13_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::meas_obj_eutra_r13:
...
ISRASN_CODE meas_obj_to_add_mod_ext_r13_s::meas_obj_r13_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE quant_cfg_cdma2000_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(meas_quant_cdma2000.pack(bref));

  return ISRASN_SUCCESS;
}
ISRASN_CODE quant_cfg_cdma2000_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE quant_cfg_eutra_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE quant_cfg_eutra_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE quant_cfg_eutra_v1250_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE quant_cfg_eutra_v1250_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE quant_cfg_eutra_v1310_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE quant_cfg_eutra_v1310_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE quant_cfg_geran_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE quant_cfg_geran_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE quant_cfg_utra_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(filt_coef_present, 1));
...
ISRASN_CODE quant_cfg_utra_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(filt_coef_present, 1));
...
ISRASN_CODE quant_cfg_utra_v1020_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE quant_cfg_utra_v1020_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE quant_cfg_wlan_r13_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE quant_cfg_wlan_r13_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE report_cfg_to_add_mod_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(pack_integer(bref, report_cfg_id, (uint8_t)1u, (uint8_t)32u));
...
ISRASN_CODE report_cfg_to_add_mod_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(unpack_integer(report_cfg_id, bref, (uint8_t)1u, (uint8_t)32u));
...
ISRASN_CODE report_cfg_to_add_mod_s::report_cfg_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::report_cfg_eutra:
...
ISRASN_CODE report_cfg_to_add_mod_s::report_cfg_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE meas_gap_cfg_dense_prs_r15_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE meas_gap_cfg_dense_prs_r15_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE meas_gap_cfg_dense_prs_r15_c::setup_s_::gap_offset_dense_prs_r15_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::rstd0_r15:
...
ISRASN_CODE meas_gap_cfg_dense_prs_r15_c::setup_s_::gap_offset_dense_prs_r15_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE meas_gap_cfg_per_cc_list_r14_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE meas_gap_cfg_per_cc_list_r14_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE meas_gap_sharing_cfg_r14_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE meas_gap_sharing_cfg_r14_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE quant_cfg_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE quant_cfg_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE rach_cfg_ded_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE rach_cfg_ded_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE rach_skip_r14_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE rach_skip_r14_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE rach_skip_r14_s::target_ta_r14_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::ta0_r14:
...
ISRASN_CODE rach_skip_r14_s::target_ta_r14_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
// MeasConfig ::= SEQUENCE
ISRASN_CODE meas_cfg_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE meas_cfg_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE meas_cfg_s::speed_state_pars_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE meas_cfg_s::speed_state_pars_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE meas_cfg_s::meas_scale_factor_r12_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE meas_cfg_s::meas_scale_factor_r12_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE meas_cfg_s::height_thresh_ref_r15_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE meas_cfg_s::height_thresh_ref_r15_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE carrier_freq_geran_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE carrier_freq_geran_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE logged_meas_cfg_v1530_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE logged_meas_cfg_v1530_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE cell_global_id_eutra_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE cell_global_id_eutra_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE carrier_bw_eutra_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE carrier_bw_eutra_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE carrier_freq_eutra_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE carrier_freq_eutra_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE carrier_freq_eutra_v9e0_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE carrier_freq_eutra_v9e0_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE mob_ctrl_info_v2x_r14_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE mob_ctrl_info_v2x_r14_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE mob_ctrl_info_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE mob_ctrl_info_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE trace_ref_r10_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE trace_ref_r10_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE cell_global_id_cdma2000_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::cell_global_id1_xrtt:
...
ISRASN_CODE cell_global_id_cdma2000_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE add_si_info_r9_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE add_si_info_r9_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE bler_result_r12_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE bler_result_r12_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE cell_global_id_utra_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(plmn_id.pack(bref));
  HANDLE_CODE(cell_id.pack(bref));
...
ISRASN_CODE cell_global_id_utra_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(plmn_id.unpack(bref));
  HANDLE_CODE(cell_id.unpack(bref));
...
ISRASN_CODE meas_result_cdma2000_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE meas_result_cdma2000_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE cell_global_id_geran_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(plmn_id.pack(bref));
...
ISRASN_CODE cell_global_id_geran_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(plmn_id.unpack(bref));
...
ISRASN_CODE data_bler_mch_result_r12_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE data_bler_mch_result_r12_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE meas_result_eutra_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(cgi_info_present, 1));
...
ISRASN_CODE meas_result_eutra_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(cgi_info_present, 1));
...
ISRASN_CODE meas_result_eutra_s::meas_result_s_::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE meas_result_eutra_s::meas_result_s_::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE meas_result_utra_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(cgi_info_present, 1));
...
ISRASN_CODE meas_result_utra_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(cgi_info_present, 1));
...
ISRASN_CODE meas_result_utra_s::pci_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::fdd:
...
ISRASN_CODE meas_result_utra_s::pci_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE meas_result_utra_s::meas_result_s_::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE meas_result_utra_s::meas_result_s_::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE location_info_r10_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE location_info_r10_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE location_info_r10_s::location_coordinates_r10_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::ellipsoid_point_r10:
...
ISRASN_CODE location_info_r10_s::location_coordinates_r10_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE location_info_r10_s::vertical_velocity_info_r15_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::vertical_velocity_r15:
...
ISRASN_CODE location_info_r10_s::vertical_velocity_info_r15_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE meas_result_geran_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(cgi_info_present, 1));
...
ISRASN_CODE meas_result_geran_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(cgi_info_present, 1));
...
ISRASN_CODE meas_result_nr_r15_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE meas_result_nr_r15_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE meas_results_cdma2000_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE meas_results_cdma2000_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE plmn_id_info_nr_r15_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE plmn_id_info_nr_r15_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE rsrq_type_r12_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE rsrq_type_r12_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE wlan_rtt_r15_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE wlan_rtt_r15_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE log_meas_result_bt_r15_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE log_meas_result_bt_r15_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE log_meas_result_wlan_r15_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE log_meas_result_wlan_r15_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE meas_result2_cdma2000_r9_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE meas_result2_cdma2000_r9_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE meas_result2_eutra_r9_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE meas_result2_eutra_r9_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE meas_result2_eutra_v1250_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE meas_result2_eutra_v1250_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE meas_result2_eutra_v9e0_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE meas_result2_eutra_v9e0_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(carrier_freq_v9e0_present, 1));
...
ISRASN_CODE meas_result2_utra_r9_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE meas_result2_utra_r9_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE meas_result_mbsfn_r12_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE meas_result_mbsfn_r12_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE meas_result_ssb_idx_r15_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE meas_result_ssb_idx_r15_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE cgi_info_nr_r15_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE cgi_info_nr_r15_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE log_meas_info_r10_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE log_meas_info_r10_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE meas_result_cell_nr_r15_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE meas_result_cell_nr_r15_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE log_meas_report_r10_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE log_meas_report_r10_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE meas_result_cbr_r14_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE meas_result_cbr_r14_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE meas_result_csi_rs_r12_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
  HANDLE_CODE(pack_integer(bref, meas_csi_rs_id_r12, (uint8_t)1u, (uint8_t)96u));
...
ISRASN_CODE meas_result_csi_rs_r12_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
  HANDLE_CODE(unpack_integer(meas_csi_rs_id_r12, bref, (uint8_t)1u, (uint8_t)96u));
...
ISRASN_CODE meas_result_cell_sftd_r15_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(rsrp_result_r15_present, 1));
...
ISRASN_CODE meas_result_cell_sftd_r15_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(rsrp_result_r15_present, 1));
...
ISRASN_CODE meas_result_serv_freq_r10_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE meas_result_serv_freq_r10_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE meas_result_serv_freq_r13_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE meas_result_serv_freq_r13_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE meas_result_serv_freq_nr_r15_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE meas_result_serv_freq_nr_r15_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE meas_result_wlan_r13_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE meas_result_wlan_r13_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sensing_result_r15_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(pack_integer(bref, res_idx_r15, (uint16_t)1u, (uint16_t)2000u));

  return ISRASN_SUCCESS;
}
ISRASN_CODE sensing_result_r15_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE ul_pdcp_delay_result_r13_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE ul_pdcp_delay_result_r13_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE meas_result_for_ecid_r9_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE meas_result_for_ecid_r9_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE meas_result_for_rssi_r13_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE meas_result_for_rssi_r13_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE meas_result_sstd_r13_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE meas_result_sstd_r13_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE meas_result_sensing_r15_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE meas_result_sensing_r15_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE meas_results_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE meas_results_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE meas_results_s::meas_result_neigh_cells_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::meas_result_list_eutra:
...
ISRASN_CODE meas_results_s::meas_result_neigh_cells_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE meas_report_v8a0_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE meas_report_v8a0_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE meas_report_r8_ies_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(non_crit_ext_present, 1));
...
ISRASN_CODE meas_report_r8_ies_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(non_crit_ext_present, 1));
...
ISRASN_CODE meas_report_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(crit_exts.pack(bref));

  return ISRASN_SUCCESS;
}
ISRASN_CODE meas_report_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE meas_report_s::crit_exts_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::c1:
...
ISRASN_CODE meas_report_s::crit_exts_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE meas_report_s::crit_exts_c_::c1_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::meas_report_r8:
...
ISRASN_CODE meas_report_s::crit_exts_c_::c1_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE mob_ctrl_info_v10l0_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE mob_ctrl_info_v10l0_s::unpack(cbit_ref& bref)
{
