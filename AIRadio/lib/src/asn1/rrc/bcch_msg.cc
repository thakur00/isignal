...
#include "isrran/asn1/rrc/bcch_msg.h"
#include <sstream>
...
ISRASN_CODE bcch_bch_msg_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE bcch_bch_msg_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE band_class_info_cdma2000_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE band_class_info_cdma2000_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE neigh_cells_per_bandclass_cdma2000_r11_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE neigh_cells_per_bandclass_cdma2000_r11_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE ns_pmax_value_r10_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE ns_pmax_value_r10_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE ns_pmax_value_nr_r15_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE ns_pmax_value_nr_r15_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE neigh_cell_cdma2000_r11_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(band_class.pack(bref));
...
ISRASN_CODE neigh_cell_cdma2000_r11_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(band_class.unpack(bref));
...
ISRASN_CODE neigh_cells_per_bandclass_cdma2000_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(pack_integer(bref, arfcn, (uint16_t)0u, (uint16_t)2047u));
...
ISRASN_CODE neigh_cells_per_bandclass_cdma2000_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(unpack_integer(arfcn, bref, (uint16_t)0u, (uint16_t)2047u));
...
ISRASN_CODE neigh_cells_per_bandclass_cdma2000_v920_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(pack_dyn_seq_of(bref, pci_list_v920, 0, 24, integer_packer<uint16_t>(0, 511)));

  return ISRASN_SUCCESS;
}
ISRASN_CODE neigh_cells_per_bandclass_cdma2000_v920_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE redist_neigh_cell_r13_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE redist_neigh_cell_r13_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE ac_barr_cfg1_xrtt_r9_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE ac_barr_cfg1_xrtt_r9_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE csfb_regist_param1_xrtt_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE csfb_regist_param1_xrtt_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE csfb_regist_param1_xrtt_v920_s::pack(bit_ref& bref) const
{
  return ISRASN_SUCCESS;
}
ISRASN_CODE csfb_regist_param1_xrtt_v920_s::unpack(cbit_ref& bref)
{
  return ISRASN_SUCCESS;
}
...
ISRASN_CODE cell_resel_params_cdma2000_r11_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE cell_resel_params_cdma2000_r11_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE inter_freq_neigh_cell_info_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE inter_freq_neigh_cell_info_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE plmn_id_info2_r12_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::plmn_idx_r12:
...
ISRASN_CODE plmn_id_info2_r12_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE sys_time_info_cdma2000_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sys_time_info_cdma2000_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sys_time_info_cdma2000_s::cdma_sys_time_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::sync_sys_time:
...
ISRASN_CODE sys_time_info_cdma2000_s::cdma_sys_time_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE uac_barr_per_cat_r15_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE uac_barr_per_cat_r15_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE neigh_cell_cdma2000_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(band_class.pack(bref));
...
ISRASN_CODE neigh_cell_cdma2000_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(band_class.unpack(bref));
...
ISRASN_CODE neigh_cell_cdma2000_v920_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(pack_dyn_seq_of(bref, neigh_cells_per_freq_list_v920, 1, 16));

  return ISRASN_SUCCESS;
}
ISRASN_CODE neigh_cell_cdma2000_v920_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE params_cdma2000_r11_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE params_cdma2000_r11_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE params_cdma2000_r11_s::sys_time_info_r11_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::explicit_value:
...
ISRASN_CODE params_cdma2000_r11_s::sys_time_info_r11_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE redist_inter_freq_info_r13_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE redist_inter_freq_info_r13_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sl_disc_cfg_other_inter_freq_r13_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sl_disc_cfg_other_inter_freq_r13_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE carrier_freq_nr_r15_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE carrier_freq_nr_r15_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE carrier_freq_utra_fdd_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
  HANDLE_CODE(bref.pack(cell_resel_prio_present, 1));
...
ISRASN_CODE carrier_freq_utra_fdd_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
  HANDLE_CODE(bref.unpack(cell_resel_prio_present, 1));
...
ISRASN_CODE carrier_freq_utra_fdd_ext_r12_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE carrier_freq_utra_fdd_ext_r12_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE carrier_freq_utra_tdd_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
  HANDLE_CODE(bref.pack(cell_resel_prio_present, 1));
...
ISRASN_CODE carrier_freq_utra_tdd_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
  HANDLE_CODE(bref.unpack(cell_resel_prio_present, 1));
...
ISRASN_CODE carrier_freq_utra_tdd_r12_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
  HANDLE_CODE(bref.pack(cell_resel_prio_r12_present, 1));
  HANDLE_CODE(bref.pack(reduced_meas_performance_r12_present, 1));
...
ISRASN_CODE carrier_freq_utra_tdd_r12_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
  HANDLE_CODE(bref.unpack(cell_resel_prio_r12_present, 1));
  HANDLE_CODE(bref.unpack(reduced_meas_performance_r12_present, 1));
...
ISRASN_CODE carrier_freqs_info_geran_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE carrier_freqs_info_geran_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE eab_cfg_r11_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE eab_cfg_r11_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE inter_freq_carrier_freq_info_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE inter_freq_carrier_freq_info_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE inter_freq_carrier_freq_info_r12_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE inter_freq_carrier_freq_info_r12_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE inter_freq_carrier_freq_info_v10j0_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE inter_freq_carrier_freq_info_v10j0_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE inter_freq_carrier_freq_info_v1250_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(reduced_meas_performance_r12_present, 1));
  HANDLE_CODE(bref.pack(q_qual_min_rsrq_on_all_symbols_r12_present, 1));
...
ISRASN_CODE inter_freq_carrier_freq_info_v1250_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(reduced_meas_performance_r12_present, 1));
  HANDLE_CODE(bref.unpack(q_qual_min_rsrq_on_all_symbols_r12_present, 1));
...
ISRASN_CODE inter_freq_carrier_freq_info_v1310_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE inter_freq_carrier_freq_info_v1310_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE inter_freq_carrier_freq_info_v1350_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE inter_freq_carrier_freq_info_v1350_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE inter_freq_carrier_freq_info_v1360_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE inter_freq_carrier_freq_info_v1360_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE inter_freq_carrier_freq_info_v1530_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE inter_freq_carrier_freq_info_v1530_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE intra_freq_neigh_cell_info_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
  HANDLE_CODE(pack_integer(bref, pci, (uint16_t)0u, (uint16_t)503u));
  HANDLE_CODE(q_offset_cell.pack(bref));
...
ISRASN_CODE intra_freq_neigh_cell_info_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
  HANDLE_CODE(unpack_integer(pci, bref, (uint16_t)0u, (uint16_t)503u));
  HANDLE_CODE(q_offset_cell.unpack(bref));
...
ISRASN_CODE mbms_carrier_type_r14_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE mbms_carrier_type_r14_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE mbms_sai_inter_freq_r11_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE mbms_sai_inter_freq_r11_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE mbms_sai_inter_freq_v1140_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE mbms_sai_inter_freq_v1140_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE mbsfn_area_info_r9_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE mbsfn_area_info_r9_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE resel_info_relay_r13_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE resel_info_relay_r13_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sib8_per_plmn_r11_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sib8_per_plmn_r11_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sib8_per_plmn_r11_s::params_cdma2000_r11_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::explicit_value:
...
ISRASN_CODE sib8_per_plmn_r11_s::params_cdma2000_r11_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE sl_carrier_freq_info_r12_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sl_carrier_freq_info_r12_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sl_carrier_freq_info_v1310_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sl_carrier_freq_info_v1310_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sl_pppp_tx_cfg_idx_r15_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sl_pppp_tx_cfg_idx_r15_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE uac_barr_info_set_r15_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE uac_barr_info_set_r15_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE uac_barr_per_plmn_r15_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE uac_barr_per_plmn_r15_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE uac_barr_per_plmn_r15_s::uac_ac_barr_list_type_r15_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::uac_implicit_ac_barr_list_r15:
...
ISRASN_CODE uac_barr_per_plmn_r15_s::uac_ac_barr_list_type_r15_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE carrier_freq_info_utra_v1250_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(reduced_meas_performance_r12_present, 1));

  return ISRASN_SUCCESS;
}
ISRASN_CODE carrier_freq_info_utra_v1250_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(reduced_meas_performance_r12_present, 1));
...
ISRASN_CODE cell_resel_info_common_v1460_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(s_search_delta_p_r14.pack(bref));

  return ISRASN_SUCCESS;
}
ISRASN_CODE cell_resel_info_common_v1460_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE cell_resel_info_hsdn_r15_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(pack_integer(bref, cell_equivalent_size_r15, (uint8_t)2u, (uint8_t)16u));

  return ISRASN_SUCCESS;
}
ISRASN_CODE cell_resel_info_hsdn_r15_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE cell_resel_params_cdma2000_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(t_resel_cdma2000_sf_present, 1));
...
ISRASN_CODE cell_resel_params_cdma2000_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(t_resel_cdma2000_sf_present, 1));
...
ISRASN_CODE cell_resel_params_cdma2000_v920_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(pack_dyn_seq_of(bref, neigh_cell_list_v920, 1, 16));

  return ISRASN_SUCCESS;
}
ISRASN_CODE cell_resel_params_cdma2000_v920_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE cell_resel_serving_freq_info_v1310_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(cell_resel_sub_prio_r13.pack(bref));

  return ISRASN_SUCCESS;
}
ISRASN_CODE cell_resel_serving_freq_info_v1310_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(cell_resel_sub_prio_r13.unpack(bref));
...
ISRASN_CODE eab_cfg_plmn_r11_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE eab_cfg_plmn_r11_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE mbms_notif_cfg_r9_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE mbms_notif_cfg_r9_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE mbms_notif_cfg_v1430_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(pack_integer(bref, notif_sf_idx_v1430, (uint8_t)7u, (uint8_t)10u));

  return ISRASN_SUCCESS;
}
ISRASN_CODE mbms_notif_cfg_v1430_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE meas_idle_cfg_sib_r15_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE meas_idle_cfg_sib_r15_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE redist_serving_info_r13_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE redist_serving_info_r13_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sc_mcch_sched_info_r14_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sc_mcch_sched_info_r14_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sc_mcch_sched_info_r14_s::sched_period_start_offset_scptm_r14_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::sf10:
...
ISRASN_CODE sc_mcch_sched_info_r14_s::sched_period_start_offset_scptm_r14_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE sl_disc_cfg_relay_ue_r13_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sl_disc_cfg_relay_ue_r13_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sl_disc_cfg_remote_ue_r13_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(thresh_high_r13_present, 1));
  HANDLE_CODE(bref.pack(hyst_max_r13_present, 1));
...
ISRASN_CODE sl_disc_cfg_remote_ue_r13_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(thresh_high_r13_present, 1));
  HANDLE_CODE(bref.unpack(hyst_max_r13_present, 1));
...
ISRASN_CODE sys_info_v8a0_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sys_info_v8a0_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sib_pos_r15_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
  HANDLE_CODE(bref.pack(late_non_crit_ext_present, 1));
...
ISRASN_CODE sib_pos_r15_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
  HANDLE_CODE(bref.unpack(late_non_crit_ext_present, 1));
...
ISRASN_CODE sib_type10_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sib_type10_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sib_type11_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sib_type11_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sib_type12_r9_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sib_type12_r9_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sib_type13_r9_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
  HANDLE_CODE(bref.pack(late_non_crit_ext_present, 1));
...
ISRASN_CODE sib_type13_r9_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
  HANDLE_CODE(bref.unpack(late_non_crit_ext_present, 1));
...
ISRASN_CODE sib_type14_r11_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sib_type14_r11_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sib_type14_r11_s::eab_param_r11_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::eab_common_r11:
...
ISRASN_CODE sib_type14_r11_s::eab_param_r11_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE sib_type15_r11_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sib_type15_r11_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sib_type16_r11_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sib_type16_r11_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sib_type17_r12_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sib_type17_r12_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sib_type18_r12_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sib_type18_r12_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sib_type19_r12_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sib_type19_r12_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sib_type20_r13_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sib_type20_r13_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sib_type20_r13_s::br_bcch_cfg_r14_s_::mpdcch_start_sf_sc_mcch_r14_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::fdd_r14:
...
ISRASN_CODE sib_type20_r13_s::br_bcch_cfg_r14_s_::mpdcch_start_sf_sc_mcch_r14_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE sib_type21_r14_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sib_type21_r14_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sib_type24_r15_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sib_type24_r15_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sib_type25_r15_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sib_type25_r15_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sib_type25_r15_s::uac_ac1_select_assist_info_r15_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::plmn_common_r15:
...
ISRASN_CODE sib_type25_r15_s::uac_ac1_select_assist_info_r15_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE sib_type26_r15_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sib_type26_r15_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sib_type3_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sib_type3_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sib_type4_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sib_type4_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sib_type5_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sib_type5_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sib_type6_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sib_type6_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sib_type7_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sib_type7_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sib_type8_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sib_type8_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sib_type9_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sib_type9_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE pos_sys_info_r15_ies_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(late_non_crit_ext_present, 1));
  HANDLE_CODE(bref.pack(non_crit_ext_present, 1));
...
ISRASN_CODE pos_sys_info_r15_ies_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(late_non_crit_ext_present, 1));
  HANDLE_CODE(bref.unpack(non_crit_ext_present, 1));
...
ISRASN_CODE pos_sys_info_r15_ies_s::pos_sib_type_and_info_r15_item_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::pos_sib1_minus1_r15:
...
ISRASN_CODE pos_sys_info_r15_ies_s::pos_sib_type_and_info_r15_item_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE sib_info_item_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::sib2:
...
ISRASN_CODE sib_info_item_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE sys_info_r8_ies_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(non_crit_ext_present, 1));
...
ISRASN_CODE sys_info_r8_ies_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(non_crit_ext_present, 1));
...
ISRASN_CODE sys_info_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(crit_exts.pack(bref));

  return ISRASN_SUCCESS;
}
ISRASN_CODE sys_info_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sys_info_s::crit_exts_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::sys_info_r8:
...
ISRASN_CODE sys_info_s::crit_exts_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE sys_info_s::crit_exts_c_::crit_exts_future_r15_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::pos_sys_info_r15:
...
ISRASN_CODE sys_info_s::crit_exts_c_::crit_exts_future_r15_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE bcch_dl_sch_msg_type_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::c1:
...
ISRASN_CODE bcch_dl_sch_msg_type_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE bcch_dl_sch_msg_type_c::c1_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::sys_info:
...
ISRASN_CODE bcch_dl_sch_msg_type_c::c1_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE bcch_dl_sch_msg_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(msg.pack(bref));
...
ISRASN_CODE bcch_dl_sch_msg_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(msg.unpack(bref));
...
ISRASN_CODE bcch_dl_sch_msg_type_br_r13_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::c1:
...
ISRASN_CODE bcch_dl_sch_msg_type_br_r13_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE bcch_dl_sch_msg_type_br_r13_c::c1_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::sys_info_br_r13:
...
ISRASN_CODE bcch_dl_sch_msg_type_br_r13_c::c1_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE bcch_dl_sch_msg_br_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(msg.pack(bref));
...
ISRASN_CODE bcch_dl_sch_msg_br_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(msg.unpack(bref));
...
ISRASN_CODE sched_info_mbms_r14_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sched_info_mbms_r14_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE non_mbsfn_sf_cfg_r14_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE non_mbsfn_sf_cfg_r14_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sib_type1_mbms_r14_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sib_type1_mbms_r14_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE carrier_freq_info_utra_fdd_v8h0_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE carrier_freq_info_utra_fdd_v8h0_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE ns_pmax_value_v10l0_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE ns_pmax_value_v10l0_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE inter_freq_carrier_freq_info_v10l0_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE inter_freq_carrier_freq_info_v10l0_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE inter_freq_carrier_freq_info_v8h0_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(multi_band_info_list_present, 1));
...
ISRASN_CODE inter_freq_carrier_freq_info_v8h0_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(multi_band_info_list_present, 1));
...
ISRASN_CODE multi_band_info_v9e0_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE multi_band_info_v9e0_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE inter_freq_carrier_freq_info_v9e0_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE inter_freq_carrier_freq_info_v9e0_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sched_info_v12j0_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sched_info_v12j0_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sched_info_ext_r12_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sched_info_ext_r12_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sib_type1_v12j0_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sib_type1_v12j0_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sib_type1_v10x0_ies_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(late_non_crit_ext_present, 1));
  HANDLE_CODE(bref.pack(non_crit_ext_present, 1));
...
ISRASN_CODE sib_type1_v10x0_ies_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(late_non_crit_ext_present, 1));
  HANDLE_CODE(bref.unpack(non_crit_ext_present, 1));
...
ISRASN_CODE sib_type1_v10l0_ies_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(freq_band_info_v10l0_present, 1));
  HANDLE_CODE(bref.pack(multi_band_info_list_v10l0_present, 1));
  HANDLE_CODE(bref.pack(non_crit_ext_present, 1));
...
ISRASN_CODE sib_type1_v10l0_ies_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(freq_band_info_v10l0_present, 1));
  HANDLE_CODE(bref.unpack(multi_band_info_list_v10l0_present, 1));
  HANDLE_CODE(bref.unpack(non_crit_ext_present, 1));
...
ISRASN_CODE sib_type1_v10j0_ies_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(freq_band_info_r10_present, 1));
  HANDLE_CODE(bref.pack(multi_band_info_list_v10j0_present, 1));
  HANDLE_CODE(bref.pack(non_crit_ext_present, 1));
...
ISRASN_CODE sib_type1_v10j0_ies_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(freq_band_info_r10_present, 1));
  HANDLE_CODE(bref.unpack(multi_band_info_list_v10j0_present, 1));
  HANDLE_CODE(bref.unpack(non_crit_ext_present, 1));
...
ISRASN_CODE sib_type1_v9e0_ies_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(freq_band_ind_v9e0_present, 1));
  HANDLE_CODE(bref.pack(multi_band_info_list_v9e0_present, 1));
  HANDLE_CODE(bref.pack(non_crit_ext_present, 1));
...
ISRASN_CODE sib_type1_v9e0_ies_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(freq_band_ind_v9e0_present, 1));
  HANDLE_CODE(bref.unpack(multi_band_info_list_v9e0_present, 1));
  HANDLE_CODE(bref.unpack(non_crit_ext_present, 1));
...
ISRASN_CODE sib_type1_v8h0_ies_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(multi_band_info_list_present, 1));
  HANDLE_CODE(bref.pack(non_crit_ext_present, 1));
...
ISRASN_CODE sib_type1_v8h0_ies_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(multi_band_info_list_present, 1));
  HANDLE_CODE(bref.unpack(non_crit_ext_present, 1));
...
ISRASN_CODE sib_type2_v13c0_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sib_type2_v13c0_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sib_type2_v10n0_ies_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(late_non_crit_ext_present, 1));
  HANDLE_CODE(bref.pack(non_crit_ext_present, 1));
...
ISRASN_CODE sib_type2_v10n0_ies_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(late_non_crit_ext_present, 1));
  HANDLE_CODE(bref.unpack(non_crit_ext_present, 1));
...
ISRASN_CODE sib_type2_v10m0_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sib_type2_v10m0_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sib_type2_v9i0_ies_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(non_crit_ext_present, 1));
  HANDLE_CODE(bref.pack(dummy_present, 1));
...
ISRASN_CODE sib_type2_v9i0_ies_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(non_crit_ext_present, 1));
  HANDLE_CODE(bref.unpack(dummy_present, 1));
...
ISRASN_CODE sib_type2_v9e0_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sib_type2_v9e0_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sib_type2_v8h0_ies_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(multi_band_info_list_present, 1));
  HANDLE_CODE(bref.pack(non_crit_ext_present, 1));
...
ISRASN_CODE sib_type2_v8h0_ies_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(multi_band_info_list_present, 1));
  HANDLE_CODE(bref.unpack(non_crit_ext_present, 1));
...
ISRASN_CODE sib_type3_v10l0_ies_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(freq_band_info_v10l0_present, 1));
  HANDLE_CODE(bref.pack(multi_band_info_list_v10l0_present, 1));
  HANDLE_CODE(bref.pack(non_crit_ext_present, 1));
...
ISRASN_CODE sib_type3_v10l0_ies_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(freq_band_info_v10l0_present, 1));
  HANDLE_CODE(bref.unpack(multi_band_info_list_v10l0_present, 1));
  HANDLE_CODE(bref.unpack(non_crit_ext_present, 1));
...
ISRASN_CODE sib_type3_v10j0_ies_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(freq_band_info_r10_present, 1));
  HANDLE_CODE(bref.pack(multi_band_info_list_v10j0_present, 1));
  HANDLE_CODE(bref.pack(non_crit_ext_present, 1));
...
ISRASN_CODE sib_type3_v10j0_ies_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(freq_band_info_r10_present, 1));
  HANDLE_CODE(bref.unpack(multi_band_info_list_v10j0_present, 1));
  HANDLE_CODE(bref.unpack(non_crit_ext_present, 1));
...
ISRASN_CODE sib_type5_v13a0_ies_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(late_non_crit_ext_present, 1));
...
ISRASN_CODE sib_type5_v13a0_ies_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(late_non_crit_ext_present, 1));
...
ISRASN_CODE sib_type5_v10l0_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sib_type5_v10l0_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sib_type5_v10j0_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sib_type5_v10j0_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sib_type5_v9e0_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sib_type5_v9e0_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sib_type5_v8h0_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sib_type5_v8h0_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sib_type6_v8h0_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sib_type6_v8h0_ies_s::unpack(cbit_ref& bref)
{
