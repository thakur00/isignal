...
#include "isrran/asn1/rrc/rr_ded.h"
#include <sstream>
...
ISRASN_CODE dl_am_rlc_r15_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE dl_am_rlc_r15_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE dl_um_rlc_r15_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE dl_um_rlc_r15_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE ul_am_rlc_r15_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE ul_am_rlc_r15_s::unpack(cbit_ref& bref)
{
...
// UL-UM-RLC ::= SEQUENCE
ISRASN_CODE ul_um_rlc_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(sn_field_len.pack(bref));

  return ISRASN_SUCCESS;
}
ISRASN_CODE ul_um_rlc_s::unpack(cbit_ref& bref)
{
...
// DL-AM-RLC ::= SEQUENCE
ISRASN_CODE dl_am_rlc_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE dl_am_rlc_s::unpack(cbit_ref& bref)
{
...
// DL-UM-RLC ::= SEQUENCE
ISRASN_CODE dl_um_rlc_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(sn_field_len.pack(bref));
  HANDLE_CODE(t_reordering.pack(bref));
...
ISRASN_CODE dl_um_rlc_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(sn_field_len.unpack(bref));
  HANDLE_CODE(t_reordering.unpack(bref));
...
ISRASN_CODE lc_ch_cfg_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE lc_ch_cfg_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE lc_ch_cfg_s::allowed_tti_lens_r15_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE lc_ch_cfg_s::allowed_tti_lens_r15_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE lc_ch_cfg_s::lc_ch_sr_restrict_r15_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE lc_ch_cfg_s::lc_ch_sr_restrict_r15_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE lc_ch_cfg_s::ch_access_prio_r15_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE lc_ch_cfg_s::ch_access_prio_r15_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE rlc_cfg_r15_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE rlc_cfg_r15_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE rlc_cfg_r15_s::mode_r15_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::am_r15:
...
ISRASN_CODE rlc_cfg_r15_s::mode_r15_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
// UL-AM-RLC ::= SEQUENCE
ISRASN_CODE ul_am_rlc_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE ul_am_rlc_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE crs_assist_info_r11_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE crs_assist_info_r11_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE crs_assist_info_r13_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE crs_assist_info_r13_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE crs_assist_info_r15_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE crs_assist_info_r15_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE neigh_cells_info_r12_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE neigh_cells_info_r12_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE pdcp_cfg_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE pdcp_cfg_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE pdcp_cfg_s::hdr_compress_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::not_used:
...
ISRASN_CODE pdcp_cfg_s::hdr_compress_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE pdcp_cfg_s::ul_data_split_thres_r13_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE pdcp_cfg_s::ul_data_split_thres_r13_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE pdcp_cfg_s::status_feedback_r13_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE pdcp_cfg_s::status_feedback_r13_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE pdcp_cfg_s::ul_lwa_cfg_r14_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE pdcp_cfg_s::ul_lwa_cfg_r14_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE pdcp_cfg_s::ul_only_hdr_compress_r14_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::not_used_r14:
...
ISRASN_CODE pdcp_cfg_s::ul_only_hdr_compress_r14_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE pdcp_cfg_s::pdcp_dupl_cfg_r15_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE pdcp_cfg_s::pdcp_dupl_cfg_r15_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE rlc_bearer_cfg_r15_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE rlc_bearer_cfg_r15_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE rlc_bearer_cfg_r15_c::setup_s_::lc_ch_id_cfg_r15_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::lc_ch_id_r15:
...
ISRASN_CODE rlc_bearer_cfg_r15_c::setup_s_::lc_ch_id_cfg_r15_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE rlc_cfg_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::am:
...
ISRASN_CODE rlc_cfg_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE rlc_cfg_v1250_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE rlc_cfg_v1250_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE rlc_cfg_v1310_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE rlc_cfg_v1310_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE rlc_cfg_v1430_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE rlc_cfg_v1430_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE rlc_cfg_v1510_s::pack(bit_ref& bref) const
{
  return ISRASN_SUCCESS;
}
ISRASN_CODE rlc_cfg_v1510_s::unpack(cbit_ref& bref)
{
  return ISRASN_SUCCESS;
}
...
ISRASN_CODE rlc_cfg_v1530_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  return ISRASN_SUCCESS;
}
ISRASN_CODE rlc_cfg_v1530_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE sps_cfg_sl_r14_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sps_cfg_sl_r14_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sps_cfg_ul_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE sps_cfg_ul_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE sps_cfg_ul_c::setup_s_::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sps_cfg_ul_c::setup_s_::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sps_cfg_ul_c::setup_s_::p0_persistent_sf_set2_r12_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE sps_cfg_ul_c::setup_s_::p0_persistent_sf_set2_r12_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE sps_cfg_ul_stti_r15_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE sps_cfg_ul_stti_r15_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE sps_cfg_ul_stti_r15_c::setup_s_::p0_persistent_sf_set2_r15_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE sps_cfg_ul_stti_r15_c::setup_s_::p0_persistent_sf_set2_r15_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE stag_to_add_mod_r11_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE stag_to_add_mod_r11_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE drb_to_add_mod_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE drb_to_add_mod_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE drx_cfg_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE drx_cfg_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE drx_cfg_c::setup_s_::long_drx_cycle_start_offset_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::sf10:
...
ISRASN_CODE drx_cfg_c::setup_s_::long_drx_cycle_start_offset_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE drx_cfg_r13_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE drx_cfg_r13_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE drx_cfg_r15_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE drx_cfg_r15_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE drx_cfg_v1130_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE drx_cfg_v1130_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE drx_cfg_v1130_s::long_drx_cycle_start_offset_v1130_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::sf60_v1130:
...
ISRASN_CODE drx_cfg_v1130_s::long_drx_cycle_start_offset_v1130_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE drx_cfg_v1310_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE drx_cfg_v1310_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sps_cfg_dl_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE sps_cfg_dl_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE sps_cfg_dl_c::setup_s_::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sps_cfg_dl_c::setup_s_::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sps_cfg_dl_c::setup_s_::two_ant_port_activ_r10_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE sps_cfg_dl_c::setup_s_::two_ant_port_activ_r10_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE sps_cfg_dl_stti_r15_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE sps_cfg_dl_stti_r15_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE sps_cfg_dl_stti_r15_c::setup_s_::two_ant_port_activ_r15_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE sps_cfg_dl_stti_r15_c::setup_s_::two_ant_port_activ_r15_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE srb_to_add_mod_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
  HANDLE_CODE(bref.pack(rlc_cfg_present, 1));
  HANDLE_CODE(bref.pack(lc_ch_cfg_present, 1));
...
ISRASN_CODE srb_to_add_mod_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
  HANDLE_CODE(bref.unpack(rlc_cfg_present, 1));
  HANDLE_CODE(bref.unpack(lc_ch_cfg_present, 1));
...
ISRASN_CODE srb_to_add_mod_s::rlc_cfg_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::explicit_value:
...
ISRASN_CODE srb_to_add_mod_s::rlc_cfg_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE srb_to_add_mod_s::lc_ch_cfg_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::explicit_value:
...
ISRASN_CODE srb_to_add_mod_s::lc_ch_cfg_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE mac_main_cfg_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE mac_main_cfg_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE mac_main_cfg_s::phr_cfg_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE mac_main_cfg_s::phr_cfg_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE mac_main_cfg_s::dual_connect_phr_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE mac_main_cfg_s::dual_connect_phr_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE mac_main_cfg_s::lc_ch_sr_cfg_r12_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE mac_main_cfg_s::lc_ch_sr_cfg_r12_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE mac_main_cfg_s::edrx_cfg_cycle_start_offset_r13_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE mac_main_cfg_s::edrx_cfg_cycle_start_offset_r13_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE mac_main_cfg_s::edrx_cfg_cycle_start_offset_r13_c_::setup_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::sf5120:
...
ISRASN_CODE mac_main_cfg_s::edrx_cfg_cycle_start_offset_r13_c_::setup_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE mac_main_cfg_s::drx_cfg_r13_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE mac_main_cfg_s::drx_cfg_r13_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE mac_main_cfg_s::skip_ul_tx_r14_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE mac_main_cfg_s::skip_ul_tx_r14_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE mac_main_cfg_s::data_inactivity_timer_cfg_r14_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE mac_main_cfg_s::data_inactivity_timer_cfg_r14_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE mac_main_cfg_s::short_tti_and_spt_r15_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE mac_main_cfg_s::short_tti_and_spt_r15_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE mac_main_cfg_s::dormant_state_timers_r15_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE mac_main_cfg_s::dormant_state_timers_r15_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE meas_sf_pattern_pcell_r10_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE meas_sf_pattern_pcell_r10_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE naics_assist_info_r12_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE naics_assist_info_r12_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE neigh_cells_crs_info_r11_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE neigh_cells_crs_info_r11_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE neigh_cells_crs_info_r13_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE neigh_cells_crs_info_r13_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE neigh_cells_crs_info_r15_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE neigh_cells_crs_info_r15_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE rlf_timers_and_consts_r13_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE rlf_timers_and_consts_r13_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE rlf_timers_and_consts_r13_c::setup_s_::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE rlf_timers_and_consts_r13_c::setup_s_::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE rlf_timers_and_consts_r9_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE rlf_timers_and_consts_r9_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
// SPS-Config ::= SEQUENCE
ISRASN_CODE sps_cfg_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sps_cfg_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sps_cfg_v1430_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sps_cfg_v1430_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sps_cfg_v1530_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sps_cfg_v1530_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sps_cfg_v1540_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sps_cfg_v1540_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE rr_cfg_ded_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE rr_cfg_ded_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE rr_cfg_ded_s::mac_main_cfg_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::explicit_value:
...
ISRASN_CODE rr_cfg_ded_s::mac_main_cfg_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE rr_cfg_ded_s::crs_intf_mitig_cfg_r15_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE rr_cfg_ded_s::crs_intf_mitig_cfg_r15_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE rr_cfg_ded_s::crs_intf_mitig_cfg_r15_c_::setup_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::crs_intf_mitig_enabled:
...
ISRASN_CODE rr_cfg_ded_s::crs_intf_mitig_cfg_r15_c_::setup_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE pdcch_candidate_reductions_laa_ul_r14_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE pdcch_candidate_reductions_laa_ul_r14_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE aul_cfg_r15_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE aul_cfg_r15_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE cqi_report_periodic_scell_r15_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE cqi_report_periodic_scell_r15_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE cqi_report_periodic_scell_r15_c::setup_s_::csi_sf_pattern_dormant_r15_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE cqi_report_periodic_scell_r15_c::setup_s_::csi_sf_pattern_dormant_r15_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE cqi_report_periodic_scell_r15_c::setup_s_::cqi_format_ind_dormant_r15_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::wideband_cqi_r15:
...
ISRASN_CODE cqi_report_periodic_scell_r15_c::setup_s_::cqi_format_ind_dormant_r15_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE cross_carrier_sched_cfg_laa_ul_r14_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE cross_carrier_sched_cfg_laa_ul_r14_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE lbt_cfg_r14_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::max_energy_detection_thres_r14:
...
ISRASN_CODE lbt_cfg_r14_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE pdcch_cfg_laa_r14_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE pdcch_cfg_laa_r14_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE pusch_mode_cfg_laa_r15_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE pusch_mode_cfg_laa_r15_s::unpack(cbit_ref& bref)
{
...
void isr_ul_cfg_ded_aperiodic_v1430_c::set(types::options e)
{
  type_ = e;
}
void isr_ul_cfg_ded_aperiodic_v1430_c::set_release()
{
  set(types::release);
}
isr_ul_cfg_ded_aperiodic_v1430_c::setup_s_& isr_ul_cfg_ded_aperiodic_v1430_c::set_setup()
{
  set(types::setup);
  return c;
}
void isr_ul_cfg_ded_aperiodic_v1430_c::to_json(json_writer& j) const
{
  j.start_obj();
  switch (type_) {
    case types::release:
    ...
    case types::setup:
      j.write_fieldname("setup");
      j.start_obj();
      if (c.isr_sf_ind_r14_present) {
        j.write_int("isr-SubframeIndication-r14", c.isr_sf_ind_r14);
      }
      j.end_obj();
      break;
    default:
      log_invalid_choice_id(type_, "isr_ul_cfg_ded_aperiodic_v1430_c");
  }
  j.end_obj();
}
ISRASN_CODE isr_ul_cfg_ded_aperiodic_v1430_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
      break;
    case types::setup:
      HANDLE_CODE(bref.pack(c.isr_sf_ind_r14_present, 1));
      if (c.isr_sf_ind_r14_present) {
        HANDLE_CODE(pack_integer(bref, c.isr_sf_ind_r14, (uint8_t)1u, (uint8_t)4u));
      }
      break;
    default:
      log_invalid_choice_id(type_, "isr_ul_cfg_ded_aperiodic_v1430_c");
...
ISRASN_CODE isr_ul_cfg_ded_aperiodic_v1430_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
  switch (type_) {
    case types::release:
      break;
    case types::setup:
      HANDLE_CODE(bref.unpack(c.isr_sf_ind_r14_present, 1));
      if (c.isr_sf_ind_r14_present) {
        HANDLE_CODE(unpack_integer(c.isr_sf_ind_r14, bref, (uint8_t)1u, (uint8_t)4u));
      }
      break;
    default:
      log_invalid_choice_id(type_, "isr_ul_cfg_ded_aperiodic_v1430_c");
...
bool isr_ul_cfg_ded_aperiodic_v1430_c::operator==(const isr_ul_cfg_ded_aperiodic_v1430_c& other) const
{
  return type() == other.type() and c.isr_sf_ind_r14_present == other.c.isr_sf_ind_r14_present and
         (not c.isr_sf_ind_r14_present or c.isr_sf_ind_r14 == other.c.isr_sf_ind_r14);
}

// CQI-ReportConfigSCell-r10 ::= SEQUENCE
ISRASN_CODE cqi_report_cfg_scell_r10_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE cqi_report_cfg_scell_r10_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE cqi_report_cfg_scell_r15_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE cqi_report_cfg_scell_r15_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE cqi_short_cfg_scell_r15_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE cqi_short_cfg_scell_r15_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE cqi_short_cfg_scell_r15_c::setup_s_::cqi_format_ind_short_r15_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::wideband_cqi_short_r15:
...
ISRASN_CODE cqi_short_cfg_scell_r15_c::setup_s_::cqi_format_ind_short_r15_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE cross_carrier_sched_cfg_r10_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(sched_cell_info_r10.pack(bref));

  return ISRASN_SUCCESS;
}
ISRASN_CODE cross_carrier_sched_cfg_r10_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE cross_carrier_sched_cfg_r10_s::sched_cell_info_r10_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::own_r10:
...
ISRASN_CODE cross_carrier_sched_cfg_r10_s::sched_cell_info_r10_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE cross_carrier_sched_cfg_r13_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(sched_cell_info_r13.pack(bref));

  return ISRASN_SUCCESS;
}
ISRASN_CODE cross_carrier_sched_cfg_r13_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE cross_carrier_sched_cfg_r13_s::sched_cell_info_r13_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::own_r13:
...
ISRASN_CODE cross_carrier_sched_cfg_r13_s::sched_cell_info_r13_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE laa_scell_cfg_r13_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE laa_scell_cfg_r13_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE laa_scell_cfg_v1430_s::pack(bit_ref& bref) const
{
  ...
  HANDLE_CODE(bref.pack(isr_ul_cfg_ded_aperiodic_v1430_present, 1));
  ...
  if (isr_ul_cfg_ded_aperiodic_v1430_present) {
    HANDLE_CODE(isr_ul_cfg_ded_aperiodic_v1430.pack(bref));
  }

  return ISRASN_SUCCESS;
}
ISRASN_CODE laa_scell_cfg_v1430_s::unpack(cbit_ref& bref)
{
  ...
  HANDLE_CODE(bref.unpack(isr_ul_cfg_ded_aperiodic_v1430_present, 1));
  ...
  if (isr_ul_cfg_ded_aperiodic_v1430_present) {
    HANDLE_CODE(isr_ul_cfg_ded_aperiodic_v1430.unpack(bref));
  }
...
void laa_scell_cfg_v1430_s::to_json(json_writer& j) const
{
  ...
  if (isr_ul_cfg_ded_aperiodic_v1430_present) {
    ...
    isr_ul_cfg_ded_aperiodic_v1430.to_json(j);
  }
  j.end_obj();
}
bool laa_scell_cfg_v1430_s::operator==(const laa_scell_cfg_v1430_s& other) const
{
  return cross_carrier_sched_cfg_ul_r14_present == other.cross_carrier_sched_cfg_ul_r14_present and
         ...
         isr_ul_cfg_ded_aperiodic_v1430_present == other.isr_ul_cfg_ded_aperiodic_v1430_present and
         (not isr_ul_cfg_ded_aperiodic_v1430_present or
          isr_ul_cfg_ded_aperiodic_v1430 == other.isr_ul_cfg_ded_aperiodic_v1430);
}
...
ISRASN_CODE laa_scell_cfg_v1430_s::cross_carrier_sched_cfg_ul_r14_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE laa_scell_cfg_v1430_s::cross_carrier_sched_cfg_ul_r14_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE laa_scell_cfg_v1530_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE laa_scell_cfg_v1530_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE pdcch_cfg_scell_r13_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(skip_monitoring_dci_format0_minus1_a_r13_present, 1));

  return ISRASN_SUCCESS;
}
ISRASN_CODE pdcch_cfg_scell_r13_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE pdsch_cfg_ded_scell_v1430_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(tbs_idx_alt2_r14_present, 1));

  return ISRASN_SUCCESS;
}
ISRASN_CODE pdsch_cfg_ded_scell_v1430_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE pucch_cfg_ded_v1370_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(pucch_format_v1370.pack(bref));

  return ISRASN_SUCCESS;
}
ISRASN_CODE pucch_cfg_ded_v1370_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE pucch_cfg_ded_v1370_s::pucch_format_v1370_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE pucch_cfg_ded_v1370_s::pucch_format_v1370_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE pusch_cfg_ded_scell_r10_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE pusch_cfg_ded_scell_r10_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE pusch_cfg_ded_scell_v1430_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE pusch_cfg_ded_scell_v1430_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE pusch_cfg_ded_scell_v1530_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(uci_on_pusch_r15.pack(bref));

  return ISRASN_SUCCESS;
}
ISRASN_CODE pusch_cfg_ded_scell_v1530_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE pusch_cfg_ded_scell_v1530_s::uci_on_pusch_r15_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE pusch_cfg_ded_scell_v1530_s::uci_on_pusch_r15_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE sched_request_cfg_scell_r13_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE sched_request_cfg_scell_r13_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE isr_aperiodic_set_r14_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(isr_cc_set_idx_list_r14_present, 1));

  if (isr_cc_set_idx_list_r14_present) {
    HANDLE_CODE(pack_dyn_seq_of(bref, isr_cc_set_idx_list_r14, 1, 4));
  }
  HANDLE_CODE(isr_ul_cfg_ded_aperiodic_r14.pack(bref));

  return ISRASN_SUCCESS;
}
ISRASN_CODE isr_aperiodic_set_r14_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(isr_cc_set_idx_list_r14_present, 1));

  if (isr_cc_set_idx_list_r14_present) {
    HANDLE_CODE(unpack_dyn_seq_of(isr_cc_set_idx_list_r14, bref, 1, 4));
  }
  HANDLE_CODE(isr_ul_cfg_ded_aperiodic_r14.unpack(bref));

  return ISRASN_SUCCESS;
}
void isr_aperiodic_set_r14_s::to_json(json_writer& j) const
{
  j.start_obj();
  if (isr_cc_set_idx_list_r14_present) {
    j.start_array("isr-CC-SetIndexList-r14");
    for (const auto& e1 : isr_cc_set_idx_list_r14) {
      e1.to_json(j);
    }
    j.end_array();
  }
  j.write_fieldname("soundingRS-UL-ConfigDedicatedAperiodic-r14");
  isr_ul_cfg_ded_aperiodic_r14.to_json(j);
  j.end_obj();
}
bool isr_aperiodic_set_r14_s::operator==(const isr_aperiodic_set_r14_s& other) const
{
  return isr_cc_set_idx_list_r14_present == other.isr_cc_set_idx_list_r14_present and
         (not isr_cc_set_idx_list_r14_present or isr_cc_set_idx_list_r14 == other.isr_cc_set_idx_list_r14) and
         isr_ul_cfg_ded_aperiodic_r14 == other.isr_ul_cfg_ded_aperiodic_r14;
}

// SoundingRS-AperiodicSetUpPTsExt-r14 ::= SEQUENCE
ISRASN_CODE isr_aperiodic_set_up_pts_ext_r14_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(isr_cc_set_idx_list_r14_present, 1));
  ...
  HANDLE_CODE(isr_ul_cfg_ded_aperiodic_up_pts_ext_r14.pack(bref));

  return ISRASN_SUCCESS;
}
ISRASN_CODE isr_aperiodic_set_up_pts_ext_r14_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(isr_cc_set_idx_list_r14_present, 1));
  ...
  HANDLE_CODE(isr_ul_cfg_ded_aperiodic_up_pts_ext_r14.unpack(bref));

  return ISRASN_SUCCESS;
}
void isr_aperiodic_set_up_pts_ext_r14_s::to_json(json_writer& j) const
{
  j.start_obj();
  if (isr_cc_set_idx_list_r14_present) {
    j.start_array("isr-CC-SetIndexList-r14");
  ...
  isr_ul_cfg_ded_aperiodic_up_pts_ext_r14.to_json(j);
  j.end_obj();
}
bool isr_aperiodic_set_up_pts_ext_r14_s::operator==(const isr_aperiodic_set_up_pts_ext_r14_s& other) const
{
  return isr_cc_set_idx_list_r14_present == other.isr_cc_set_idx_list_r14_present and
         (not isr_cc_set_idx_list_r14_present or isr_cc_set_idx_list_r14 == other.isr_cc_set_idx_list_r14) and
         isr_ul_cfg_ded_aperiodic_up_pts_ext_r14 == other.isr_ul_cfg_ded_aperiodic_up_pts_ext_r14;
}
...
ISRASN_CODE tpc_pdcch_cfg_scell_r13_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE tpc_pdcch_cfg_scell_r13_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE ul_pusch_less_pwr_ctrl_ded_v1430_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(p0_ue_periodic_isr_r14_present, 1));
  HANDLE_CODE(bref.pack(p0_ue_aperiodic_isr_r14_present, 1));

  if (p0_ue_periodic_isr_r14_present) {
    HANDLE_CODE(pack_integer(bref, p0_ue_periodic_isr_r14, (int8_t)-8, (int8_t)7));
  }
  if (p0_ue_aperiodic_isr_r14_present) {
    HANDLE_CODE(pack_integer(bref, p0_ue_aperiodic_isr_r14, (int8_t)-8, (int8_t)7));
  }
  HANDLE_CODE(bref.pack(accumulation_enabled_r14, 1));

  return ISRASN_SUCCESS;
}
ISRASN_CODE ul_pusch_less_pwr_ctrl_ded_v1430_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(p0_ue_periodic_isr_r14_present, 1));
  HANDLE_CODE(bref.unpack(p0_ue_aperiodic_isr_r14_present, 1));

  if (p0_ue_periodic_isr_r14_present) {
    HANDLE_CODE(unpack_integer(p0_ue_periodic_isr_r14, bref, (int8_t)-8, (int8_t)7));
  }
  if (p0_ue_aperiodic_isr_r14_present) {
    HANDLE_CODE(unpack_integer(p0_ue_aperiodic_isr_r14, bref, (int8_t)-8, (int8_t)7));
  }
...
void ul_pusch_less_pwr_ctrl_ded_v1430_s::to_json(json_writer& j) const
{
  j.start_obj();
  if (p0_ue_periodic_isr_r14_present) {
    j.write_int("p0-UE-PeriodicISR-r14", p0_ue_periodic_isr_r14);
  }
  if (p0_ue_aperiodic_isr_r14_present) {
    j.write_int("p0-UE-AperiodicISR-r14", p0_ue_aperiodic_isr_r14);
  }
...
{
  return p0_ue_periodic_isr_r14_present == other.p0_ue_periodic_isr_r14_present and
         (not p0_ue_periodic_isr_r14_present or p0_ue_periodic_isr_r14 == other.p0_ue_periodic_isr_r14) and
         p0_ue_aperiodic_isr_r14_present == other.p0_ue_aperiodic_isr_r14_present and
         (not p0_ue_aperiodic_isr_r14_present or p0_ue_aperiodic_isr_r14 == other.p0_ue_aperiodic_isr_r14) and
         accumulation_enabled_r14 == other.accumulation_enabled_r14;
}

// UplinkPowerControlDedicatedSCell-r10 ::= SEQUENCE
ISRASN_CODE ul_pwr_ctrl_ded_scell_r10_s::pack(bit_ref& bref) const
{
  ...
  HANDLE_CODE(pack_integer(bref, pisr_offset_r10, (uint8_t)0u, (uint8_t)15u));
...
ISRASN_CODE ul_pwr_ctrl_ded_scell_r10_s::unpack(cbit_ref& bref)
{
  ...
  HANDLE_CODE(unpack_integer(pisr_offset_r10, bref, (uint8_t)0u, (uint8_t)15u));
  if (pisr_offset_ap_r10_present) {
...
void ul_pwr_ctrl_ded_scell_r10_s::to_json(json_writer& j) const
{
  ...
  j.write_int("pISR-Offset-r10", pisr_offset_r10);
  if (pisr_offset_ap_r10_present) {
...
bool ul_pwr_ctrl_ded_scell_r10_s::operator==(const ul_pwr_ctrl_ded_scell_r10_s& other) const
{
  return p0_ue_pusch_r10 == other.p0_ue_pusch_r10 and delta_mcs_enabled_r10 == other.delta_mcs_enabled_r10 and
         accumulation_enabled_r10 == other.accumulation_enabled_r10 and pisr_offset_r10 == other.pisr_offset_r10 and
         pisr_offset_ap_r10_present == other.pisr_offset_ap_r10_present and
         (not pisr_offset_ap_r10_present or pisr_offset_ap_r10 == other.pisr_offset_ap_r10) and
...
ISRASN_CODE ul_pwr_ctrl_ded_scell_v1310_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE ul_pwr_ctrl_ded_scell_v1310_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE mac_main_cfg_scell_r11_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE mac_main_cfg_scell_r11_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE phys_cfg_ded_scell_r10_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
  ...
  if (ul_cfg_r10_present) {
    ...
    HANDLE_CODE(bref.pack(ul_cfg_r10.isr_ul_cfg_ded_r10_present, 1));
    HANDLE_CODE(bref.pack(ul_cfg_r10.isr_ul_cfg_ded_v1020_present, 1));
    HANDLE_CODE(bref.pack(ul_cfg_r10.isr_ul_cfg_ded_aperiodic_r10_present, 1));
    ...
    if (ul_cfg_r10.isr_ul_cfg_ded_r10_present) {
      HANDLE_CODE(ul_cfg_r10.isr_ul_cfg_ded_r10.pack(bref));
    }
    if (ul_cfg_r10.isr_ul_cfg_ded_v1020_present) {
      HANDLE_CODE(ul_cfg_r10.isr_ul_cfg_ded_v1020.pack(bref));
    }
    if (ul_cfg_r10.isr_ul_cfg_ded_aperiodic_r10_present) {
      HANDLE_CODE(ul_cfg_r10.isr_ul_cfg_ded_aperiodic_r10.pack(bref));
    }
  }
  ...
  if (ext) {
    ...
    group_flags[3] |= isr_ul_cfg_ded_v1310.is_present();
    group_flags[3] |= isr_ul_cfg_ded_up_pts_ext_r13.is_present();
    group_flags[3] |= isr_ul_cfg_ded_aperiodic_v1310.is_present();
    group_flags[3] |= isr_ul_cfg_ded_aperiodic_up_pts_ext_r13.is_present();
    ...
    group_flags[5] |= type_b_isr_tpc_pdcch_cfg_r14.is_present();
    group_flags[5] |= ul_pusch_less_pwr_ctrl_ded_v1430.is_present();
    group_flags[5] |= isr_ul_periodic_cfg_ded_list_r14.is_present();
    group_flags[5] |= isr_ul_periodic_cfg_ded_up_pts_ext_list_r14.is_present();
    group_flags[5] |= isr_ul_aperiodic_cfg_ded_list_r14.is_present();
    group_flags[5] |= isr_ul_cfg_ded_ap_up_pts_ext_list_r14.is_present();
    ...
    if (group_flags[5]) {
      ...
      HANDLE_CODE(bref.pack(type_b_isr_tpc_pdcch_cfg_r14.is_present(), 1));
      ...
      if (type_b_isr_tpc_pdcch_cfg_r14.is_present()) {
        HANDLE_CODE(type_b_isr_tpc_pdcch_cfg_r14->pack(bref));
      }
...
ISRASN_CODE phys_cfg_ded_scell_r10_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
  ...
  if (ul_cfg_r10_present) {
    ...
    HANDLE_CODE(bref.unpack(ul_cfg_r10.isr_ul_cfg_ded_r10_present, 1));
    HANDLE_CODE(bref.unpack(ul_cfg_r10.isr_ul_cfg_ded_v1020_present, 1));
    HANDLE_CODE(bref.unpack(ul_cfg_r10.isr_ul_cfg_ded_aperiodic_r10_present, 1));
    if (ul_cfg_r10.ant_info_ul_r10_present) {
    ...
    if (ul_cfg_r10.isr_ul_cfg_ded_r10_present) {
      HANDLE_CODE(ul_cfg_r10.isr_ul_cfg_ded_r10.unpack(bref));
    }
    if (ul_cfg_r10.isr_ul_cfg_ded_v1020_present) {
      HANDLE_CODE(ul_cfg_r10.isr_ul_cfg_ded_v1020.unpack(bref));
    }
    if (ul_cfg_r10.isr_ul_cfg_ded_aperiodic_r10_present) {
      HANDLE_CODE(ul_cfg_r10.isr_ul_cfg_ded_aperiodic_r10.unpack(bref));
    }
  }
  ...
  if (ext) {
    ...
    if (group_flags[5]) {
      ...
      bool type_b_isr_tpc_pdcch_cfg_r14_present;
      HANDLE_CODE(bref.unpack(type_b_isr_tpc_pdcch_cfg_r14_present, 1));
      type_b_isr_tpc_pdcch_cfg_r14.set_present(type_b_isr_tpc_pdcch_cfg_r14_present);
      ...
      if (type_b_isr_tpc_pdcch_cfg_r14.is_present()) {
        HANDLE_CODE(type_b_isr_tpc_pdcch_cfg_r14->unpack(bref));
      }
      if (ul_pusch_less_pwr_ctrl_ded_v1430.is_present()) {
...
void phys_cfg_ded_scell_r10_s::to_json(json_writer& j) const
{
  ...
  if (ul_cfg_r10_present) {
    ...
    if (ul_cfg_r10.isr_ul_cfg_ded_r10_present) {
      ...
      ul_cfg_r10.isr_ul_cfg_ded_r10.to_json(j);
    }
    if (ul_cfg_r10.isr_ul_cfg_ded_v1020_present) {
      j.write_fieldname("soundingRS-UL-ConfigDedicated-v1020");
      ul_cfg_r10.isr_ul_cfg_ded_v1020.to_json(j);
    }
    if (ul_cfg_r10.isr_ul_cfg_ded_aperiodic_r10_present) {
      j.write_fieldname("soundingRS-UL-ConfigDedicatedAperiodic-r10");
      ul_cfg_r10.isr_ul_cfg_ded_aperiodic_r10.to_json(j);
    }
    j.end_obj();
  }
  if (ext) {
    ...
    if (type_b_isr_tpc_pdcch_cfg_r14.is_present()) {
      j.write_fieldname("typeB-ISR-TPC-PDCCH-Config-r14");
      type_b_isr_tpc_pdcch_cfg_r14->to_json(j);
    }
    if (ul_pusch_less_pwr_ctrl_ded_v1430.is_present()) {
...
bool phys_cfg_ded_scell_r10_s::operator==(const phys_cfg_ded_scell_r10_s& other) const
{
  return ext == other.ext and non_ul_cfg_r10.ant_info_r10_present == other.non_ul_cfg_r10.ant_info_r10_present and
         ...
         ul_cfg_r10.isr_ul_cfg_ded_r10_present == other.ul_cfg_r10.isr_ul_cfg_ded_r10_present and
         (not ul_cfg_r10.isr_ul_cfg_ded_r10_present or
          ul_cfg_r10.isr_ul_cfg_ded_r10 == other.ul_cfg_r10.isr_ul_cfg_ded_r10) and
         ul_cfg_r10.isr_ul_cfg_ded_v1020_present == other.ul_cfg_r10.isr_ul_cfg_ded_v1020_present and
         (not ul_cfg_r10.isr_ul_cfg_ded_v1020_present or
          ul_cfg_r10.isr_ul_cfg_ded_v1020 == other.ul_cfg_r10.isr_ul_cfg_ded_v1020) and
         ul_cfg_r10.isr_ul_cfg_ded_aperiodic_r10_present == other.ul_cfg_r10.isr_ul_cfg_ded_aperiodic_r10_present and
         (not ul_cfg_r10.isr_ul_cfg_ded_aperiodic_r10_present or
          ul_cfg_r10.isr_ul_cfg_ded_aperiodic_r10 == other.ul_cfg_r10.isr_ul_cfg_ded_aperiodic_r10) and
         (not ext or
          (csi_rs_cfg_nzp_to_release_list_r11.is_present() == other.csi_rs_cfg_nzp_to_release_list_r11.is_present() and
           ...
           isr_ul_cfg_ded_v1310.is_present() == other.isr_ul_cfg_ded_v1310.is_present() and
           (not isr_ul_cfg_ded_v1310.is_present() or *isr_ul_cfg_ded_v1310 == *other.isr_ul_cfg_ded_v1310) and
           isr_ul_cfg_ded_up_pts_ext_r13.is_present() == other.isr_ul_cfg_ded_up_pts_ext_r13.is_present() and
           (not isr_ul_cfg_ded_up_pts_ext_r13.is_present() or
            *isr_ul_cfg_ded_up_pts_ext_r13 == *other.isr_ul_cfg_ded_up_pts_ext_r13) and
           isr_ul_cfg_ded_aperiodic_v1310.is_present() == other.isr_ul_cfg_ded_aperiodic_v1310.is_present() and
           (not isr_ul_cfg_ded_aperiodic_v1310.is_present() or
            *isr_ul_cfg_ded_aperiodic_v1310 == *other.isr_ul_cfg_ded_aperiodic_v1310) and
           isr_ul_cfg_ded_aperiodic_up_pts_ext_r13.is_present() ==
               other.isr_ul_cfg_ded_aperiodic_up_pts_ext_r13.is_present() and
           (not isr_ul_cfg_ded_aperiodic_up_pts_ext_r13.is_present() or
            *isr_ul_cfg_ded_aperiodic_up_pts_ext_r13 == *other.isr_ul_cfg_ded_aperiodic_up_pts_ext_r13) and
           ...
           type_b_isr_tpc_pdcch_cfg_r14.is_present() == other.type_b_isr_tpc_pdcch_cfg_r14.is_present() and
           (not type_b_isr_tpc_pdcch_cfg_r14.is_present() or
            *type_b_isr_tpc_pdcch_cfg_r14 == *other.type_b_isr_tpc_pdcch_cfg_r14) and
           ...
           isr_ul_periodic_cfg_ded_list_r14.is_present() == other.isr_ul_periodic_cfg_ded_list_r14.is_present() and
           (not isr_ul_periodic_cfg_ded_list_r14.is_present() or
            *isr_ul_periodic_cfg_ded_list_r14 == *other.isr_ul_periodic_cfg_ded_list_r14) and
           isr_ul_periodic_cfg_ded_up_pts_ext_list_r14.is_present() ==
               other.isr_ul_periodic_cfg_ded_up_pts_ext_list_r14.is_present() and
           (not isr_ul_periodic_cfg_ded_up_pts_ext_list_r14.is_present() or
            *isr_ul_periodic_cfg_ded_up_pts_ext_list_r14 == *other.isr_ul_periodic_cfg_ded_up_pts_ext_list_r14) and
           isr_ul_aperiodic_cfg_ded_list_r14.is_present() == other.isr_ul_aperiodic_cfg_ded_list_r14.is_present() and
           (not isr_ul_aperiodic_cfg_ded_list_r14.is_present() or
            *isr_ul_aperiodic_cfg_ded_list_r14 == *other.isr_ul_aperiodic_cfg_ded_list_r14) and
           isr_ul_cfg_ded_ap_up_pts_ext_list_r14.is_present() ==
               other.isr_ul_cfg_ded_ap_up_pts_ext_list_r14.is_present() and
           (not isr_ul_cfg_ded_ap_up_pts_ext_list_r14.is_present() or
            *isr_ul_cfg_ded_ap_up_pts_ext_list_r14 == *other.isr_ul_cfg_ded_ap_up_pts_ext_list_r14) and
...
ISRASN_CODE phys_cfg_ded_scell_r10_s::pucch_scell_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE phys_cfg_ded_scell_r10_s::pucch_scell_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE phys_cfg_ded_scell_r10_s::must_cfg_r14_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE phys_cfg_ded_scell_r10_s::must_cfg_r14_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE phys_cfg_ded_scell_r10_s::semi_static_cfi_cfg_r15_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE phys_cfg_ded_scell_r10_s::semi_static_cfi_cfg_r15_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE phys_cfg_ded_scell_r10_s::semi_static_cfi_cfg_r15_c_::setup_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::cfi_cfg_r15:
...
ISRASN_CODE phys_cfg_ded_scell_r10_s::semi_static_cfi_cfg_r15_c_::setup_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE phys_cfg_ded_scell_r10_s::blind_pdsch_repeat_cfg_r15_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE phys_cfg_ded_scell_r10_s::blind_pdsch_repeat_cfg_r15_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE phys_cfg_ded_scell_v1370_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(pucch_scell_v1370.pack(bref));

  return ISRASN_SUCCESS;
}
ISRASN_CODE phys_cfg_ded_scell_v1370_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE phys_cfg_ded_scell_v1370_s::pucch_scell_v1370_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE phys_cfg_ded_scell_v1370_s::pucch_scell_v1370_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE ant_info_ded_v10i0_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE ant_info_ded_v10i0_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE rr_cfg_ded_scell_r10_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE rr_cfg_ded_scell_r10_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE scell_to_add_mod_ext_r13_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE scell_to_add_mod_ext_r13_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE pucch_cfg_ded_v13c0_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(ch_sel_v13c0.n1_pucch_an_cs_v13c0.pack(bref));

  return ISRASN_SUCCESS;
}
ISRASN_CODE pucch_cfg_ded_v13c0_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE pucch_cfg_ded_v13c0_s::ch_sel_v13c0_s_::n1_pucch_an_cs_v13c0_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE pucch_cfg_ded_v13c0_s::ch_sel_v13c0_s_::n1_pucch_an_cs_v13c0_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE drb_to_add_mod_scg_r12_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE drb_to_add_mod_scg_r12_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE drb_to_add_mod_scg_r12_s::drb_type_r12_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::split_r12:
...
ISRASN_CODE drb_to_add_mod_scg_r12_s::drb_type_r12_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE phys_cfg_ded_v13c0_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(pucch_cfg_ded_v13c0.pack(bref));

  return ISRASN_SUCCESS;
}
ISRASN_CODE phys_cfg_ded_v13c0_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE rr_cfg_common_scell_v10l0_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(pack_integer(bref, ul_cfg_v10l0.add_spec_emission_scell_v10l0, (uint16_t)33u, (uint16_t)288u));

  return ISRASN_SUCCESS;
}
ISRASN_CODE rr_cfg_common_scell_v10l0_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE rlf_timers_and_consts_scg_r12_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE rlf_timers_and_consts_scg_r12_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE scell_to_add_mod_r10_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
  ...
  if (ext) {
    ...
    group_flags[2] |= isr_switch_from_serv_cell_idx_r14_present;
    ...
    if (group_flags[2]) {
      ...
      HANDLE_CODE(bref.pack(isr_switch_from_serv_cell_idx_r14_present, 1));
      if (isr_switch_from_serv_cell_idx_r14_present) {
        HANDLE_CODE(pack_integer(bref, isr_switch_from_serv_cell_idx_r14, (uint8_t)0u, (uint8_t)31u));
      }
    }
    if (group_flags[3]) {
      varlength_field_pack_guard varlen_scope(bref, false);
...
ISRASN_CODE scell_to_add_mod_r10_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
  ...
  if (ext) {
    ...
    if (group_flags[2]) {
      ...
      HANDLE_CODE(bref.unpack(isr_switch_from_serv_cell_idx_r14_present, 1));
      if (isr_switch_from_serv_cell_idx_r14_present) {
        HANDLE_CODE(unpack_integer(isr_switch_from_serv_cell_idx_r14, bref, (uint8_t)0u, (uint8_t)31u));
      }
    }
    if (group_flags[3]) {
      varlength_field_unpack_guard varlen_scope(bref, false);
...
void scell_to_add_mod_r10_s::to_json(json_writer& j) const
{
  ...
  if (ext) {
    ...
    if (isr_switch_from_serv_cell_idx_r14_present) {
      j.write_int("isr-SwitchFromServCellIndex-r14", isr_switch_from_serv_cell_idx_r14);
    }
    if (scell_state_r15_present) {
...
bool scell_to_add_mod_r10_s::operator==(const scell_to_add_mod_r10_s& other) const
{
  return ext == other.ext and scell_idx_r10 == other.scell_idx_r10 and
         ...
         (not ext or (dl_carrier_freq_v1090_present == other.dl_carrier_freq_v1090_present and
                      ...
                      isr_switch_from_serv_cell_idx_r14_present == other.isr_switch_from_serv_cell_idx_r14_present and
                      (not isr_switch_from_serv_cell_idx_r14_present or
                       isr_switch_from_serv_cell_idx_r14 == other.isr_switch_from_serv_cell_idx_r14) and
...
ISRASN_CODE scell_to_add_mod_ext_v1370_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE scell_to_add_mod_ext_v1370_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE scell_to_add_mod_ext_v1430_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
  HANDLE_CODE(bref.pack(isr_switch_from_serv_cell_idx_r14_present, 1));
...
ISRASN_CODE scell_to_add_mod_ext_v1430_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
  HANDLE_CODE(bref.unpack(isr_switch_from_serv_cell_idx_r14_present, 1));
...
ISRASN_CODE rr_cfg_ded_scg_r12_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE rr_cfg_ded_scg_r12_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE phys_cfg_ded_scell_v13c0_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(pucch_scell_v13c0.pack(bref));

  return ISRASN_SUCCESS;
}
ISRASN_CODE phys_cfg_ded_scell_v13c0_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE phys_cfg_ded_scell_v13c0_s::pucch_scell_v13c0_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE phys_cfg_ded_scell_v13c0_s::pucch_scell_v13c0_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE rr_cfg_ded_scell_v13c0_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(phys_cfg_ded_scell_v13c0.pack(bref));

  return ISRASN_SUCCESS;
}
ISRASN_CODE rr_cfg_ded_scell_v13c0_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE scell_to_add_mod_v13c0_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE scell_to_add_mod_v13c0_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE scell_to_add_mod_v10l0_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE scell_to_add_mod_v10l0_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE rr_cfg_ded_v13c0_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(phys_cfg_ded_v13c0.pack(bref));

  return ISRASN_SUCCESS;
}
ISRASN_CODE rr_cfg_ded_v13c0_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE cell_to_add_mod_r12_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE cell_to_add_mod_r12_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
