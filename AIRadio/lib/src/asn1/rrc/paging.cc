...
#include "isrran/asn1/rrc/paging.h"
#include <sstream>
...
ISRASN_CODE paging_v1530_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE paging_v1530_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE paging_v1310_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE paging_v1310_ies_s::unpack(cbit_ref& bref)
{
...
// S-TMSI ::= SEQUENCE
ISRASN_CODE s_tmsi_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE s_tmsi_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE paging_v1130_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE paging_v1130_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE paging_ue_id_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::s_tmsi:
...
ISRASN_CODE paging_ue_id_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE paging_v920_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE paging_v920_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE paging_record_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE paging_record_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE paging_v890_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE paging_v890_ies_s::unpack(cbit_ref& bref)
{
...
// Paging ::= SEQUENCE
ISRASN_CODE paging_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE paging_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE pcch_msg_type_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::c1:
...
ISRASN_CODE pcch_msg_type_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE pcch_msg_type_c::c1_c_::pack(bit_ref& bref) const
{
  HANDLE_CODE(c.pack(bref));
  return ISRASN_SUCCESS;
}
ISRASN_CODE pcch_msg_type_c::c1_c_::unpack(cbit_ref& bref)
{
  HANDLE_CODE(c.unpack(bref));
  return ISRASN_SUCCESS;
}
...
ISRASN_CODE pcch_msg_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE pcch_msg_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE ue_paging_coverage_info_r13_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE ue_paging_coverage_info_r13_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE ue_paging_coverage_info_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(crit_exts.pack(bref));

  return ISRASN_SUCCESS;
}
ISRASN_CODE ue_paging_coverage_info_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE ue_paging_coverage_info_s::crit_exts_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::c1:
...
ISRASN_CODE ue_paging_coverage_info_s::crit_exts_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE ue_paging_coverage_info_s::crit_exts_c_::c1_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::ue_paging_coverage_info_r13:
...
ISRASN_CODE ue_paging_coverage_info_s::crit_exts_c_::c1_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE ue_radio_paging_info_v1310_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE ue_radio_paging_info_v1310_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE ue_radio_paging_info_r12_ies_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(non_crit_ext_present, 1));
...
ISRASN_CODE ue_radio_paging_info_r12_ies_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(non_crit_ext_present, 1));
...
ISRASN_CODE ue_radio_paging_info_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(crit_exts.pack(bref));

  return ISRASN_SUCCESS;
}
ISRASN_CODE ue_radio_paging_info_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(crit_exts.unpack(bref));
...
ISRASN_CODE ue_radio_paging_info_s::crit_exts_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::c1:
...
ISRASN_CODE ue_radio_paging_info_s::crit_exts_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE ue_radio_paging_info_s::crit_exts_c_::c1_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::ue_radio_paging_info_r12:
...
ISRASN_CODE ue_radio_paging_info_s::crit_exts_c_::c1_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
