...
#include "isrran/asn1/rrc/dl_ccch_msg.h"
#include <sstream>
...
ISRASN_CODE rrc_conn_reject_v1320_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE rrc_conn_reject_v1320_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE band_class_prio1_xrtt_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE band_class_prio1_xrtt_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE band_class_prio_hrpd_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(band_class.pack(bref));
  HANDLE_CODE(pack_integer(bref, cell_resel_prio, (uint8_t)0u, (uint8_t)7u));
...
ISRASN_CODE band_class_prio_hrpd_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(band_class.unpack(bref));
  HANDLE_CODE(unpack_integer(cell_resel_prio, bref, (uint8_t)0u, (uint8_t)7u));
...
ISRASN_CODE freq_prio_eutra_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE freq_prio_eutra_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE freq_prio_eutra_r12_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE freq_prio_eutra_r12_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE freq_prio_eutra_v1310_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE freq_prio_eutra_v1310_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE freq_prio_nr_r15_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE freq_prio_nr_r15_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE freq_prio_utra_fdd_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE freq_prio_utra_fdd_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE freq_prio_utra_tdd_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(pack_integer(bref, carrier_freq, (uint16_t)0u, (uint16_t)16383u));
  HANDLE_CODE(pack_integer(bref, cell_resel_prio, (uint8_t)0u, (uint8_t)7u));
...
ISRASN_CODE freq_prio_utra_tdd_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(unpack_integer(carrier_freq, bref, (uint16_t)0u, (uint16_t)16383u));
  HANDLE_CODE(unpack_integer(cell_resel_prio, bref, (uint8_t)0u, (uint8_t)7u));
...
ISRASN_CODE freqs_prio_geran_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE freqs_prio_geran_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE rrc_conn_reject_v1130_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE rrc_conn_reject_v1130_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE freq_prio_eutra_v9e0_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE freq_prio_eutra_v9e0_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE rrc_conn_reject_v1020_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE rrc_conn_reject_v1020_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE idle_mode_mob_ctrl_info_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE idle_mode_mob_ctrl_info_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE idle_mode_mob_ctrl_info_v9e0_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(pack_dyn_seq_of(bref, freq_prio_list_eutra_v9e0, 1, 8));

  return ISRASN_SUCCESS;
}
ISRASN_CODE idle_mode_mob_ctrl_info_v9e0_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE rrc_conn_reest_v8a0_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE rrc_conn_reest_v8a0_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE rrc_conn_reest_reject_v8a0_ies_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(late_non_crit_ext_present, 1));
  HANDLE_CODE(bref.pack(non_crit_ext_present, 1));
...
ISRASN_CODE rrc_conn_reest_reject_v8a0_ies_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(late_non_crit_ext_present, 1));
  HANDLE_CODE(bref.unpack(non_crit_ext_present, 1));
...
ISRASN_CODE rrc_conn_reject_v8a0_ies_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(late_non_crit_ext_present, 1));
  HANDLE_CODE(bref.pack(non_crit_ext_present, 1));
...
ISRASN_CODE rrc_conn_reject_v8a0_ies_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(late_non_crit_ext_present, 1));
  HANDLE_CODE(bref.unpack(non_crit_ext_present, 1));
...
ISRASN_CODE rrc_conn_setup_v8a0_ies_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(late_non_crit_ext_present, 1));
  HANDLE_CODE(bref.pack(non_crit_ext_present, 1));
...
ISRASN_CODE rrc_conn_setup_v8a0_ies_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(late_non_crit_ext_present, 1));
  HANDLE_CODE(bref.unpack(non_crit_ext_present, 1));
...
ISRASN_CODE rrc_early_data_complete_v1590_ies_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(late_non_crit_ext_present, 1));
  HANDLE_CODE(bref.pack(non_crit_ext_present, 1));
...
ISRASN_CODE rrc_early_data_complete_v1590_ies_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(late_non_crit_ext_present, 1));
  HANDLE_CODE(bref.unpack(non_crit_ext_present, 1));
...
ISRASN_CODE redirected_carrier_info_r15_ies_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::eutra_r15:
...
ISRASN_CODE redirected_carrier_info_r15_ies_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE rrc_conn_reest_r8_ies_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(non_crit_ext_present, 1));
...
ISRASN_CODE rrc_conn_reest_r8_ies_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(non_crit_ext_present, 1));
...
ISRASN_CODE rrc_conn_reest_reject_r8_ies_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(non_crit_ext_present, 1));
...
ISRASN_CODE rrc_conn_reest_reject_r8_ies_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(non_crit_ext_present, 1));
...
ISRASN_CODE rrc_conn_reject_r8_ies_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(non_crit_ext_present, 1));
...
ISRASN_CODE rrc_conn_reject_r8_ies_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(non_crit_ext_present, 1));
...
ISRASN_CODE rrc_conn_setup_r8_ies_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(non_crit_ext_present, 1));
...
ISRASN_CODE rrc_conn_setup_r8_ies_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(non_crit_ext_present, 1));
...
ISRASN_CODE rrc_early_data_complete_r15_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE rrc_early_data_complete_r15_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE rrc_conn_reest_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE rrc_conn_reest_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE rrc_conn_reest_s::crit_exts_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::c1:
...
ISRASN_CODE rrc_conn_reest_s::crit_exts_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE rrc_conn_reest_s::crit_exts_c_::c1_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::rrc_conn_reest_r8:
...
ISRASN_CODE rrc_conn_reest_s::crit_exts_c_::c1_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE rrc_conn_reest_reject_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(crit_exts.pack(bref));

  return ISRASN_SUCCESS;
}
ISRASN_CODE rrc_conn_reest_reject_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(crit_exts.unpack(bref));
...
ISRASN_CODE rrc_conn_reest_reject_s::crit_exts_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::rrc_conn_reest_reject_r8:
...
ISRASN_CODE rrc_conn_reest_reject_s::crit_exts_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE rrc_conn_reject_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(crit_exts.pack(bref));

  return ISRASN_SUCCESS;
}
ISRASN_CODE rrc_conn_reject_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(crit_exts.unpack(bref));
...
ISRASN_CODE rrc_conn_reject_s::crit_exts_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::c1:
...
ISRASN_CODE rrc_conn_reject_s::crit_exts_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE rrc_conn_reject_s::crit_exts_c_::c1_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::rrc_conn_reject_r8:
...
ISRASN_CODE rrc_conn_reject_s::crit_exts_c_::c1_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE rrc_conn_setup_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(pack_integer(bref, rrc_transaction_id, (uint8_t)0u, (uint8_t)3u));
  HANDLE_CODE(crit_exts.pack(bref));
...
ISRASN_CODE rrc_conn_setup_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(unpack_integer(rrc_transaction_id, bref, (uint8_t)0u, (uint8_t)3u));
  HANDLE_CODE(crit_exts.unpack(bref));
...
ISRASN_CODE rrc_conn_setup_s::crit_exts_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::c1:
...
ISRASN_CODE rrc_conn_setup_s::crit_exts_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE rrc_conn_setup_s::crit_exts_c_::c1_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::rrc_conn_setup_r8:
...
ISRASN_CODE rrc_conn_setup_s::crit_exts_c_::c1_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE rrc_early_data_complete_r15_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(crit_exts.pack(bref));

  return ISRASN_SUCCESS;
}
ISRASN_CODE rrc_early_data_complete_r15_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(crit_exts.unpack(bref));
...
ISRASN_CODE rrc_early_data_complete_r15_s::crit_exts_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::rrc_early_data_complete_r15:
...
ISRASN_CODE rrc_early_data_complete_r15_s::crit_exts_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE dl_ccch_msg_type_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::c1:
...
ISRASN_CODE dl_ccch_msg_type_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE dl_ccch_msg_type_c::c1_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::rrc_conn_reest:
...
ISRASN_CODE dl_ccch_msg_type_c::c1_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE dl_ccch_msg_type_c::msg_class_ext_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::c2:
...
ISRASN_CODE dl_ccch_msg_type_c::msg_class_ext_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE dl_ccch_msg_type_c::msg_class_ext_c_::c2_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::rrc_early_data_complete_r15:
...
ISRASN_CODE dl_ccch_msg_type_c::msg_class_ext_c_::c2_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE dl_ccch_msg_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE dl_ccch_msg_s::unpack(cbit_ref& bref)
{
