...
ISRASN_CODE plmn_id_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE plmn_id_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE plmn_id_info_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE plmn_id_info_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE mbsfn_sf_cfg_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE mbsfn_sf_cfg_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE mbsfn_sf_cfg_s::sf_alloc_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::one_frame:
...
ISRASN_CODE mbsfn_sf_cfg_s::sf_alloc_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE mbsfn_sf_cfg_v1430_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(sf_alloc_v1430.pack(bref));

  return ISRASN_SUCCESS;
}
ISRASN_CODE mbsfn_sf_cfg_v1430_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE mbsfn_sf_cfg_v1430_s::sf_alloc_v1430_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::one_frame_v1430:
...
ISRASN_CODE mbsfn_sf_cfg_v1430_s::sf_alloc_v1430_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE meas_sf_pattern_r10_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::sf_pattern_fdd_r10:
...
ISRASN_CODE meas_sf_pattern_r10_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE meas_sf_pattern_r10_c::sf_pattern_tdd_r10_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::sf_cfg1_minus5_r10:
...
ISRASN_CODE meas_sf_pattern_r10_c::sf_pattern_tdd_r10_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
