...
#include "isrran/asn1/rrc/common_ext.h"
#include <sstream>
...
ISRASN_CODE mcs_pssch_range_r15_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE mcs_pssch_range_r15_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sl_tx_pwr_r14_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::minusinfinity_r14:
...
ISRASN_CODE sl_tx_pwr_r14_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE sl_min_t2_value_r15_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sl_min_t2_value_r15_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sl_pppp_tx_cfg_idx_r14_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sl_pppp_tx_cfg_idx_r14_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sl_pppp_tx_cfg_idx_v1530_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sl_pppp_tx_cfg_idx_v1530_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sl_pssch_tx_params_r14_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sl_pssch_tx_params_r14_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sl_pssch_tx_params_v1530_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(pack_integer(bref, min_mcs_pssch_r15, (uint8_t)0u, (uint8_t)31u));
  HANDLE_CODE(pack_integer(bref, max_mcs_pssch_r15, (uint8_t)0u, (uint8_t)31u));
...
ISRASN_CODE sl_pssch_tx_params_v1530_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(unpack_integer(min_mcs_pssch_r15, bref, (uint8_t)0u, (uint8_t)31u));
  HANDLE_CODE(unpack_integer(max_mcs_pssch_r15, bref, (uint8_t)0u, (uint8_t)31u));
...
ISRASN_CODE sl_offset_ind_r12_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::small_r12:
...
ISRASN_CODE sl_offset_ind_r12_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE sl_p2_x_res_sel_cfg_r14_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sl_p2_x_res_sel_cfg_r14_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sl_pssch_tx_cfg_r14_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sl_pssch_tx_cfg_r14_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sl_sync_allowed_r14_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sl_sync_allowed_r14_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sl_tx_params_r12_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sl_tx_params_r12_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sf_bitmap_sl_r12_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::bs4_r12:
...
ISRASN_CODE sf_bitmap_sl_r12_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE sf_bitmap_sl_r14_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::bs10_r14:
...
ISRASN_CODE sf_bitmap_sl_r14_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE sl_comm_res_pool_v2x_r14_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sl_comm_res_pool_v2x_r14_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sl_pool_sel_cfg_r12_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sl_pool_sel_cfg_r12_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sl_sync_cfg_nfreq_r13_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sl_sync_cfg_nfreq_r13_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sl_tf_res_cfg_r12_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sl_tf_res_cfg_r12_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sl_comm_tx_pool_sensing_cfg_r14_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(restrict_res_reserv_period_r14_present, 1));
...
ISRASN_CODE sl_comm_tx_pool_sensing_cfg_r14_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(restrict_res_reserv_period_r14_present, 1));
...
ISRASN_CODE sl_disc_res_pool_r12_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sl_disc_res_pool_r12_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sl_disc_res_pool_r12_s::tx_params_r12_s_::ue_sel_res_cfg_r12_s_::pool_sel_r12_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::rsrp_based_r12:
...
ISRASN_CODE sl_disc_res_pool_r12_s::tx_params_r12_s_::ue_sel_res_cfg_r12_s_::pool_sel_r12_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE sl_disc_res_pool_r12_s::disc_period_v1310_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE sl_disc_res_pool_r12_s::disc_period_v1310_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE sl_disc_res_pool_r12_s::rx_params_add_neigh_freq_r13_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE sl_disc_res_pool_r12_s::rx_params_add_neigh_freq_r13_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE sl_disc_res_pool_r12_s::tx_params_add_neigh_freq_r13_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE sl_disc_res_pool_r12_s::tx_params_add_neigh_freq_r13_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE sl_disc_res_pool_r12_s::tx_params_add_neigh_freq_v1370_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE sl_disc_res_pool_r12_s::tx_params_add_neigh_freq_v1370_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE sl_zone_cfg_r14_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sl_zone_cfg_r14_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE pci_range_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE pci_range_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sl_disc_tx_pwr_info_r12_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sl_disc_tx_pwr_info_r12_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sl_v2x_freq_sel_cfg_r15_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sl_v2x_freq_sel_cfg_r15_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sl_v2x_inter_freq_ue_cfg_r14_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sl_v2x_inter_freq_ue_cfg_r14_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE cell_sel_info_nfreq_r13_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE cell_sel_info_nfreq_r13_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sl_allowed_carrier_freq_list_r15_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sl_allowed_carrier_freq_list_r15_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sl_disc_tx_res_inter_freq_r13_c::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::acquire_si_from_carrier_r13:
...
ISRASN_CODE sl_disc_tx_res_inter_freq_r13_c::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE meas_idle_carrier_eutra_r15_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE meas_idle_carrier_eutra_r15_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sl_cbr_pssch_tx_cfg_r14_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sl_cbr_pssch_tx_cfg_r14_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sl_hop_cfg_comm_r12_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sl_hop_cfg_comm_r12_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sl_inter_freq_info_v2x_r14_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sl_inter_freq_info_v2x_r14_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sl_inter_freq_info_v2x_r14_s::add_spec_emission_v2x_r14_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::add_spec_emission_r14:
...
ISRASN_CODE sl_inter_freq_info_v2x_r14_s::add_spec_emission_v2x_r14_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE sl_pppr_dest_carrier_freq_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sl_pppr_dest_carrier_freq_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sl_res_inter_freq_r13_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sl_res_inter_freq_r13_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sl_sync_cfg_r12_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
  HANDLE_CODE(bref.pack(tx_params_r12_present, 1));
...
ISRASN_CODE sl_sync_cfg_r12_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
  HANDLE_CODE(bref.unpack(tx_params_r12_present, 1));
...
ISRASN_CODE wlan_ids_r12_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE wlan_ids_r12_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE ref_time_r15_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE ref_time_r15_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sl_cbr_common_tx_cfg_list_r14_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE sl_cbr_common_tx_cfg_list_r14_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE sl_comm_res_pool_r12_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sl_comm_res_pool_r12_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE wlan_offload_cfg_r12_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE wlan_offload_cfg_r12_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sl_v2x_cfg_common_r14_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(v2x_comm_rx_pool_r14_present, 1));
...
ISRASN_CODE sl_v2x_cfg_common_r14_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(v2x_comm_rx_pool_r14_present, 1));
...
ISRASN_CODE sl_v2x_packet_dupl_cfg_r15_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sl_v2x_packet_dupl_cfg_r15_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE time_ref_info_r15_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE time_ref_info_r15_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE wlan_offload_info_per_plmn_r12_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE wlan_offload_info_per_plmn_r12_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE sl_gap_pattern_r13_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE sl_gap_pattern_r13_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
