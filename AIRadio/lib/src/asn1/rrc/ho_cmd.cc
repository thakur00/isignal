...
#include "isrran/asn1/rrc/ho_cmd.h"
#include <sstream>
...
ISRASN_CODE scg_cfg_v13c0_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE scg_cfg_v13c0_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE scg_cfg_v12i0a_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE scg_cfg_v12i0a_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE scg_cfg_r12_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE scg_cfg_r12_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE as_cfg_v1550_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE as_cfg_v1550_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE as_cfg_nr_r15_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE as_cfg_nr_r15_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE as_cfg_nr_v1570_s::pack(bit_ref& bref) const
{
  return ISRASN_SUCCESS;
}
ISRASN_CODE as_cfg_nr_v1570_s::unpack(cbit_ref& bref)
{
  return ISRASN_SUCCESS;
}
...
ISRASN_CODE scg_cfg_r12_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(crit_exts.pack(bref));

  return ISRASN_SUCCESS;
}
ISRASN_CODE scg_cfg_r12_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE scg_cfg_r12_s::crit_exts_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::c1:
...
ISRASN_CODE scg_cfg_r12_s::crit_exts_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE scg_cfg_r12_s::crit_exts_c_::c1_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::scg_cfg_r12:
...
ISRASN_CODE scg_cfg_r12_s::crit_exts_c_::c1_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
// AS-Config ::= SEQUENCE
ISRASN_CODE as_cfg_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE as_cfg_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE as_cfg_v10j0_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE as_cfg_v10j0_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE as_cfg_v1250_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE as_cfg_v1250_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE as_cfg_v1320_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE as_cfg_v1320_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE as_cfg_v13c0_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE as_cfg_v13c0_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE as_cfg_v1430_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE as_cfg_v1430_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE as_cfg_v9e0_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(pack_integer(bref, source_dl_carrier_freq_v9e0, (uint32_t)65536u, (uint32_t)262143u));

  return ISRASN_SUCCESS;
}
ISRASN_CODE as_cfg_v9e0_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE add_reestab_info_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE add_reestab_info_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE reest_info_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE reest_info_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
// AS-Context ::= SEQUENCE
ISRASN_CODE as_context_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE as_context_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE as_context_v1130_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE as_context_v1130_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE as_context_v1320_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE as_context_v1320_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE candidate_cell_info_r10_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE candidate_cell_info_r10_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE ho_cmd_r8_ies_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(non_crit_ext_present, 1));
...
ISRASN_CODE ho_cmd_r8_ies_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(non_crit_ext_present, 1));
...
ISRASN_CODE ho_cmd_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(crit_exts.pack(bref));

  return ISRASN_SUCCESS;
}
ISRASN_CODE ho_cmd_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(crit_exts.unpack(bref));
...
ISRASN_CODE ho_cmd_s::crit_exts_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::c1:
...
ISRASN_CODE ho_cmd_s::crit_exts_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE ho_cmd_s::crit_exts_c_::c1_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::ho_cmd_r8:
...
ISRASN_CODE ho_cmd_s::crit_exts_c_::c1_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE ho_prep_info_v1540_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE ho_prep_info_v1540_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE ho_prep_info_v1530_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE ho_prep_info_v1530_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE ho_prep_info_v1430_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE ho_prep_info_v1430_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE ho_prep_info_v1320_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE ho_prep_info_v1320_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE ho_prep_info_v1250_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE ho_prep_info_v1250_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE ho_prep_info_v1130_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE ho_prep_info_v1130_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE ho_prep_info_v9e0_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE ho_prep_info_v9e0_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE ho_prep_info_v9d0_ies_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(late_non_crit_ext_present, 1));
  HANDLE_CODE(bref.pack(non_crit_ext_present, 1));
...
ISRASN_CODE ho_prep_info_v9d0_ies_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(late_non_crit_ext_present, 1));
  HANDLE_CODE(bref.unpack(non_crit_ext_present, 1));
...
ISRASN_CODE ho_prep_info_v920_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE ho_prep_info_v920_ies_s::unpack(cbit_ref& bref)
{
...
// RRM-Config ::= SEQUENCE
ISRASN_CODE rrm_cfg_s::pack(bit_ref& bref) const
{
  bref.pack(ext, 1);
...
ISRASN_CODE rrm_cfg_s::unpack(cbit_ref& bref)
{
  bref.unpack(ext, 1);
...
ISRASN_CODE ho_prep_info_r8_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE ho_prep_info_r8_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE ho_prep_info_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(crit_exts.pack(bref));

  return ISRASN_SUCCESS;
}
ISRASN_CODE ho_prep_info_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(crit_exts.unpack(bref));
...
ISRASN_CODE ho_prep_info_s::crit_exts_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::c1:
...
ISRASN_CODE ho_prep_info_s::crit_exts_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE ho_prep_info_s::crit_exts_c_::c1_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::ho_prep_info_r8:
...
ISRASN_CODE ho_prep_info_s::crit_exts_c_::c1_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
...
ISRASN_CODE ho_prep_info_v13c0_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE ho_prep_info_v13c0_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE ho_prep_info_v10x0_ies_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(late_non_crit_ext_present, 1));
  HANDLE_CODE(bref.pack(non_crit_ext_present, 1));
...
ISRASN_CODE ho_prep_info_v10x0_ies_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(late_non_crit_ext_present, 1));
  HANDLE_CODE(bref.unpack(non_crit_ext_present, 1));
...
ISRASN_CODE ho_prep_info_v10j0_ies_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE ho_prep_info_v10j0_ies_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE ho_prep_info_v9j0_ies_s::pack(bit_ref& bref) const
{
  HANDLE_CODE(bref.pack(late_non_crit_ext_present, 1));
  HANDLE_CODE(bref.pack(non_crit_ext_present, 1));
...
ISRASN_CODE ho_prep_info_v9j0_ies_s::unpack(cbit_ref& bref)
{
  HANDLE_CODE(bref.unpack(late_non_crit_ext_present, 1));
  HANDLE_CODE(bref.unpack(non_crit_ext_present, 1));
...
ISRASN_CODE var_meas_cfg_s::pack(bit_ref& bref) const
{
...
ISRASN_CODE var_meas_cfg_s::unpack(cbit_ref& bref)
{
...
ISRASN_CODE var_meas_cfg_s::speed_state_pars_c_::pack(bit_ref& bref) const
{
  type_.pack(bref);
  switch (type_) {
    case types::release:
...
ISRASN_CODE var_meas_cfg_s::speed_state_pars_c_::unpack(cbit_ref& bref)
{
  types e;
  e.unpack(bref);
  set(e);
