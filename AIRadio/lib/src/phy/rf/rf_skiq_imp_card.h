 ...
 *
 */
#ifndef ISRRAN_LIB_SRC_PHY_RF_RF_SKIQ_IMP_CARD_H_
#define ISRRAN_LIB_SRC_PHY_RF_RF_SKIQ_IMP_CARD_H_
...
void rf_skiq_card_set_error_handler(rf_skiq_card_t* q, isrran_rf_error_handler_t error_handler, void* arg);
...
#endif // ISRRAN_LIB_SRC_PHY_RF_RF_SKIQ_IMP_CARD_H_
