 ...
 *
 */
#ifndef ISRRAN_RF_UHD_SAFE_H
#define ISRRAN_RF_UHD_SAFE_H
...
#define ISRRAN_UHD_SAFE_C_LOG_ERROR(...)                                                                               \
  try {                                                                                                                \
    __VA_ARGS__                                                                                                        \
...
public:
  ...
  uhd_error         start_rx_stream(double delay)
  {
    ...
    ISRRAN_UHD_SAFE_C_LOG_ERROR(uhd::stream_cmd_t stream_cmd(uhd::stream_cmd_t::STREAM_MODE_START_CONTINUOUS);
  ...
  uhd_error stop_rx_stream()
  {
    ...
    ISRRAN_UHD_SAFE_C_LOG_ERROR(uhd::stream_cmd_t stream_cmd(uhd::stream_cmd_t::STREAM_MODE_STOP_CONTINUOUS);
  ...
  {
    ISRRAN_UHD_SAFE_C_LOG_ERROR(uhd::rx_streamer::buffs_type buffs_cpp(buffs, rx_stream->get_num_channels());
                                nof_rxd_samples =
  ...
  {
    ISRRAN_UHD_SAFE_C_LOG_ERROR(valid = tx_stream->recv_async_msg(async_metadata, timeout);)
  }
  ...
  {
    ISRRAN_UHD_SAFE_C_LOG_ERROR(uhd::tx_streamer::buffs_type buffs_cpp(buffs, tx_stream->get_num_channels());
