 ...
 */
ISRRAN_API void isrran_vec_function_f_fff(const float* x, const float* y, float* z, uint16_t len);
 ...
 * \param[in] len Length of vectors x, y and z.
 */
ISRRAN_API void isrran_vec_function_f_sss(const int16_t* x, const int16_t* y, int16_t* z, uint16_t len);
 ...
 * \param[in] len Length of vectors x, y and z.
 */
ISRRAN_API void isrran_vec_function_f_ccc(const int8_t* x, const int8_t* y, int8_t* z, uint16_t len);
 ...
 */
ISRRAN_API void isrran_vec_function_g_bfff(const uint8_t* b, const float* x, const float* y, float* z, uint16_t len);
 ...
 */
ISRRAN_API void
isrran_vec_function_g_bsss(const uint8_t* b, const int16_t* x, const int16_t* y, int16_t* z, uint16_t len);
 ...
 * \param[in] len Length of vectors b, x, y and z.
 */
ISRRAN_API void isrran_vec_function_g_bccc(const uint8_t* b, const int8_t* x, const int8_t* y, int8_t* z, uint16_t len);
 ...
 */
ISRRAN_API void isrran_vec_hard_bit_fc(const float* x, uint8_t* z, uint16_t len);
 ...
 * \param[in] len Length of vectors x and z.
 */
ISRRAN_API void isrran_vec_hard_bit_sc(const int16_t* x, uint8_t* z, uint16_t len);
 ...
 * \param[in] len Length of vectors x and z.
 */
ISRRAN_API void isrran_vec_hard_bit_cc(const int8_t* x, uint8_t* z, uint16_t len);
