 ...
 */
static const __m256i mask_least_epi8[ISRRAN_AVX2_B_SIZE + 1] = {
 ...
 * corresponding to the ISRRAN_AVX2_B_SIZE - \b i most significant chars.
 */
static const __m256i mask_most_epi8[ISRRAN_AVX2_B_SIZE + 1] = {
    {0xFFFFFFFFFFFFFFFF, 0xFFFFFFFFFFFFFFFF, 0xFFFFFFFFFFFFFFFF, 0xFFFFFFFFFFFFFFFF},  // NOLINT
