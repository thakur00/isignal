...
#ifndef ISRRAN_LDPCDEC_ALL_H
#define ISRRAN_LDPCDEC_ALL_H
 ...
 * ISRRAN_AVX2_B_SIZE). \param[in] bgN          Codeword length. \param[in] bgM          Number of check nodes.
...
/*!
 * Destroys the inner registers of the optimized 8-bit integer-based LDPC decoder (LS <= \ref ISRRAN_AVX2_B_SIZE).
 ...
 * carrying out the actual decoding (LS <= \ref ISRRAN_AVX2_B_SIZE).
...
/*!
 * Updates the messages from variable nodes to check nodes (optimized 8-bit version, LS <= \ref ISRRAN_AVX2_B_SIZE).
 * \param[in,out] p       A pointer to the decoder registers (an ldpc_regs_c_avx2 structure).
 * \param[in]     i_layer The index of the variable-to-check layer to update.
 * \return An integer: 0 if the function executes correctly, -1 otherwise.
 */
...
/*!
 * Updates the messages from check nodes to variable nodes (optimized 8-bit version, LS <= \ref ISRRAN_AVX2_B_SIZE).
 * \param[in,out] p        A pointer to the decoder registers (an ldpc_regs_c_avx2 structure).
 * \param[in]     i_layer  The index of the variable-to-check layer to update.
 * \param[in]     this_pcm A pointer to the row of the parity check matrix (i.e. base
 *                         graph) corresponding to the selected layer.
 ...
 * ISRRAN_AVX2_B_SIZE). \param[in,out] p        A pointer to the decoder registers (an ldpc_regs_c_avx2 structure).
 * \param[in]     i_layer  The index of the variable-to-check layer to update.
 * \param[in]     these_var_indices
 *                         Contains the indices of the variable nodes connected
 *                         to the current layer.
...
/*!
 * Updates the current estimate of the (soft) bits of the codeword (optimized 8-bit version, LS > \ref
 * ISRRAN_AVX2_B_SIZE). \param[in,out] p        A pointer to the decoder registers (an ldpc_regs_c_avx2long structure).
 * \param[in]     i_layer  The index of the variable-to-check layer to update.
 * \param[in]     these_var_indices
 *                         Contains the indices of the variable nodes connected
 *                         to the current layer.
...
/*!
 * Returns the decoded message (hard bits) from the current soft bits (optimized 8-bit version, LS > \ref
 * ISRRAN_AVX2_B_SIZE). \param[in]  p       A pointer to the decoder registers (an ldpc_regs_c_avx2long structure).
 * \param[out] message A pointer to the decoded message.
 * \param[in]  liftK   The length of the decoded message.
 * \return An integer: 0 if the function executes correctly, -1 otherwise.
 */
 ...
 * (flooded scheduling, LS <= \ref ISRRAN_AVX2_B_SIZE).
 * \param[in] bgN          Codeword length.
 * \param[in] bgM          Number of check nodes.
 * \param[in] ls           Lifting size.
 * \param[in] scaling_fctr Scaling factor of the normalized min-sum algorithm.
...
/*!
 * Initializes the inner registers of the optimized 8-bit integer-based LDPC decoder before
 * carrying out the actual decoding (flooded scheduling, LS <= \ref ISRRAN_AVX2_B_SIZE).
 ...
 * (optimized 8-bit version, flooded scheduling, LS <= \ref ISRRAN_AVX2_B_SIZE).
 * \param[in,out] p        A pointer to the decoder registers (an ldpc_regs_c_avx2_flood structure).
 * \param[in]     i_layer  The index of the variable-to-check layer to update.
 * \param[in]     this_pcm A pointer to the row of the parity check matrix (i.e. base
 *                         graph) corresponding to the selected layer.
...
/*!
 * Returns the decoded message (hard bits) from the current soft bits
 * (flooded scheduling, optimized 8-bit version, LS <= \ref ISRRAN_AVX2_B_SIZE).
 ...
 * ISRRAN_AVX2_B_SIZE). \param[in] p A pointer to the dismantled decoder registers (an ldpc_regs_c_avx2long_flood
 * structure).
 */
...
/*!
 * Creates the registers used by the optimized 8-bit-based implementation of the LDPC decoder (LS > \ref
 * ISRRAN_AVX512_B_SIZE). \param[in] bgN          Codeword length. \param[in] bgM          Number of check nodes.
 * \param[in] ls           Lifting size. \param[in] scaling_fctr Scaling factor of the normalized min-sum algorithm.
...
/*!
 * Destroys the inner registers of the optimized 8-bit integer-based LDPC decoder (LS > \ref ISRRAN_AVX512_B_SIZE).
...
/*!
 * Initializes the inner registers of the optimized 8-bit integer-based LDPC decoder before
 * carrying out the actual decoding (LS > \ref ISRRAN_AVX512_B_SIZE).
...
/*!
 * Updates the messages from variable nodes to check nodes (optimized 8-bit version, LS > \ref ISRRAN_AVX512_B_SIZE).
 * \param[in,out] p       A pointer to the decoder registers (an ldpc_regs_c_avx512long structure).
 * \param[in]     i_layer The index of the variable-to-check layer to update.
 * \return An integer: 0 if the function executes correctly, -1 otherwise.
 */
...
/*!
 * Updates the messages from check nodes to variable nodes (optimized 8-bit version, LS > \ref ISRRAN_AVX512_B_SIZE).
 * \param[in,out] p        A pointer to the decoder registers (an ldpc_regs_c_avx512long structure).
 * \param[in]     i_layer  The index of the variable-to-check layer to update.
 * \param[in]     this_pcm A pointer to the row of the parity check matrix (i.e. base
 *                         graph) corresponding to the selected layer.
...
/*!
 * Updates the current estimate of the (soft) bits of the codeword (optimized 8-bit version, LS <= \ref
 * ISRRAN_AVX512_B_SIZE). \param[in,out] p        A pointer to the decoder registers (an ldpc_regs_c_avx512 structure).
 * \param[in]     i_layer  The index of the variable-to-check layer to update.
 * \param[in]     these_var_indices
 *                         Contains the indices of the variable nodes connected
 *                         to the current layer.
...
/*!
 * Returns the decoded message (hard bits) from the current soft bits (optimized 8-bit version, LS <= \ref
 * ISRRAN_AVX512_B_SIZE). \param[in]  p       A pointer to the decoder registers (an ldpc_regs_c_avx512 structure).
 * \param[out] message A pointer to the decoded message.
 * \param[in]  liftK   The length of the decoded message.
 * \return An integer: 0 if the function executes correctly, -1 otherwise.
 */
...
/*!
 * Creates the registers used by the optimized 8-bit-based implementation of the LDPC decoder
 * (flooded scheduling, LS > \ref ISRRAN_AVX512_B_SIZE).
 * \param[in] bgN          Codeword length.
 * \param[in] bgM          Number of check nodes.
 * \param[in] ls           Lifting size.
 * \param[in] scaling_fctr Scaling factor of the normalized min-sum algorithm.
...
/*!
 * Destroys the inner registers of the optimized 8-bit integer-based LDPC decoder (flooded scheduling, LS > \ref
 * ISRRAN_AVX512_B_SIZE). \param[in] p A pointer to the dismantled decoder registers (an ldpc_regs_c_avx512long_flood
 * structure).
 */
...
/*!
 * Initializes the inner registers of the optimized 8-bit integer-based LDPC decoder before
 * carrying out the actual decoding (flooded scheduling, LS > \ref ISRRAN_AVX512_B_SIZE).
