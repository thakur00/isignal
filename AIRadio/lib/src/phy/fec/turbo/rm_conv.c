 ...
 */
int isrran_rm_conv_tx(uint8_t* input, uint32_t in_len, uint8_t* output, uint32_t out_len)
{
 ...
 */
int isrran_rm_conv_rx(float* input, uint32_t in_len, float* output, uint32_t out_len)
{
  int nrows, ndummy, K_p;
  int i, j, k;
  int d_i, d_j;
 ...
 * 3GPP TS 36.212 v10.1.0 section 5.1.4.2
 */
int isrran_rm_conv_rx_s(int16_t* input, uint32_t in_len, int16_t* output, uint32_t out_len)
{
  int nrows, ndummy, K_p;
  int i, j, k;
  int d_i, d_j;
