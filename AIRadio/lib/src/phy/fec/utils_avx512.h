...
#ifndef ISRRAN_UTILS_AVX512_H
#define ISRRAN_UTILS_AVX512_H

#define ISRRAN_AVX512_B_SIZE 64    /*!< \brief Number of packed bytes in an AVX512 instruction. */
#define ISRRAN_AVX512_B_SIZE_LOG 6 /*!< \brief \f$\log_2\f$ of \ref ISRRAN_AVX512_B_SIZE. */
...
{
  int k = 0;
  for (; k < nof_llr - (ISRRAN_AVX512_B_SIZE - 1); k += ISRRAN_AVX512_B_SIZE) {
