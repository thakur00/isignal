...
#include "isrran/isrlog/context.h"
...
using sector_event_t = isrlog::build_context_type<metric_type_tag,
...
DECLARE_METRIC_SET("event_data",
                   ...
                   metric_asn1_type,
                   metric_additional);
using rrc_event_t = isrlog::build_context_type<metric_type_tag,
                                               metric_timestamp_tag,
                                               metric_carrier_id,
                                               metric_cell_id,
                                               metric_event_name,
...
using s1apctx_event_t = isrlog::build_context_type<metric_type_tag,
                                                   metric_timestamp_tag,
                                                   metric_carrier_id,
                                                   metric_cell_id,
                                                   metric_event_name,
...
using rlf_report_event_t = isrlog::build_context_type<metric_type_tag,
                                                      metric_timestamp_tag,
                                                      metric_carrier_id,
                                                      metric_cell_id,
                                                      metric_event_name,
...
using meas_report_event_t = isrlog::build_context_type<metric_type_tag,
                                                       metric_timestamp_tag,
                                                       metric_carrier_id,
                                                       metric_cell_id,
                                                       metric_event_name,
...
DECLARE_METRIC_SET("event_data",
                   ...
                   metric_new_ue_rnti);
using ho_cmd_t = isrlog::build_context_type<metric_type_tag,
                                            metric_timestamp_tag,
                                            metric_carrier_id,
                                            metric_cell_id,
                                            metric_event_name,
...
using conn_resume_t = isrlog::build_context_type<metric_type_tag,
                                                 metric_timestamp_tag,
                                                 metric_carrier_id,
                                                 metric_cell_id,
                                                 metric_event_name,
...
using rlf_detected_t = isrlog::build_context_type<metric_type_tag,
                                                  metric_timestamp_tag,
                                                  metric_carrier_id,
                                                  metric_cell_id,
                                                  metric_event_name,
...
{
public:
  logging_event_logger(isrlog::log_channel& c, event_logger::asn1_output_format asn1_format) :
...
private:
  isrlog::log_channel&                   event_channel;
...
void event_logger::configure(isrlog::log_channel& c, asn1_output_format asn1_format)
{
