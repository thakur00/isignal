...
avg_time_stats::avg_time_stats(const char* name_, const char* logname, size_t print_period_) :
  name(name_), logger(isrlog::fetch_basic_logger(logname)), print_period(print_period_)
{}
...
sliding_window_stats<TUnit>::sliding_window_stats(const char* name_, const char* logname, size_t print_period_) :
  name(name_), logger(isrlog::fetch_basic_logger(logname)), sliding_window(print_period_)
{}
...
template class isrran::sliding_window_stats<std::chrono::microseconds>;
template class isrran::sliding_window_stats<std::chrono::milliseconds>;
