...
#ifndef ISREPC_S1AP_COMMON_H
#define ISREPC_S1AP_COMMON_H
...
typedef struct {
  ...
  isrran::CIPHERING_ALGORITHM_ID_ENUM encryption_algo;
  isrran::INTEGRITY_ALGORITHM_ID_ENUM integrity_algo;
  bool                                request_imeisv;
  uint16_t                            lac;
} s1ap_args_t;
