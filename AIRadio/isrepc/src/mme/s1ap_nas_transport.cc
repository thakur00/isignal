                                                   ...
                                                   struct sctp_sndrcvinfo*          enb_sri)
{
  ...
  isrran::unique_byte_buffer_t nas_msg = isrran::make_byte_buffer();
  ...
  isrran::console("Initial UE message: %s\n", liblte_nas_msg_type_to_string(msg_type));
  m_logger.info("Initial UE message: %s", liblte_nas_msg_type_to_string(msg_type));

  if (init_ue->s_tmsi_present) {
    isrran::uint8_to_uint32(init_ue->s_tmsi.value.m_tmsi.data(), &m_tmsi);
  }

  switch (msg_type) {
    case LIBLTE_MME_MSG_TYPE_ATTACH_REQUEST:
      isrran::console("Received Initial UE message -- Attach Request\n");
    ...
    case LIBLTE_MME_SECURITY_HDR_TYPE_SERVICE_REQUEST:
      isrran::console("Received Initial UE message -- Service Request\n");
    ...
    case LIBLTE_MME_MSG_TYPE_DETACH_REQUEST:
      isrran::console("Received Initial UE message -- Detach Request\n");
    ...
    case LIBLTE_MME_MSG_TYPE_TRACKING_AREA_UPDATE_REQUEST:
      isrran::console("Received Initial UE message -- Tracking Area Update Request\n");
    ...
    default:
      ...
      isrran::console("Unhandled Initial UE Message 0x%x \n", msg_type);
      err = false;
  }
  return err;
}
                                                     ...
                                                     struct sctp_sndrcvinfo*               enb_sri)
{
  ...
  if (sec_hdr_type == LIBLTE_MME_SECURITY_HDR_TYPE_INTEGRITY ||
    ...
    if (not mac_valid) {
      isrlog::log_channel& channel = warn_integrity_fail ? m_logger.warning : m_logger.info;
  ...
  switch (msg_type) {
    case LIBLTE_MME_MSG_TYPE_ATTACH_REQUEST:
      ...
      isrran::console("UL NAS: Attach Resquest\n");
    ...
    case LIBLTE_MME_MSG_TYPE_IDENTITY_RESPONSE:
      ...
      isrran::console("UL NAS: Received Identity Response\n");
    ...
    case LIBLTE_MME_MSG_TYPE_AUTHENTICATION_RESPONSE:
      ...
      isrran::console("UL NAS: Received Authentication Response\n");
    ...
    case LIBLTE_MME_MSG_TYPE_AUTHENTICATION_FAILURE:
      ...
      isrran::console("UL NAS: Authentication Failure\n");
    ...
    case LIBLTE_MME_MSG_TYPE_DETACH_REQUEST:
      ...
      isrran::console("UL NAS: Detach Request\n");
    ...
    case LIBLTE_MME_MSG_TYPE_SECURITY_MODE_COMPLETE:
      ...
      isrran::console("UL NAS: Received Security Mode Complete\n");
      if (sec_hdr_type == LIBLTE_MME_SECURITY_HDR_TYPE_INTEGRITY_AND_CIPHERED_WITH_NEW_EPS_SECURITY_CONTEXT &&
        ...
        isrran::console("Security Mode Complete %s. Discard message.\n",
    ...
    case LIBLTE_MME_MSG_TYPE_ATTACH_COMPLETE:
      ...
      isrran::console("UL NAS: Received Attach Complete\n");
      if (sec_hdr_type == LIBLTE_MME_SECURITY_HDR_TYPE_INTEGRITY_AND_CIPHERED && mac_valid == true) {
        ...
        isrran::console("Attach Complete not integrity protected. Discard message.\n");
    ...
    case LIBLTE_MME_MSG_TYPE_ESM_INFORMATION_RESPONSE:
      ...
      isrran::console("UL NAS: Received ESM Information Response\n");
      if (sec_hdr_type == LIBLTE_MME_SECURITY_HDR_TYPE_INTEGRITY_AND_CIPHERED && mac_valid == true) {
        nas_ctx->handle_esm_information_response(nas_msg.get());
      } else {
        // Attach Complete was not integrity protected
        isrran::console("ESM Information Response %s. Discard message.\n",
                        (mac_valid ? "not integrity protected" : "invalid integrity"));
    ...
    case LIBLTE_MME_MSG_TYPE_TRACKING_AREA_UPDATE_REQUEST:
      ...
      isrran::console("UL NAS: Tracking Area Update Request\n");
    ...
    case LIBLTE_MME_MSG_TYPE_PDN_CONNECTIVITY_REQUEST:
      ...
      isrran::console("UL NAS: PDN Connectivity Request\n");
    ...
    default:
      ...
      isrran::console("Unhandled NAS integrity protected message %s\n", liblte_nas_msg_type_to_string(msg_type));
      return false;
  }
