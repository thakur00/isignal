...
#ifndef ISRUE_UE_METRICS_INTERFACE_H
#define ISRUE_UE_METRICS_INTERFACE_H
...
typedef struct {
  ...
  mac_metrics_t         mac[ISRRAN_MAX_CARRIERS];
  mac_metrics_t         mac_nr[ISRRAN_MAX_CARRIERS];
  isrran::rlc_metrics_t rlc;
  nas_metrics_t         nas;
  rrc_metrics_t         rrc;
...
// UE interface
class ue_metrics_interface : public isrran::metrics_interface<ue_metrics_t>
{
public:
...
#endif // ISRUE_UE_METRICS_INTERFACE_H
