...
public:
  ...
  void get_metrics(mac_metrics_t m[ISRRAN_MAX_CARRIERS]);
  ...
  void     tb_decoded(uint32_t cc_idx, mac_grant_dl_t grant, bool ack[ISRRAN_MAX_CODEWORDS]);
...
private:
  ...
  isrran_softbuffer_rx_t pch_softbuffer        = {};
  ...
  isrran::mch_pdu        mch_msg;

  /* Functions for MAC Timers */
  isrran::timer_handler::unique_timer timer_alignment;
