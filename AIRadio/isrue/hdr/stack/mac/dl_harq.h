...
#ifndef ISRUE_DL_HARQ_H
#define ISRUE_DL_HARQ_H
...
public:
  ...
  void tb_decoded(mac_interface_phy_lte::mac_grant_dl_t grant, bool ack[ISRRAN_MAX_CODEWORDS]);
...
typedef std::array<dl_harq_entity_ptr, ISRRAN_MAX_CARRIERS> dl_harq_entity_vector;

} // namespace isrue

#endif // ISRUE_DL_HARQ_H
