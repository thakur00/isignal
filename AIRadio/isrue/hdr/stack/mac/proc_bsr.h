...
#ifndef ISRUE_PROC_BSR_H
#define ISRUE_PROC_BSR_H
...
class bsr_proc : public isrran::timer_callback, public bsr_interface_mux
{
public:
  explicit bsr_proc(isrlog::basic_logger& logger) : logger(logger) {}
  void init(sr_proc* sr_proc, rlc_interface_mac* rlc, isrran::ext_task_sched_handle* task_sched_);
  void step(uint32_t tti);
  void reset();
  void set_config(isrran::bsr_cfg_t& bsr_cfg);
