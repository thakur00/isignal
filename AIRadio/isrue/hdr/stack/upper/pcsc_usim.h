...
#ifndef ISRUE_PCSC_USIM_H
#define ISRUE_PCSC_USIM_H
...
{
public:
  explicit pcsc_usim(isrlog::basic_logger& logger);
  ~pcsc_usim();
...
private:
  ...
  {
  public:
    explicit scard(isrlog::basic_logger& logger) : logger(logger) {}
    ~scard(){};
