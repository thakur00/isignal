...
class gw : public gw_interface_stack, public isrran::thread
{
public:
  gw(isrlog::basic_logger& logger_);
  ~gw();
...
private:
  ...
  uint32_t           mbsfn_ports[ISRRAN_N_MCH_LCIDS] = {}; // Target ports for MBSFN data
