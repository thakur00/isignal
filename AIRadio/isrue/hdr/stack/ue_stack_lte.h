...
#ifndef ISRUE_UE_STACK_LTE_H
#define ISRUE_UE_STACK_LTE_H
...
public:
  ...
  void tb_decoded(uint32_t cc_idx, mac_grant_dl_t grant, bool ack[ISRRAN_MAX_CODEWORDS]) final
  {
  ...
  isrran::ext_task_sched_handle get_task_sched() { return {&task_sched}; }
...
private:
  ...
  isrlog::basic_logger& usim_logger;
  isrlog::basic_logger& nas_logger;
  isrlog::basic_logger& nas5g_logger;

  // UE NR stack logging
  isrlog::basic_logger& mac_nr_logger;
  isrlog::basic_logger& rrc_nr_logger;
  isrlog::basic_logger& rlc_nr_logger;
  isrlog::basic_logger& pdcp_nr_logger;

  // tracing
  isrran::mac_pcap mac_pcap;
  isrran::mac_pcap mac_nr_pcap;
  isrran::nas_pcap nas_pcap;
  ...
  isrran::block_queue<stack_metrics_t>  pending_stack_metrics;
  task_scheduler                        task_sched;
  isrran::task_multiqueue::queue_handle sync_task_queue, ue_task_queue, gw_queue_id, cfg_task_queue;

  // TTI stats
  isrran::tprof<isrran::sliding_window_stats_ms> tti_tprof;
