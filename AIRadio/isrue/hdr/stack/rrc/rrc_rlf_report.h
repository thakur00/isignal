 ...
 *
 */
#ifndef ISRRAN_RRC_RLF_REPORT_H_
#define ISRRAN_RRC_RLF_REPORT_H_
...
public:
  ...
  void init(isrran::task_sched_handle task_sched);
...
private:
  ...
  isrran::timer_handler::unique_timer timer_conn_failure = {};
};
} // namespace isrue

#endif // ISRRAN_RRC_RLF_REPORT_H_
