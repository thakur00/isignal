 ...
 *
 */
#ifndef ISRRAN_RRC_MEAS_H_
#define ISRRAN_RRC_MEAS_H_
...
// TODO make this agnostic with isrenb
...
{
public:
  rrc_meas() : meas_cfg(&meas_report_list), meas_report_list(&meas_cfg), logger(isrlog::fetch_basic_logger("RRC")) {}
...
private:
  ...
  {
  public:
    var_meas_report_list(var_meas_cfg* meas_cfg_) : meas_cfg(meas_cfg_), logger(isrlog::fetch_basic_logger("RRC")) {}
    void init(rrc* rrc);
  ...
  private:
    ...
    public:
      ...
      isrran::timer_handler::unique_timer periodic_timer      = {};
    };
  ...
  public:
    var_meas_cfg(var_meas_report_list* meas_report_) :
      meas_report(meas_report_), logger(isrlog::fetch_basic_logger("RRC"))
    {}
    void                             init(rrc* rrc);
    void                             reset();
...
#endif // ISRRAN_ISRUE_HDR_STACK_RRC_RRC_MEAS_H_
