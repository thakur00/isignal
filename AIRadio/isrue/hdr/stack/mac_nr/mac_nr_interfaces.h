...
#ifndef ISRUE_MAC_NR_INTERFACES_H
#define ISRUE_MAC_NR_INTERFACES_H
...
public:
  ...
  virtual void     push_bcch(isrran::unique_byte_buffer_t pdu)                         = 0;
  virtual void     push_pdu(isrran::unique_byte_buffer_t pdu, uint32_t tti)            = 0;
  virtual void     push_pdu_temp_crnti(isrran::unique_byte_buffer_t pdu, uint32_t tti) = 0;
  virtual uint64_t get_received_crueid()                                               = 0;
};

} // namespace isrue

#endif // ISRUE_MAC_NR_INTERFACES_H