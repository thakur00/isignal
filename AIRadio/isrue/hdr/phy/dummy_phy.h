...
#ifndef ISRRAN_DUMMY_PHY_H
#define ISRRAN_DUMMY_PHY_H
...
public:
  ...
  bool set_config(const isrran::phy_cfg_t& config, uint32_t cc_idx = 0) final { return false; }
  bool set_scell(isrran_cell_t cell_info, uint32_t cc_idx, uint32_t earfcn) final { return false; }
