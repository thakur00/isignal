...
#ifndef ISRUE_PHY_METRICS_H
#define ISRUE_PHY_METRICS_H
...
struct info_metrics_t {
  typedef std::array<info_metrics_t, ISRRAN_MAX_CARRIERS> array_t;
...
#define PHY_METRICS_SET(PARAM)                                                                                         \
  do {                                                                                                                 \
    PARAM = ISRRAN_VEC_SAFE_CMA(other.PARAM, PARAM, count);                                                            \
  } while (false)

struct sync_metrics_t {
  typedef std::array<sync_metrics_t, ISRRAN_MAX_CARRIERS> array_t;
...
struct ch_metrics_t {
  typedef std::array<ch_metrics_t, ISRRAN_MAX_CARRIERS> array_t;
...
struct dl_metrics_t {
  typedef std::array<dl_metrics_t, ISRRAN_MAX_CARRIERS> array_t;
...
struct ul_metrics_t {
  typedef std::array<ul_metrics_t, ISRRAN_MAX_CARRIERS> array_t;
