 ...
 *
 */
#ifndef ISRRAN_INTRA_MEASURE_LTE_H
#define ISRRAN_INTRA_MEASURE_LTE_H
...
public:
   ...
   */
  intra_measure_lte(isrlog::basic_logger& logger, meas_itf& new_meas_itf_);
   ...
   */
  void set_primary_cell(uint32_t earfcn, isrran_cell_t cell);
...
private:
   ...
   */
  isrran::isrran_rat_t get_rat() const override { return isrran::isrran_rat_t::lte; }
  ...
  isrran_cell_t         serving_cell   = {};  ///< Current serving cell in the EARFCN, to avoid reporting it
  ...
  isrran_refsignal_dl_sync_t refsignal_dl_sync = {}; ///< Reference signal based measurement
};

} // namespace scell
} // namespace isrue

#endif // ISRRAN_INTRA_MEASURE_LTE_H
