 ...
 *
 */
#ifndef ISRRAN_INTRA_MEASURE_NR_H
#define ISRRAN_INTRA_MEASURE_NR_H
...
public:
  ...
  struct args_t {
    ...
    isrran_subcarrier_spacing_t min_scs           = isrran_subcarrier_spacing_15kHz;
  ...
  struct config_t : public intra_measure_base::args_t {
    ...
    isrran_subcarrier_spacing_t scs            = isrran_subcarrier_spacing_30kHz; ///< SSB configured Subcarrier spacing
   ...
   */
  intra_measure_nr(isrlog::basic_logger& logger, meas_itf& new_meas_itf_);
...
private:
   ...
   */
  isrran::isrran_rat_t get_rat() const override { return isrran::isrran_rat_t::nr; }
  ...
  isrran_ssb_t ssb = {}; ///< SS/PBCH Block
};

} // namespace scell
} // namespace isrue

#endif // ISRRAN_INTRA_MEASURE_NR_H
