 ...
 *
 */
#ifndef ISRUE_INTRA_MEASURE_BASE_H
#define ISRUE_INTRA_MEASURE_BASE_H
 ...
 */
class intra_measure_base : public isrran::thread
{
  /*
...
protected:
   ...
   */
  intra_measure_base(isrlog::basic_logger& logger, meas_itf& new_cell_itf_);
...
private:
   ...
   */
  virtual isrran::isrran_rat_t get_rat() const = 0;
  ...
  isrran_ringbuffer_t ring_buffer = {};
};

} // namespace scell
} // namespace isrue

#endif // ISRUE_INTRA_MEASURE_BASE_H
