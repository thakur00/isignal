...
#ifndef ISRUE_METRICS_CSV_H
#define ISRUE_METRICS_CSV_H
...
class metrics_csv : public isrran::metrics_listener<ue_metrics_t>
{
public:
...
private:
  void set_metrics_helper(const isrran::rf_metrics_t&  rf,
                          const isrran::sys_metrics_t& sys,
                          const phy_metrics_t&         phy,
                          const mac_metrics_t          mac[ISRRAN_MAX_CARRIERS],
