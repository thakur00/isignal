...
#ifndef ISRUE_METRICS_STDOUT_H
#define ISRUE_METRICS_STDOUT_H
...
class metrics_stdout : public isrran::metrics_listener<ue_metrics_t>
{
public:
  metrics_stdout(){};
