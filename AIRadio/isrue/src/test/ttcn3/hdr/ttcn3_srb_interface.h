...
#ifndef ISRUE_TTCN3_SRB_INTERFACE_H
#define ISRUE_TTCN3_SRB_INTERFACE_H
...
{
public:
  explicit ttcn3_srb_interface(isrlog::basic_logger& logger) :
...
#endif // ISRUE_TTCN3_SRB_INTERFACE_H
