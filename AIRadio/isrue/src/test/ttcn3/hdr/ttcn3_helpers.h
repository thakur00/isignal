...
#ifndef ISRUE_TTCN3_HELPERS_H
#define ISRUE_TTCN3_HELPERS_H
...
public:
  ...
  static std::string
  get_rrc_pdu_ind_for_pdu(uint32_t tti, uint32_t lcid, const std::string cell_, isrran::unique_byte_buffer_t pdubuf)
  {
    Document resp;
    resp.SetObject();
  ...
  static std::string
  get_drb_common_ind_for_pdu(uint32_t tti, uint32_t lcid, const std::string cell_, isrran::unique_byte_buffer_t drbpdu)
  {
    Document resp;
    resp.SetObject();
