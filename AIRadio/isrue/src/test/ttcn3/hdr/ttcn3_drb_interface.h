...
#ifndef ISRUE_TTCN3_DRB_INTERFACE_H
#define ISRUE_TTCN3_DRB_INTERFACE_H
...
{
public:
  explicit ttcn3_drb_interface(isrlog::basic_logger& logger) : ttcn3_port_handler(logger) {}
...
#endif // ISRUE_TTCN3_DRB_INTERFACE_H
