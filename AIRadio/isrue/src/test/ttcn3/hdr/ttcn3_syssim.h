...
#ifndef ISRUE_TTCN3_SYSSIM_H
#define ISRUE_TTCN3_SYSSIM_H
...
class ttcn3_syssim : public syssim_interface_phy,
                     ...
                     public isrran::pdu_queue::process_callback
{
public:
  ...
  bool process_ce(isrran::sch_subh* subh);
  ...
  void select_cell(isrran_cell_t phy_cell);
...
private:
  ...
  isrlog::basic_logger& ut_logger;
  isrlog::basic_logger& sys_logger;
  isrlog::basic_logger& ip_sock_logger;
  isrlog::basic_logger& ip_ctrl_logger;
  isrlog::basic_logger& srb_logger;
  isrlog::basic_logger& drb_logger;
  isrlog::basic_logger& ss_mac_logger;
  isrlog::basic_logger& ss_rlc_logger;
  isrlog::basic_logger& ss_pdcp_logger;
  ...
  uint16_t                dl_rnti              = 0;
  int                     force_lcid           = -1;
  isrue::stack_test_dummy stack; // helper to run queue pending tasks
  bool                    last_dl_ndi[ISRRAN_FDD_NOF_HARQ] = {};
  bool                    last_ul_ndi[ISRRAN_FDD_NOF_HARQ] = {};
  ...
  // Map between the cellId (name) used by 3GPP test suite and isrRAN cell struct
  class syssim_cell_t
  {
  public:
  ...
  isrran::byte_buffer_t rar_buffer;
  isrran::byte_buffer_t tx_payload_buffer; // Used to buffer final MAC PDU
