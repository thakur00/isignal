...
void phy_nr_sa::isrran_phy_logger(phy_logger_level_t log_level, char* str)
{
  switch (log_level) {
...
int phy_nr_sa::init(const phy_args_nr_t& args_, stack_interface_phy_nr* stack_, isrran::radio_interface_phy* radio_)
{
  args  = args_;
  stack = stack_;
  radio = radio_;
...
bool phy_nr_sa::set_config(const isrran::phy_cfg_nr_t& cfg)
{
